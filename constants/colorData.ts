...
export const COLOR_DATA: ColorData[] = [
  ...
  },
  {
    ...
    shadows: ['과도한 생각', '불안 패턴', '집중력 분산'],
    reading1: '무의식에서 희망과 소통을 향한 욕구가 반복됩니다.\n생각이 많아지는 패턴이 오랫동안 내면에 자리하고 있습니다.\n불확실한 상황에서 불안이 반복되는 흐름이 있습니다.',
    reading2: '지금 많은 생각과 아이디어가 흐르고 있지만,\n그 분주함 속에서 마음이 쉬지 못하고 있습니다.\n소통을 원하지만 내면이 안정되지 않은 시기입니다.',
  ...
  },
  {
    ...
    shadows: ['자기 표현 어려움', '과도한 배려', '감정 억누름'],
    reading1: '무의식에서 회복과 균형을 향한 욕구가 반복됩니다.\n자연스럽게 흐르고 싶은 패턴이 오랫동안 내면에 자리하고 있습니다.\n스스로를 치유하려는 에너지가 반복적으로 올라옵니다.',
  ...
  },
  {
    ...
    shadows: ['현실 괴리', '고립감', '과도한 내면 집중'],
    reading1: '무의식에서 깊은 탐구와 직관을 향한 욕구가 반복됩니다.\n내면 세계에 머물고 싶은 패턴이 오랫동안 자리하고 있습니다.\n현실보다 내면의 세계가 더 안전하게 느껴지는 흐름이 반복됩니다.',
    reading2: '지금 깊은 사고와 탐구 속에 있지만,\n현실과의 연결이 점점 멀어지고 있는 느낌이 있습니다.\n내면이 풍부하지만 고립감이 느껴지는 시기입니다.',
  ...
  },
  {
    ...
    reading3: '마젠타가 회복 방향으로 나타났을 때는,\n내면의 고요한 중심을 찾는 안정의 에너지가 필요하다는 신호입니다.\n강렬함을 잠시 내려놓고, 폭풍 뒤의 고요함 속에서 진짜 방향을 찾아보세요.',
    recoveryMessages: [
  ...
  },
  {
    ...
    shadows: ['고립감', '감정 차단', '과도한 자기 보호'],
    reading1: '무의식에서 자신을 보호하려는 강한 에너지가 반복됩니다.\n외부로부터 자신을 지키려는 패턴이 오랫동안 내면에 자리하고 있습니다.\n깊이 있지만 연결을 차단하는 흐름이 반복됩니다.',
  ...
  },
  {
    ...
    shadows: ['감정 거리감', '냉정한 패턴', '연결 어려움'],
    reading1: '무의식에서 이성적 명료함을 향한 욕구가 반복됩니다.\n감정보다 이성으로 판단하려는 패턴이 오랫동안 내면에 자리하고 있습니다.\n감정적 연결이 불편하게 느껴지는 흐름이 반복됩니다.',
    reading2: '지금 이성적이고 명료한 에너지가 흐르고 있습니다.\n하지만 감정과의 연결이 멀어지고 있는 느낌이 있습니다.\n객관적이지만 따뜻한 연결이 부족한 시기입니다.',
  ...
  },
  {
    ...
    shadows: ['자기 표현 어려움', '과도한 배려', '감정 억누름'],
    reading1: '무의식에서 자연스러운 치유와 균형을 향한 욕구가 반복됩니다.\n조화롭게 흐르고 싶은 패턴이 오랫동안 내면에 자리하고 있습니다.\n자신을 치유하면서도 자기 표현이 어색한 흐름이 반복됩니다.',
  ...
  },
  {
    ...
    shadows: ['감정 표현 어려움', '과도한 이성', '연결 부족'],
    reading1: '무의식에서 균형과 통합을 향한 욕구가 반복됩니다.\n이성과 감정을 통합하려는 패턴이 오랫동안 내면에 자리하고 있습니다.\n명료함을 추구하지만 감정 표현이 어색한 흐름이 반복됩니다.',
  ...
  },
  {
    ...
    shadows: ['감정 표현 어려움', '과도한 내면 집중', '고립 경향'],
    reading1: '무의식에서 고요함과 안정을 향한 욕구가 반복됩니다.\n복잡한 것들을 정리하고 조용히 머물고 싶은 패턴이 내면에 자리하고 있습니다.\n외부 자극으로부터 자신을 보호하려는 흐름이 반복됩니다.',
...
function generatePsychologyFlow(card1: ColorData, card2: ColorData, card3: ColorData): string {
  const combos: Record<string, string> = {
    ...
    'coral_lavender': '따뜻한 연결을 원하는 에너지가 내면에 흐르지만,\n지금은 섬세하고 조용한 에너지 속에서 치유가 필요한 상태입니다.',
