...
export const COLOR_DATA: ColorData[] = [
  ...
  },
  {
    ...
    shadows: ['생각 과몰입', '감정 내면화', '현실 괴리'],
    reading1: '무의식에서 깊은 탐구와 직관을 향한 욕구가 반복됩니다.\n내면 세계에 머물고 싶은 패턴이 오래동안 자리하고 있습니다.\n감정을 혼자 안으로 담아두고 생각으로 정리하려는 흐름이 반복됩니다.',
