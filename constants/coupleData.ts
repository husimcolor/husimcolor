...
function getPersonEnergyProfile(families: EnergyFamily[], primaryFamily?: EnergyFamily, secondaryFamily?: EnergyFamily): {
  ...
  const currentFlowMap: Record<PersonProfile, string> = {
    ...
    warm_connector: '지금 누군가와 따뜻하게 연결되고 싶은 마음이 흐르고 있습니다. 그런데 상대를 배려하는 마음이 커질수록 자신의 감정은 뒤로 미루게 될 수 있습니다. 지금 가장 필요한 것은 자신에게도 그 따뜻함을 돌려주는 시간입니다.',
...
function getEmotionExpression(family: EnergyFamily, card: ColorData): string {
  ...
  const colorIdMap: Partial<Record<string, string>> = {
    ...
    magenta: '감정을 솔직하게 표현하는 편이며, 관계 안에서 서로의 마음을 나누는 것을 중요하게 여깁니다.',
...
function buildCard1Intro(card1: ColorData): string {
  ...
  const intros: Record<string, string> = {
    ...
    peach: '따뜻하게 주변을 챙겨왔지만 정작 자신은 지쳐 있을 수 있습니다.',
    ...
    blue: '책임감 있게 살아왔지만 감정을 표현하지 못해 답답함이 쌓여 있을 수 있습니다.',
  ...
  switch (shape) {
    ...
    case 'inverted_triangle':
      ...
      return {
        ...
        conflictTrait: '갈등 직후 조용해지거나 말이 없어집니다. 상대는 원인을 모르고 기다리는 상황이 되고, 이 침묵이 거리감으로 번지는 경향이 있을 수 있습니다',
    ...
    case 'square':
      ...
      return {
        ...
        conflictTrait: '갈등 직후 원인과 해결책을 먼저 찾는 경향이 있을 수 있습니다. 감정보다 상황 정리가 앞서면 상대는 공감받지 못한다고 느낄 수 있습니다',
    ...
    case 'diamond':
      ...
      return {
        ...
        conflictTrait: '갈등 직후 긴장이 오래 지속되고 작은 말 한마디가 마음에 오래 남는 경향이 있을 수 있습니다',
    ...
    case 'hexagon':
      ...
      return {
        ...
        conflictTrait: '갈등 직후 관계를 지키려는 마음에 자신의 감정을 숨기는 경향이 있을 수 있습니다. 상대는 실제 상태를 모를 수 있습니다',
...
function buildRelationFlow(
  ...
  if (fA === fB) {
    ...
    const sameFamilyMsg: Record<EnergyFamily, string> = {
      ...
      cool_deep: `${relLabel}은 둘 다 감정을 깊이 담아두고 천천히 꺼내는 에너지를 가지고 있습니다. 서로의 침묵을 이해하지만, 둘 다 기다리다가 연결이 늦어지는 경향이 나타날 수 있습니다. 먼저 한 마디 건네는 것이 두 사람 사이를 가장 빠르게 연결합니다.`,
  ...
  const colorIdCombos: Partial<Record<string, string>> = {
    ...
    'pink-yellow': `따뜻한 연결을 원하는 사람과 현실적이고 책임감 있는 사람이 만났습니다. 한 사람은 따뜻한 말과 직접적인 표현으로 마음을 확인하고 싶어 하고, 다른 사람은 현실적인 행동으로 마음을 보여줍니다. "말로도 해줘"와 "이미 다 하고 있잖아"가 반복될 수 있습니다. 인정 욕구와 현실 안정 욕구가 다른 방향으로 표현되는 패턴입니다.`,
    // 오렌지·퍼플·라벤더 조합
...
function buildMisunderstandingPattern(
  ...
  if (fA === fB) {
    const sameMissMap: Record<EnergyFamily, string> = {
      ...
      cool_deep: '두 사람 모두 감정을 깊이 담아두고 천천히 꺼내는 편입니다. 서로의 침묵을 이해하지만, 둘 다 기다리다가 연결이 늦어지는 경향이 나타날 수 있습니다. 먼저 한 마디 건네는 것이 두 사람 사이를 가장 빠르게 연결하는 방법입니다.',
  ...
  const colorIdMissPatterns: Partial<Record<string, string>> = {
    ...
    'white-pink': '갈등이 생기면 한 사람은 조용히 집을 정리하거나 혼자 있으려 합니다. 다른 사람은 그 침묵이 "나를 거부하는 것"처럼 느껴집니다. "왜 말을 안 해?"라고 물으면, 한 사람은 "지금 정리 중이야"라고 합니다. 이 경향이 나타날 수 있습니다. 감정 정리 후 표현하는 방식이 회복임을 서로 이해하면 오해가 줄어듭니다.',
    'white-red': '한 사람은 집이 정돈되어 있어야 마음이 편안합니다. 다른 사람은 집안 상태보다 지금 당장 함께 뭔가 하고 싶습니다. "왜 이렇게 어질러?"와 "왜 이렇게 예민해?"가 반복될 수 있습니다. 생활 기준 차이가 작은 갈등으로 쌓입니다.',
    ...
    'black-magenta': '한 사람은 감정이 복잡해지면 혼자 있으려 합니다. 다른 사람은 그 거리감이 거절처럼 느껴집니다. 한 사람이 공간을 원할수록 다른 사람은 더 가까이 다가갑니다. 그러면 한 사람은 더 물러섭니다. 이 경향이 나타날 수 있습니다.',
    // 네이비 — 책임감·행동으로 표현·말보다 행동
    'navy-pink': '한 사람은 말 없이 밥을 차려주고, 먼저 일을 처리하고, 행동으로 마음을 전합니다. 다른 사람은 "그래도 말로 해줘"라고 원합니다. "이미 다 하고 있잖아"와 "그래도 말로 해줘"가 반복될 수 있습니다. 행동과 말, 두 가지 언어를 번역해주는 것이 필요합니다.',
    ...
    'red-violet': '한 사람은 지금 당장 반응을 원합니다. 다른 사람은 충분히 생각한 후에야 말합니다. "왜 반응이 없어?"와 "왜 이렇게 빨리 결론 내려?"가 반복될 수 있습니다. 속도 차이가 이 관계의 반복적인 긴장입니다.',
    // 핑크/마젠타 — 애정 확인·감정 공유·연결감
    'pink-green': '한 사람은 "나 사랑해?"라고 자주 확인하고 싶습니다. 다른 사람은 그 기대가 부담스럽습니다. "왜 항상 확인해?"와 "왜 표현을 안 해?"가 반복될 수 있습니다. 관계 온도 차이가 반복적인 서운함을 만듭니다.',
    ...
    'violet-yellow': '한 사람은 "우리 관계에 대해 깊이 얘기하고 싶어"라고 원합니다. 다른 사람은 "그냥 오늘 뭐 먹을지 얘기하면 안 돼?"라고 합니다. "왜 이렇게 깊이 생각해?"와 "왜 이렇게 가볍게 봐?"가 반복될 수 있습니다.',
    ...
    'black-violet': '"지금 혼자 있어야 해"와 "나랑 얘기하기 싫어?"가 반복될 수 있습니다. 한 사람의 회복 공간이 다른 사람에게 단절로 읽힙니다. 조용한 것이 관계가 식은 것이 아님을 서로 확인하는 것이 필요합니다.',
    ...
    'pink-yellow': '"말로도 해줘"와 "이미 다 하고 있잖아"가 반복될 수 있습니다. 사랑의 언어가 달라서 생기는 오해입니다. 행동이 표현이라는 것을 한 사람이 알면 관계가 편안해집니다.',
    ...
    'red-black': '한 사람은 감정이 생기면 바로 꺼내고 즉각 반응을 원합니다. 다른 사람은 자기 방식이 있고 간섭받는 것이 불편합니다. "내 방식대로 해"와 "왜 이렇게 강요해?"가 반복될 수 있습니다. 주도권 충돌이 반복적인 긴장 포인트입니다. 서로의 방식을 먼저 인정하고, 작은 양보를 번갈아 하는 것이 두 사람 사이의 긴장을 줄여줍니다.',
    ...
    'pink-indigo': '한 사람은 따뜻한 말과 표현으로 연결감을 확인하고 싶어 합니다. 다른 사람은 충분히 생각한 후에야 말하는 편입니다. "왜 반응이 없어?"와 "나는 생각 중이야"가 반복될 수 있습니다. 인정 욕구와 신중함이 균형을 이룰 때 두 사람의 관계는 가장 편안해집니다.',
    ...
    'orange-purple': '한 사람은 감정이 생기면 바로 표현하고 즉각 반응을 원합니다. 다른 사람은 충분히 생각한 후에야 말하는 편입니다. "왜 반응이 없어?"와 "왜 이렇게 빨리 결론 내려?"가 반복될 수 있습니다. 속도 차이가 이 관계의 반복적인 긴장입니다.',
...
function buildExpressionDifference(
  ...
  const colorIdExprMap: Partial<Record<string, string>> = {
    ...
    'white-black': `두 사람 모두 감정을 쉽게 꺼내지 않습니다. 한 사람은 정리될 때까지 기다리고, 다른 사람은 경계를 세우며 기다립니다. 서로 기다리다 연결이 늦어지는 경향이 나타날 수 있습니다.`,
    ...
    'black-violet': `한 사람은 혼자 회복하는 시간이 필요합니다. 말이 많아지면 피로해집니다. 다른 사람은 감정 공감과 깊은 대화를 원합니다. 연결감이 없으면 외로워집니다.\n한 사람의 침묵이 다른 사람에게 단절로 느껴지고, 다른 사람의 깊은 감정 표현이 한 사람에게 부담이 됩니다. "지금 혼자 있어야 해"와 "나랑 얘기하기 싫어?"가 반복될 수 있습니다.`,
    ...
    'pink-yellow': isCouple
      ? `한 사람은 따뜻한 표현과 스킨십으로 사랑을 확인하고 싶어 합니다. 다른 사람은 현실적인 책임과 꾸준한 행동으로 마음을 보여줍니다.\n"말로도 해줘"와 "이미 다 하고 있잖아"가 반복될 수 있습니다. 사랑의 언어가 달라서 생기는 오해입니다. 한 사람의 표현 욕구와 다른 사람의 행동 언어를 서로 알면 관계가 편안해집니다.`
      : `한 사람은 따뜻한 표현과 직접적인 말로 연결감을 확인하고 싶어 합니다. 다른 사람은 현실적인 책임과 꾸준한 행동으로 마음을 보여줍니다.\n"말로도 해줘"와 "이미 다 하고 있잖아"가 반복될 수 있습니다. 표현 방식이 달라서 생기는 오해입니다. 한 사람의 표현 욕구와 다른 사람의 행동 언어를 서로 알면 관계가 편안해집니다.`,
...
function buildEmotionRecovery(fA: EnergyFamily, fB: EnergyFamily, rel?: RelationType): string {
  ...
  const recoveryMap: Partial<Record<string, string>> = {
    ...
    'cool_clear-warm_soft': '한 사람이 논리적으로 정리할 때, 다른 사람은 그 말이 차갑게 느껴질 수 있습니다. "왜 이렇게 차가워?"보다 "지금 어떤 마음으로 말하는 거야?"가 더 좋습니다. 명료한 언어 뒤에도 진심이 담겨 있을 수 있습니다.',
...
const DYNAMIC_HARD_MAP: Partial<Record<string, string>> = {
  ...
  'warm_soft-cool_deep':      '한 사람은 지금 공감받고 싶고, 다른 사람은 충분히 정리한 뒤 표현하려 합니다. "왜 반응이 없어?"와 "나는 정리 중이야"가 반복될 수 있습니다.',
...
const DYNAMIC_PATTERN_MAP: Partial<Record<string, string>> = {
  'warm_active-cool_deep':    '한 사람이 먼저 다가가고, 다른 사람은 시간이 지난 뒤 반응하는 흐름이 반복될 수 있습니다.',
  'warm_active-warm_soft':    '한 사람이 빠르게 표현하면 다른 사람이 잠시 물러서고, 그 거리가 다시 가까워지는 흐름이 반복될 수 있습니다.',
  'warm_active-nature':       '한 사람이 방향을 제시하고 다른 사람이 따라가는 흐름이 반복되다, 다른 사람이 지쳐 거리를 두는 패턴이 생깁니다.',
  'warm_active-neutral':      '한 사람이 먼저 표현하고, 다른 사람이 균형을 맞추려는 흐름이 반복될 수 있습니다.',
  'warm_active-cool_clear':   '한 사람이 감정으로 먼저 반응하고, 다른 사람이 논리로 정리하려는 흐름이 반복될 수 있습니다.',
  'warm_active-warm_grounded':'한 사람이 빠르게 결정하고, 다른 사람이 검토하며 속도를 조절하는 흐름이 반복될 수 있습니다.',
  'warm_soft-cool_deep':      '한 사람이 먼저 연락하고, 다른 사람이 그 연락을 기다리는 흐름이 반복될 수 있습니다.',
  'warm_soft-nature':         '한 사람이 더 많이 표현하고, 다른 사람이 자연스럽게 받아들이는 흐름이 반복될 수 있습니다.',
  'warm_soft-neutral':        '한 사람이 감정으로 다가가고, 다른 사람이 현실적으로 정리하는 흐름이 반복될 수 있습니다.',
  'warm_soft-cool_clear':     '한 사람이 감정으로 먼저 반응하고, 다른 사람이 논리로 정리하려는 흐름이 반복될 수 있습니다.',
  'warm_soft-warm_grounded':  '한 사람이 감정으로 표현하고, 다른 사람이 행동으로 응답하는 흐름이 반복될 수 있습니다.',
  'cool_deep-nature':         '한 사람이 깊이 생각하며 거리를 두고, 다른 사람이 자연스럽게 기다리는 흐름이 반복될 수 있습니다.',
  'cool_deep-neutral':        '한 사람이 깊이 정리하고, 다른 사람이 가볍게 풀어가려는 흐름이 반복될 수 있습니다.',
  'cool_deep-cool_clear':     '두 사람 모두 먼저 말하기를 기다리다 서로 기다리는 경향이 나타날 수 있습니다.',
  'cool_deep-warm_grounded':  '한 사람이 내면을 정리하며 거리를 두고, 다른 사람이 묵묵히 기다리는 흐름이 반복될 수 있습니다.',
  'nature-neutral':           '두 사람 모두 자연스럽게 흐르다 방향이 필요한 순간에 서로 기다리는 경향이 나타날 수 있습니다.',
  'nature-cool_clear':        '한 사람이 자연스럽게 흐르고, 다른 사람이 명확하게 정리하려는 흐름이 반복될 수 있습니다.',
  'nature-warm_grounded':     '두 사람 모두 안정을 선호하다 변화가 필요한 순간에 서로 기다리는 경향이 나타날 수 있습니다.',
  'neutral-cool_clear':       '한 사람이 유연하게 적응하고, 다른 사람이 명확한 방향을 잡으려는 흐름이 반복될 수 있습니다.',
  'neutral-warm_grounded':    '한 사람이 가볍게 제안하고, 다른 사람이 신중하게 검토하는 흐름이 반복될 수 있습니다.',
  'cool_clear-warm_grounded': '한 사람이 명료하게 결론 내리고, 다른 사람이 신중하게 검토하는 흐름이 반복될 수 있습니다.',
};
...
function buildClosingMessage(
  ...
  const relMessages: Record<RelationType, string> = {
    ...
    '부부': `오랜 시간을 함께해온 두 분의 관계 안에는 이미 많은 이해가 쌓여 있을 수 있습니다. 지금 필요한 것은 새로운 시작이 아니라, 서로를 다시 바라보는 따뜻한 시선입니다. 오늘 이 시간이 그 시작이 되길 바랍니다.`,
...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  온도차형: {
    ...
    tensionDescription: '싸운 다음 날 아침, 한 사람은 이미 평소처럼 움직입니다. 다른 사람은 아직 어젯밤 안에 머물러 있습니다. "어떻게 아무렇지 않아?"  이 말이 나옵니다. 한 사람은 "이미 끝난 거 아니야?"  라고 답합니다. 이 속도 차이가 반복될 수 있습니다. "왜 아직도 그래?" 와 "왜 이미 넘어간 것처럼 해?"가 교차합니다.',
    ...
    recommendedColors: [
      ...
      { id: 'steel_blue', korName: '스틸블루', hex: '#6B8CAE', reason: '속도 차이를 자연스럽게 조율하는 신뢰의 에너지입니다.' },
        ...
        unifiedSections: {
          ...
          lifePattern: {
            headline: '같이 살면 이런 순간이 반복될 수 있습니다',
            items: [
              {
                icon: '🧹',
                label: '정리 스타일',
  ...
  성장자극형: {
    ...
    misunderstandingPattern: '한 사람이 "이렇게 하면 더 잘 될 것 같아"라고 말합니다. 다른 사람은 "지금도 충분한데 왜 항상 더 하라고 해?"라고 느낍니다. 응원이 압박으로 들리는 순간입니다. 한 사람은 "나는 그냥 도와주려 했는데"라고 하고, 다른 사람은 "그 말이 나를 부족하게 만들어"라고 합니다. 이 오해가 반복될 수 있습니다.',
  ...
  안정추구형: {
    ...
    recommendedColors: [
      ...
      { id: 'olive', korName: '올리브', hex: '#7A8C5E', reason: '일상의 안정과 자연스러운 연결감을 더해주는 컬러입니다.' },
        ...
        intimacyConnection: {
      marriageNote: '생활을 함께 나누는 두 사람에게 스킨십은 "당신과 이 일상이 좋아"라는 가장 따뜻한 확인입니다. 요리하다 어깨를 기대거나, 자기 전 손을 잡거나, "수고했어"와 함께 안아주는 것 — 그 작은 연결들이 쌓여 이 관계의 안정감이 됩니다. 일상 속에서 의식적으로 먼저 다가가세요.',
      loverNote: '함께 밥을 먹고, 같은 공간에서 쉬고, 작은 루틴을 만들어가는 것 — 그 일상 속에서 먼저 가까이 앉아보세요. 소파에 나란히 앉아 어깨를 기대거나, 자기 전 손잡는 것만으로도 "나는 이 일상이 좋아"가 전해집니다.',
  ...
  거리조절형: {
    ...
    tensionDescription: '한 사람은 함께 있으면 숨막히는 순간이 옵니다. 혼자 있는 시간이 필요합니다. 다른 사람은 그 거리가 불안합니다. "나한테 관심 없는 거 아니야?"라는 생각이 듭니다. 한 사람이 공간을 원할 때 다른 사람은 더 가까이 다가갑니다. 그러면 한 사람은 더 물러섭니다. 이 경향이 나타날 수 있습니다. 두 사람 모두 지칩니다.',
      ...
      recoveryBridge: '이 감정은 관계의 약점이 아닙니다. 거리는 이 관계의 방식입니다. 숨을 고를 수 있는 공간과 다시 연결되는 시간이 모두 필요합니다.',
        ...
        unifiedSections: {
          ...
          conflictFlow: {
            ...
            danger: '공간이 필요한 사람이 계속 거리를 두면, 더 원하는 사람은 포기하거나 더 강하게 요구합니다. 그 사이클이 반복될 수 있습니다.',
        ...
        intimacyConnection: {
      marriageNote: '공간이 필요한 두 사람에게 스킨십은 "멀어진 게 아니야"를 전하는 가장 조용한 방법입니다. 억지로 가까워지려 하지 말고, 돌아왔을 때 자연스럽게 어깨를 기대거나 손을 잡으세요. 그 순간이 "우리는 여전히 연결되어 있어"를 확인하는 시간입니다.',
      loverNote: '혼자만의 시간이 필요하다고 느낄 때 솔직하게 말하고, 돌아왔을 때 먼저 손잡아 주세요. 그 작은 행동 하나가 "나는 멀어진 게 아니야"를 전합니다. 가까이 앉아 어깨를 기대는 것만으로도 충분합니다.',
      ...
      { id: 'peach', korName: '피치', hex: '#F4A882', reason: '이상화된 감정을 따뜻하고 부드럽게 현실로 내려주는 회복 컬러입니다.' },
        ...
        unifiedSections: {
          ...
          conflictFlow: {
            ...
            danger: '감정 기복이 커지면 서로 지칩니다. 감정을 해결하려 하면 더 커지는 경향이 나타날 수 있습니다.',
  ...
  현실균형형: {
    ...
    recommendedColors: [
      ...
      { id: 'warm_gray', korName: '웜그레이', hex: '#A09080', reason: '현실적인 안정감을 따뜻하게 감싸주는 균형의 컬러입니다.' },
        ...
        intimacyConnection: {
      marriageNote: '현실 문제를 함께 해결한 후에도 "우리는 팀 이상이야"를 확인하는 시간이 필요합니다. 바쁜 일상 속에서 의식적으로 손잡고, 어깨를 기대고, "수고했어" 한마디와 함께 안아주세요. 그 작은 연결이 현실의 무게를 함께 버티게 해줍니다.',
      loverNote: '현실적인 대화가 끝난 후 자연스럽게 가까이 앉아보세요. 문제를 함께 해결한 후 손잡는 것, 걸을 때 어깨를 기대는 것 — 그 작은 행동이 "우리는 현실 이상의 연결이 있어"를 전합니다.',
  ...
  회복형: {
    ...
    profileContrastOverride: {
      attractionContrast: '두 사람은 갈등 후 다시 연결되는 힘이 있습니다. 싸우는 것이 이 관계의 문제가 아닙니다. 싸우고 나서 어떻게 돌아오는지가 이 관계의 핵심입니다. 한 사람이 먼저 연락하고, 다른 사람이 그 연락을 기다리는 흐름이 반복될 수 있습니다. 그 반복이 쌓여 이 관계가 됩니다. 상처를 함께 아문 사람들만이 아는 안도감이 이 관계에 있습니다.',
      ...
      connectionStyle: '갈등 후 안아주는 순간 긴장이 풀립니다. 그 안도감이 이 관계의 가장 깊은 연결입니다. 먼저 손을 내미는 것, 먼저 연락하는 것, 먼저 옆에 앉는 것. 그 작은 용기가 이 관계를 다시 연결합니다. "우리 또 해냈어"라고 함께 인정하는 순간이 이 관계의 가장 따뜻한 순간입니다.',
        ...
        unifiedSections: {
          ...
          conflictFlow: {
            ...
            danger: '회복 속도 차이를 인정하지 않으면 "또 이 패턴"이 반복될 수 있습니다. 한 사람이 항상 먼저 손을 내밀면 지칩니다.',
...
const SUPPLEMENT_CLEANING: Record<string, string> = {
  red:     '다만 지금은 레드 카드 영향으로 빠르게 움직이고 싶은 마음이 강해지는 시기입니다. 작은 것 하나부터 바꿔보면서 그 흐름을 조금씩 이어가는 것이 도움이 됩니다.',
  orange:  '다만 지금은 오렌지 카드 영향으로 새로운 방식을 시도하고 싶은 마음이 평소보다 강해질 수 있습니다. 일상에 작은 변화를 하나씩 더해보는 것이 이 시기에 잘 맞습니다.',
  yellow:  '다만 지금은 옐로우 카드 영향으로 가볍고 즐겁게 움직이고 싶은 마음이 강해지는 시기입니다. 부담 없이 일상을 밝게 채워가는 것이 이 시기에 자연스럽게 맞습니다.',
  green:   '다만 지금은 그린 카드 영향으로 무리하지 않고 일정한 리듬을 유지하고 싶은 마음이 강해질 수 있습니다. 익숙한 루틴을 지키면서 천천히 움직이는 것이 이 시기에 좋습니다.',
  blue:    '다만 지금은 블루 카드 영향으로 조용하고 혼자만의 시간이 더 필요한 시기입니다. 일상 속에서 자신만의 공간과 속도를 충분히 확보하는 것이 중요합니다.',
  indigo:  '다만 지금은 인디고 카드 영향으로 생각이 많아지고 일상 속에서도 깊이 고민하게 되는 시기입니다. 서두르지 않고 자신의 속도대로 움직이는 것이 이 시기에 맞습니다.',
  violet:  '다만 지금은 바이올렛 카드 영향으로 감수성이 예민해지고 일상의 작은 것에도 더 많이 반응하게 되는 시기입니다. 감정을 억누르지 않고 자연스럽게 흘려보내는 것이 도움이 됩니다.',
  pink:    '다만 지금은 핑크 카드 영향으로 상대와 함께하는 시간과 따뜻한 연결을 더 원하게 되는 시기입니다. 일상 속 작은 공유와 대화가 이 시기에 큰 힘이 됩니다.',
  white:   '다만 지금은 화이트 카드 영향으로 주변을 정리하고 불필요한 것을 덜어내고 싶은 마음이 강해지는 시기입니다. 일상을 단순하게 만들어가는 것이 이 시기에 잘 맞습니다.',
  black:   '다만 지금은 블랙 카드 영향으로 자신만의 공간과 리듬을 지키고 싶은 마음이 강해지는 시기입니다. 일상에서 자신의 페이스를 유지하는 것이 이 시기에 특히 중요합니다.',
  brown:   '다만 지금은 브라운 카드 영향으로 안정적이고 현실적인 일상 기반을 원하는 마음이 강해질 수 있습니다. 작고 확실한 루틴을 하나씩 챙기는 것이 이 시기에 도움이 됩니다.',
  beige:   '다만 지금은 베이지 카드 영향으로 익숙하고 편안한 일상을 원하는 마음이 강해지는 시기입니다. 새로운 변화보다 지금의 루틴 안에서 안정감을 찾는 것이 이 시기에 좋습니다.',
  neutral: '다만 지금은 심리 상태가 고요하고 중립적인 시기입니다. 무리한 변화보다 지금의 일상 리듬을 그대로 유지하는 것이 가장 자연스럽습니다.',
  navy:    '다만 지금은 네이비 카드 영향으로 믿을 수 있는 환경과 안정된 일상을 원하는 마음이 강해질 수 있습니다. 신뢰할 수 있는 루틴 안에서 천천히 움직이는 것이 이 시기에 맞습니다.',
  sky:     '다만 지금은 스카이블루 카드 영향으로 자유롭고 가볍게 움직이고 싶은 마음이 높아지는 시기입니다. 부담 없이 열린 방식으로 일상을 채워가는 것이 이 시기에 잘 맞습니다.',
  mint:    '다만 지금은 민트 카드 영향으로 새롭게 시작하고 싶은 마음이 강해지는 시기입니다. 일상에 작은 변화 하나를 더해보는 것이 이 시기에 활력이 됩니다.',
  peach:   '다만 지금은 피치 카드 영향으로 부드럽고 따뜻한 일상을 원하는 마음이 높아지는 시기입니다. 상대와 함께하는 따뜻한 순간을 의도적으로 만들어보는 것이 좋습니다.',
  coral:   '다만 지금은 코랄 카드 영향으로 활기차게 움직이고 싶은 마음이 강해지는 시기입니다. 이 활력을 일상 속에서 긍정적인 방향으로 표현해보세요.',
  gold:    '다만 지금은 골드 카드 영향으로 일상 속에서 성취감을 느끼고 싶은 마음이 높아질 수 있습니다. 작은 목표를 하나 세우고 함께 이루어가는 것이 이 시기에 활력이 됩니다.',
  lavender:'다만 지금은 라벤더 카드 영향으로 감성적이고 섬세한 흐름이 강해지는 시기입니다. 여유 있고 부드러운 방식으로 일상을 보내는 것이 이 시기에 잘 맞습니다.',
  sage:    '다만 지금은 세이지 카드 영향으로 차분하고 조용하게 일상을 이어가고 싶은 마음이 강해지는 시기입니다. 서두르지 않고 자연스럽게 흘러가는 것이 이 시기에 가장 좋습니다.',
};

// 재정패턴(소비 및 지출 성향) 보충
const SUPPLEMENT_FINANCE: Record<string, string> = {
  red:     '다만 지금은 레드 카드 영향으로 즉흥적으로 지출하고 싶은 충동이 평소보다 강해질 수 있습니다. 구매 전 하루 정도 기다려보는 습관이 이 시기에 특히 도움이 됩니다.',
  orange:  '다만 지금은 오렌지 카드 영향으로 새로운 경험과 변화에 돈을 쓰고 싶은 마음이 커질 수 있습니다. 예산 안에서 함께 새로운 경험을 계획하는 것이 이 시기에 잘 맞습니다.',
  yellow:  '다만 지금은 옐로우 카드 영향으로 가볍고 즐거운 소비에 대한 욕구가 높아질 수 있습니다. 소소한 즐거움을 위한 소비는 허용하되 큰 지출은 한 번 더 생각해보는 것이 좋습니다.',
  green:   '다만 지금은 그린 카드 영향으로 균형 잡힌 소비와 안정적인 재정 관리를 원하는 마음이 강해질 수 있습니다. 불필요한 지출을 줄이고 균형을 맞추는 것이 이 시기에 도움이 됩니다.',
  blue:    '다만 지금은 블루 카드 영향으로 차분하고 신중하게 소비를 결정하고 싶은 마음이 강해질 수 있습니다. 큰 결정은 충분히 생각한 뒤 내리는 것이 이 시기에 잘 맞습니다.',
  indigo:  '다만 지금은 인디고 카드 영향으로 가치 있는 것에만 집중하고 불필요한 소비를 줄이려는 마음이 강해질 수 있습니다. 의미 있는 곳에 집중적으로 투자하는 것이 이 시기에 좋습니다.',
  violet:  '다만 지금은 바이올렛 카드 영향으로 감성적인 소비 욕구가 높아질 수 있습니다. 감정에 따른 충동 구매보다 실질적인 필요를 먼저 확인하는 것이 도움이 됩니다.',
  pink:    '다만 지금은 핑크 카드 영향으로 상대를 위한 소비나 관계 중심의 지출 욕구가 높아질 수 있습니다. 마음을 표현하되 서로 부담 없는 방식을 찾는 것이 이 시기에 좋습니다.',
  white:   '다만 지금은 화이트 카드 영향으로 불필요한 소비를 줄이고 지출을 정리하고 싶은 마음이 강해질 수 있습니다. 꼭 필요한 것만 남기고 나머지를 덜어내는 것이 이 시기에 잘 맞습니다.',
  black:   '다만 지금은 블랙 카드 영향으로 재정적 경계와 자신만의 기준을 지키려는 마음이 강해지는 시기입니다. 소비 방식에 대해 상대와 솔직하게 이야기하는 것이 이 시기에 중요합니다.',
  brown:   '다만 지금은 브라운 카드 영향으로 안정적인 재정 기반을 원하는 마음이 강해질 수 있습니다. 저축과 비상금 확보에 집중하는 것이 이 시기에 도움이 됩니다.',
  beige:   '다만 지금은 베이지 카드 영향으로 편안하고 안정적인 소비 패턴을 원하는 마음이 강해질 수 있습니다. 익숙하고 검증된 소비 방식을 유지하는 것이 이 시기에 좋습니다.',
  neutral: '다만 지금은 심리 상태가 고요하고 중립적인 시기입니다. 큰 재정 결정보다 현재의 소비 패턴을 점검하고 유지하는 것이 가장 좋습니다.',
  navy:    '다만 지금은 네이비 카드 영향으로 신뢰할 수 있는 재정 계획과 안정적인 기반을 원하는 마음이 강해질 수 있습니다. 장기적인 관점에서 재정을 점검하는 것이 이 시기에 맞습니다.',
  sky:     '다만 지금은 스카이블루 카드 영향으로 자유롭고 유연하게 소비하고 싶은 마음이 높아질 수 있습니다. 지나친 제약보다 합리적인 범위 안에서 유연하게 소비하는 것이 좋습니다.',
  mint:    '다만 지금은 민트 카드 영향으로 새로운 소비 방식이나 재정 계획을 시도하고 싶은 마음이 강해질 수 있습니다. 작은 변화부터 시도해보는 것이 이 시기에 활력이 됩니다.',
  peach:   '다만 지금은 피치 카드 영향으로 따뜻한 관계를 위한 소비 욕구가 높아질 수 있습니다. 상대와 함께하는 경험에 투자하되 서로 부담 없는 수준을 유지하는 것이 좋습니다.',
  coral:   '다만 지금은 코랄 카드 영향으로 활기차고 즉흥적인 소비 욕구가 강해지는 시기입니다. 이 활력을 긍정적으로 활용하되 충동 지출은 주의하는 것이 좋습니다.',
  gold:    '다만 지금은 골드 카드 영향으로 가치 있는 것에 투자하고 싶은 마음이 높아질 수 있습니다. 함께 의미 있는 목표를 위한 재정 계획을 세워보는 것이 이 시기에 좋습니다.',
  lavender:'다만 지금은 라벤더 카드 영향으로 감성적이고 섬세한 소비 욕구가 강해질 수 있습니다. 아름다움과 여유를 위한 소비는 허용하되 균형을 유지하는 것이 이 시기에 잘 맞습니다.',
  sage:    '다만 지금은 세이지 카드 영향으로 차분하고 신중하게 소비를 결정하고 싶은 마음이 강해지는 시기입니다. 서두르지 않고 천천히 판단하는 것이 이 시기에 가장 좋습니다.',
};

// 휴식방식(회복 및 충전 방식) 보충
const SUPPLEMENT_REST: Record<string, string> = {
  red:     '다만 지금은 레드 카드 영향으로 활동적으로 움직이면서 회복하고 싶은 마음이 강해지는 시기입니다. 함께 몸을 움직이는 활동이 이 시기에 충전에 도움이 됩니다.',
  orange:  '다만 지금은 오렌지 카드 영향으로 새로운 경험을 통해 충전하고 싶은 마음이 높아질 수 있습니다. 함께 새로운 장소나 활동을 시도해보는 것이 이 시기에 좋습니다.',
  yellow:  '다만 지금은 옐로우 카드 영향으로 가볍고 즐거운 방식으로 충전하고 싶은 마음이 강해지는 시기입니다. 부담 없이 웃을 수 있는 시간을 함께 만들어보는 것이 이 시기에 잘 맞습니다.',
  green:   '다만 지금은 그린 카드 영향으로 자연스럽고 균형 잡힌 방식으로 회복하고 싶은 마음이 강해질 수 있습니다. 무리하지 않고 자연 속에서 천천히 쉬는 것이 이 시기에 좋습니다.',
  blue:    '다만 지금은 블루 카드 영향으로 조용하고 혼자만의 시간을 통해 충전하고 싶은 마음이 강해질 수 있습니다. 각자의 회복 시간을 충분히 존중하는 것이 이 시기에 중요합니다.',
  indigo:  '다만 지금은 인디고 카드 영향으로 깊은 고독과 내면의 시간을 통해 충전하고 싶은 마음이 강해질 수 있습니다. 서두르지 않고 자신만의 방식으로 회복하는 것이 좋습니다.',
  violet:  '다만 지금은 바이올렛 카드 영향으로 감수성이 예민해지고 섬세한 방식으로 충전하고 싶은 마음이 강해질 수 있습니다. 감정을 억누르지 않고 부드럽게 흘려보내는 것이 이 시기에 회복에 도움이 됩니다.',
  pink:    '다만 지금은 핑크 카드 영향으로 따뜻한 연결과 함께하는 시간을 통해 충전하고 싶은 마음이 높아질 수 있습니다. 상대와 감정을 나누는 시간이 이 시기에 최고의 회복이 됩니다.',
  white:   '다만 지금은 화이트 카드 영향으로 비우고 정리하는 방식으로 충전하고 싶은 마음이 강해질 수 있습니다. 조용하고 단순한 환경 속에서 쉬는 것이 이 시기에 잘 맞습니다.',
  black:   '다만 지금은 블랙 카드 영향으로 자신만의 공간에서 경계를 지키며 충전하고 싶은 마음이 강해질 수 있습니다. 충분한 혼자만의 시간이 이 시기에 회복의 핵심입니다.',
  brown:   '다만 지금은 브라운 카드 영향으로 안정적이고 익숙한 환경에서 충전하고 싶은 마음이 강해질 수 있습니다. 집에서 루틴대로 쉬는 것이 이 시기에 가장 효과적입니다.',
  beige:   '다만 지금은 베이지 카드 영향으로 편안하고 따뜻한 환경에서 천천히 회복하고 싶은 마음이 강해질 수 있습니다. 익숙한 공간에서 여유롭게 쉬는 것이 이 시기에 좋습니다.',
  neutral: '다만 지금은 심리 상태가 고요하고 중립적인 시기입니다. 특별한 활동보다 현재의 회복 리듬을 그대로 유지하는 것이 가장 좋습니다.',
  navy:    '다만 지금은 네이비 카드 영향으로 신뢰할 수 있는 공간과 사람 안에서 충전하고 싶은 마음이 강해질 수 있습니다. 믿을 수 있는 환경 속에서 천천히 회복하는 것이 이 시기에 맞습니다.',
  sky:     '다만 지금은 스카이블루 카드 영향으로 자유롭고 가볍게 쉬고 싶은 마음이 높아질 수 있습니다. 부담 없이 열린 방식으로 쉬는 것이 이 시기에 좋습니다.',
  mint:    '다만 지금은 민트 카드 영향으로 신선하고 청량한 방식으로 충전하고 싶은 마음이 강해질 수 있습니다. 자연 속 산책이나 가벼운 활동이 이 시기에 활력이 됩니다.',
  peach:   '다만 지금은 피치 카드 영향으로 부드럽고 따뜻한 방식으로 충전하고 싶은 마음이 높아질 수 있습니다. 상대와 함께하는 따뜻한 시간이 이 시기에 최고의 회복이 됩니다.',
  coral:   '다만 지금은 코랄 카드 영향으로 활기차게 충전하고 싶은 마음이 강해지는 시기입니다. 이 활력을 함께 즐기는 활동으로 표현하는 것이 좋습니다.',
  gold:    '다만 지금은 골드 카드 영향으로 성취감을 통해 충전하고 싶은 마음이 높아질 수 있습니다. 함께 작은 목표를 이루는 활동이 이 시기에 회복에 도움이 됩니다.',
  lavender:'다만 지금은 라벤더 카드 영향으로 감성적이고 섬세한 방식으로 충전하고 싶은 마음이 강해질 수 있습니다. 부드럽고 여유 있는 회복 시간이 이 시기에 잘 맞습니다.',
  sage:    '다만 지금은 세이지 카드 영향으로 차분하고 조용한 방식으로 회복하고 싶은 마음이 강해지는 시기입니다. 서두르지 않고 자연스럽게 충전하는 것이 이 시기에 가장 좋습니다.',
};

// 갈등패턴(감정 표현 및 갈등 대응) 보충
const SUPPLEMENT_CONFLICT: Record<string, string> = {
  red:     '다만 지금은 레드 카드 영향으로 감정이 즉각적으로 올라오고 강하게 표현하고 싶은 마음이 커질 수 있습니다. 갈등 상황에서 한 박자 쉬고 반응하는 것이 이 시기에 특히 중요합니다.',
  orange:  '다만 지금은 오렌지 카드 영향으로 감정 표현이 활발해지고 변화를 원하는 마음이 높아질 수 있습니다. 갈등 후 새로운 방식으로 대화를 시도해보는 것이 이 시기에 도움이 됩니다.',
  yellow:  '다만 지금은 옐로우 카드 영향으로 갈등을 가볍게 넘기거나 유머로 풀려는 마음이 강해질 수 있습니다. 상대의 감정을 먼저 확인하고 공감해주는 것이 이 시기에 중요합니다.',
  green:   '다만 지금은 그린 카드 영향으로 균형과 조화를 원하는 마음이 강해질 수 있습니다. 갈등 후 서로의 감정을 인정하고 자연스럽게 회복하는 것이 이 시기에 잘 맞습니다.',
  blue:    '다만 지금은 블루 카드 영향으로 차분하게 내면을 정리하려는 마음이 강해질 수 있습니다. 갈등 후 충분한 시간을 갖고 감정을 정리한 뒤 대화하는 것이 이 시기에 좋습니다.',
  indigo:  '다만 지금은 인디고 카드 영향으로 깊이 생각하고 혼자 정리하려는 마음이 강해질 수 있습니다. 갈등 후 자신의 감정을 충분히 탐색한 뒤 상대와 대화하는 것이 이 시기에 좋습니다.',
  violet:  '다만 지금은 바이올렛 카드 영향으로 감수성이 예민해지고 감정이 깊어지는 시기입니다. 갈등 상황에서 감정이 증폭되지 않도록 부드럽게 표현하는 것이 이 시기에 특히 도움이 됩니다.',
  pink:    '다만 지금은 핑크 카드 영향으로 따뜻한 연결과 공감을 원하는 마음이 높아질 수 있습니다. 갈등 후 상대의 마음을 먼저 확인하고 따뜻하게 다가가는 것이 이 시기에 관계를 회복하는 가장 좋은 방법입니다.',
  white:   '다만 지금은 화이트 카드 영향으로 감정을 정리하고 비우려는 마음이 강해질 수 있습니다. 갈등 후 각자 감정을 정리하는 시간을 갖고 다시 연결하는 것이 이 시기에 잘 맞습니다.',
  black:   '다만 지금은 블랙 카드 영향으로 경계와 자기 보호 본능이 강해지는 시기입니다. 자신을 지키면서도 상대와의 연결을 유지하는 균형이 이 시기에 중요합니다.',
  brown:   '다만 지금은 브라운 카드 영향으로 안정과 현실적인 해결을 원하는 마음이 강해질 수 있습니다. 갈등 후 실질적인 해결책을 함께 찾는 것이 이 시기에 도움이 됩니다.',
  beige:   '다만 지금은 베이지 카드 영향으로 편안하고 안정적인 방식으로 갈등을 해결하고 싶은 마음이 강해질 수 있습니다. 익숙하고 따뜻한 방식으로 대화하는 것이 이 시기에 좋습니다.',
  neutral: '다만 지금은 심리 상태가 고요하고 중립적인 시기입니다. 감정적인 반응보다 차분하게 상황을 바라보는 것이 갈등 해결에 도움이 됩니다.',
  navy:    '다만 지금은 네이비 카드 영향으로 신뢰와 안정을 원하는 마음이 강해질 수 있습니다. 갈등 후 서로에 대한 신뢰를 확인하고 천천히 회복하는 것이 이 시기에 맞습니다.',
  sky:     '다만 지금은 스카이블루 카드 영향으로 자유롭고 가볍게 갈등을 해소하고 싶은 마음이 높아질 수 있습니다. 무거운 대화보다 가볍게 연결하는 방식이 이 시기에 효과적입니다.',
  mint:    '다만 지금은 민트 카드 영향으로 새로운 방식으로 갈등을 해결하고 싶은 마음이 강해질 수 있습니다. 기존 패턴에서 벗어나 새로운 대화 방식을 시도해보는 것이 이 시기에 도움이 됩니다.',
  peach:   '다만 지금은 피치 카드 영향으로 부드럽고 따뜻하게 갈등을 풀고 싶은 마음이 높아질 수 있습니다. 상대에게 먼저 따뜻하게 다가가는 것이 이 시기에 관계를 회복하는 가장 좋은 방법입니다.',
  coral:   '다만 지금은 코랄 카드 영향으로 활기차고 직접적인 감정 표현 욕구가 강해지는 시기입니다. 이 마음을 긍정적인 방향으로 표현하되 상대의 속도를 배려하는 것이 중요합니다.',
  gold:    '다만 지금은 골드 카드 영향으로 자신감과 주도적으로 해결하고 싶은 마음이 높아질 수 있습니다. 상대의 의견도 충분히 듣고 함께 해결책을 찾는 것이 이 시기에 좋습니다.',
  lavender:'다만 지금은 라벤더 카드 영향으로 감성적이고 섬세한 감정 흐름이 강해질 수 있습니다. 갈등 후 감정을 부드럽게 표현하고 상대의 감정도 섬세하게 살피는 것이 이 시기에 잘 맞습니다.',
...
export function getRelationArchetype(
  ...
  const SECTION_WEIGHTS: Record<string, SectionWeightProfile> = {
    ...
    finance:    { c1: 0.60, c2: 0.40, c3: 0.00, card: 0.00 }, // 재정 스타일: 1순위 60% + 2순위 40% 기질 중심 (3순위·카드 제외)
    lifestyle:  { c1: 0.60, c2: 0.40, c3: 0.00, card: 0.00 }, // 생활패턴/공간: 1순위 60% + 2순위 40% 기질 중심 (3순위·카드 제외)
  };
  ...
  const sameExprDescMap: Record<EnergyFamily, string> = {
    ...
    cool_deep: '두 사람 모두 내면 처리 후 표현하는 편입니다. 서로의 침묵을 이해하지만 둘 다 기다리다 연결이 늦어지는 경향이 나타날 수 있습니다.',
  ...
  const sameExprLabelDescMap: Record<string, string> = {
    ...
    '내면 처리 후 표현': '두 사람 모두 내면에서 먼저 정리한 후 표현하는 편입니다. 서로의 침묵을 이해하지만 둘 다 기다리다 연결이 늦어지는 경향이 나타날 수 있습니다.',
  ...
  const LIFESTYLE_MAP: Partial<Record<string, LifestyleSections>> = {
    ...
    'red-pink': {
      ...
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 행동으로, 다른 사람은 공감과 따뜻한 반응으로 사랑을 확인합니다.',
        personA: '"밥 먹었어?" "내가 해줄게." 챙김과 행동이 사랑의 언어입니다.',
        personB: '"내 말 들어줘. 먼저 공감해줘." 해결보다 공감과 정서적 연결이 사랑의 언어입니다.',
        tip: '한 사람은 행동으로 사랑을 표현하고, 다른 사람은 공감받을 때 사랑을 느낍니다. "나는 공감이 먼저야"라고 알려주세요.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 바로 해결하고 싶고, 다른 사람은 먼저 공감받고 감정이 가라앉아야 합니다.',
        personA: '"지금 바로 얘기하자. 이대로 자면 안 돼." 즉각 해결을 원합니다.',
        personB: '"먼저 내 마음 알아줘. 그래야 얘기할 수 있어." 공감 후 대화형입니다.',
        tip: '"많이 힘들었구나"라는 한 마디가 해결보다 먼저입니다. 공감 후 30분 뒤 다시 얘기하세요.',
      },
    },
    // ── red + blue 조합 ──
    'red-blue': {
    ...
    'red-white': {
      ...
      cleaning: {
        ...
        tension: '한 사람이 치워놓으면 다른 사람이 다시 정리하는 경향이 나타날 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
    ...
    'pink-indigo': {
      finance: {
        ...
        tension: '"왜 이렇게 신중해?"와 "왜 이렇게 충동적이야?"가 반복될 수 있습니다. 소비 기준이 다릅니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
      ...
      rest: {
        ...
        tension: '"왜 혼자 있으려 해? 나 싫어?"와 "나 지금 충전 중이야"가 반복될 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 공감과 따뜻한 반응을 먼저 원하고, 다른 사람은 깊은 대화와 신뢰로 사랑을 표현합니다.',
        personA: '"내 말 들어줘. 먼저 공감해줘." 해결보다 공감과 정서적 연결이 사랑의 언어입니다.',
        personB: '"네 얘기 다 들어줄게." "믿어." 깊은 신뢰와 진심 어린 대화가 사랑의 언어입니다.',
        tip: '한 사람은 공감이 먼저, 다른 사람은 신뢰가 먼저입니다. "나는 먼저 공감받고 싶어"라고 알려주세요.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 즉각 공감받고 싶고, 다른 사람은 내면에서 천천히 정리합니다.',
        personA: '"지금 당장 내 감정 알아줘. 해결보다 공감이 먼저야." 즉각 공감 요청형입니다.',
        personB: '"조금만 시간 줘. 나 아직 정리가 안 됐어." 내면 정리 후 대화형입니다.',
        tip: '"지금 네 마음이 힘들구나"라는 한 마디가 논리적 해결보다 먼저 필요합니다.',
      },
    },
    // ── indigo + yellow 조합 ──
    'indigo-yellow': {
      ...
      cleaning: {
        ...
        tension: '"왜 이걸 버려?"와 "왜 이걸 아직도 갖고 있어?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
    ...
    // ── pink + red 조합 (red-pink 역방향 — swap 로직으로 처리되므로 별도 키 불필요하나 명시적 추가) ──
    // NOTE: pink-red 입력 시 swap 로직이 red-pink 데이터를 personA/B 교환해 사용함
    // ── blue + white 조합 (white-blue 역방향) ──
    // NOTE: blue-white 입력 시 swap 로직이 white-blue 데이터를 personA/B 교환해 사용함
    // ── green + red 조합 ──
    'red-green': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 즉각적인 추진력으로 소비하고, 다른 사람은 관계와 균형을 고려하며 신중하게 소비합니다.',
        personA: '"지금 필요하면 바로 사자. 기회를 놓치면 후회해." 빠른 결정형 소비입니다.',
        personB: '"우리 함께 쓰는 거니까 같이 결정하자. 균형이 중요해." 관계 중심 소비입니다.',
        tension: '"왜 혼자 결정해?"와 "왜 이렇게 느려?"가 반복될 수 있습니다. 소비 결정 속도의 차이가 갈등 포인트입니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 빠른 실행을 선호하고, 다른 사람은 모두가 편안한 공간을 만들고 싶어합니다.',
        personA: '"일단 치우자. 빠르게 끝내는 게 좋아." 속도 우선 정리형입니다.',
        personB: '"같이 하면 더 좋아. 서로 불편하지 않게 정리하자." 조율 중심 정리형입니다.',
        tension: '한 사람이 혼자 빠르게 치우면 다른 사람은 "나한테 물어보지도 않고"라고 느낄 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 활동하며 기분을 전환하고, 다른 사람은 관계 안에서 안정을 찾으며 회복합니다.',
        personA: '"나가서 뭔가 하면 기분 풀려. 움직여야 회복돼." 활동 전환형입니다.',
        personB: '"같이 있으면서 편안하게 쉬고 싶어. 관계 안에서 충전돼." 관계 회복형입니다.',
        tension: '한 사람이 나가자고 할 때 다른 사람은 "그냥 같이 있으면 안 돼?"라고 느낄 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 행동으로, 다른 사람은 따뜻한 연결과 배려로 사랑을 표현합니다.',
        personA: '"내가 해줄게. 필요한 거 있으면 말해." 행동과 챙김이 사랑의 언어입니다.',
        personB: '"같이 있는 시간이 좋아. 네가 편안하면 나도 편안해." 연결과 조화가 사랑의 언어입니다.',
        tip: '서로의 사랑 언어가 다릅니다. "나는 이렇게 표현해"라고 먼저 알려주세요.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 즉각 해결을 원하고, 다른 사람은 관계 회복을 먼저 원합니다.',
        personA: '"지금 바로 얘기하자. 이대로 두면 안 돼." 즉각 해결형입니다.',
        personB: '"먼저 우리 사이가 괜찮아야 해. 감정이 풀리면 얘기하자." 관계 회복 우선형입니다.',
        tip: '"많이 힘들었지"라는 한 마디가 해결보다 먼저 필요합니다.',
      },
    },
    // ── green + red 역방향 조합 (green이 첫 번째 사람일 때) ──
    // NOTE: red-green 키는 레드가 personA(즉각 표현), 그린이 personB(관계 회복).
    //       green-red 키는 그린이 personA(내면 정리·관계 회복), 레드가 personB(즉각 표현).
    'green-red': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 관계와 균형을 고려하며 신중하게 소비하고, 다른 사람은 즉각적인 추진력으로 소비합니다.',
        personA: '"우리 함께 쓰는 거니까 같이 결정하자. 균형이 중요해." 관계 중심 소비입니다.',
        personB: '"지금 필요하면 바로 사자. 기회를 놓치면 후회해." 빠른 결정형 소비입니다.',
        tension: '"왜 혼자 결정해?"와 "왜 이렇게 느려?"가 반복될 수 있습니다. 소비 결정 속도의 차이가 갈등 포인트입니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 모두가 편안한 공간을 원하고, 다른 사람은 빠른 실행을 선호합니다.',
        personA: '"같이 하면 더 좋아. 서로 불편하지 않게 정리하자." 조율 중심 정리형입니다.',
        personB: '"일단 치우자. 빠르게 끝내는 게 좋아." 속도 우선 정리형입니다.',
        tension: '다른 사람이 혼자 빠르게 치우면 "나한테 물어보지도 않고"라고 느낄 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 관계 안에서 안정을 찾으며 회복하고, 다른 사람은 활동하며 기분을 전환합니다.',
        personA: '"같이 있으면서 편안하게 쉬고 싶어. 관계 안에서 충전돼." 관계 회복형입니다.',
        personB: '"나가서 뭔가 하면 기분 풀려. 움직여야 회복돼." 활동 전환형입니다.',
        tension: '다른 사람이 나가자고 할 때 "그냥 같이 있으면 안 돼?"라고 느낄 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 따뜻한 연결과 배려로, 다른 사람은 행동과 챙김으로 사랑을 표현합니다.',
        personA: '"같이 있는 시간이 좋아. 네가 편안하면 나도 편안해." 연결과 조화가 사랑의 언어입니다.',
        personB: '"내가 해줄게. 필요한 거 있으면 말해." 행동과 챙김이 사랑의 언어입니다.',
        tip: '공감이 먼저입니다. "나는 이렇게 사랑받을 때 좋아"라고 먼저 알려주면 두 사람 모두 편해집니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 관계 회복을 먼저 원하고, 다른 사람은 즉각 해결을 원합니다.',
        personA: '"먼저 우리 사이가 괜찮아야 해. 감정이 풀리면 얘기하자." 관계 회복 우선형입니다.',
        personB: '"지금 바로 얘기하자. 이대로 두면 안 돼." 즉각 해결형입니다.',
        tip: '해결보다 공감이 먼저입니다. "많이 힘들었지"라는 한 마디가 대화의 문을 열어줍니다.',
      },
    },
    // ── black + lavender 조합 ──
    'black-lavender': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 원칙과 기준 중심 소비, 다른 사람은 감성적 안정과 아름다움을 위한 소비를 합니다.',
        personA: '"꼭 필요한 것만 사야 해. 기준 없이 쓰면 안 돼." 원칙·절제형 소비입니다.',
        personB: '"이게 있으면 마음이 편안해질 것 같아. 감성적인 것도 필요해." 감성 안정형 소비입니다.',
        tension: '"왜 이런 걸 사?"와 "이게 나한테 필요해"가 반복될 수 있습니다. 소비 기준이 다릅니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 군더더기 없는 정돈을 원하고, 다른 사람은 감성적이고 아늑한 공간을 원합니다.',
        personA: '"필요한 것만 두자. 비워야 마음이 편해." 미니멀 정리형입니다.',
        personB: '"예쁘고 아늑한 분위기가 있어야 편안해. 감성적인 소품도 필요해." 감성 공간형입니다.',
        tension: '한 사람이 치우면 다른 사람은 "내 물건 어디 갔어?"라고 느낄 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 완전한 고요 속에서, 다른 사람은 감성적인 분위기 안에서 회복합니다.',
        personA: '"혼자 조용히 있어야 충전돼. 자극이 없어야 쉬어지는 느낌이야." 고요 회복형입니다.',
        personB: '"좋아하는 음악 틀고, 향 피우고, 아늑한 공간에서 쉬어야 회복돼." 감성 회복형입니다.',
        tension: '두 사람 모두 혼자 쉬고 싶은 편이라, 서로 연결이 끊어지는 느낌이 반복될 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 신뢰와 행동으로, 다른 사람은 감성적인 분위기와 따뜻한 말로 사랑을 표현합니다.',
        personA: '"말 안 해도 알잖아. 내가 여기 있는 게 표현이야." 존재형·신뢰형 표현입니다.',
        personB: '"오늘 예뻐. 네가 옆에 있어서 좋아." 감성적인 말과 분위기가 사랑의 언어입니다.',
        tip: '"왜 표현을 안 해?"보다 "이런 게 나한테 사랑이야"라고 먼저 알려주세요.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 혼자 정리하고, 다른 사람은 감정이 가라앉기를 기다립니다.',
        personA: '"나 혼자 정리할게. 다 정리되면 얘기하자." 완전 정리 후 대화형입니다.',
        personB: '"지금 많이 힘들어. 조금만 기다려줘." 감정 안정 후 대화형입니다.',
        tip: '두 사람 모두 먼저 말하기 어렵습니다. "나 지금 정리 중이야"라는 신호만으로도 거리감이 줄어듭니다.',
      },
    },
    // ── lavender + black 조합 (black-lavender 역방향) ──
    // NOTE: lavender-black 입력 시 swap 로직이 black-lavender 데이터를 personA/B 교환해 사용함
    // ── indigo + green 조합 ──
    'indigo-green': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 의미와 가치 중심 소비, 다른 사람은 관계와 균형을 고려한 소비를 합니다.',
        personA: '"이게 정말 가치 있는 건지가 중요해. 의미 없는 소비는 싫어." 가치·의미 중심 소비입니다.',
        personB: '"우리가 함께 쓰는 거니까 같이 결정하자. 균형이 중요해." 관계·균형 중심 소비입니다.',
        tension: '두 사람 모두 신중한 편이지만, 기준이 달라 "왜 이걸 샀어?"가 생깁니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 조용하고 정돈된 공간, 다른 사람은 모두가 편안한 공간을 원합니다.',
        personA: '"물건이 너무 많으면 마음이 무거워. 필요한 것만 두자." 미니멀 정리형입니다.',
        personB: '"우리 둘 다 편한 공간이어야 해. 같이 정리하자." 조율 중심 정리형입니다.',
        tension: '한 사람이 혼자 정리하면 다른 사람은 "나한테 물어보지도 않고"라고 느낄 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 혼자 내면을 정리하며 회복하고, 다른 사람은 관계 안에서 안정을 찾습니다.',
        personA: '"오늘은 혼자 조용히 있고 싶어. 생각 정리할 시간이 필요해." 내면 회복형입니다.',
        personB: '"같이 있으면서 편안하게 쉬고 싶어. 관계 안에서 충전돼." 관계 회복형입니다.',
        tension: '"왜 혼자 있으려 해?"와 "나 지금 충전 중이야"가 반복될 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 깊은 대화와 신뢰로, 다른 사람은 따뜻한 배려와 연결로 사랑을 표현합니다.',
        personA: '"네 생각이 궁금해. 진심 어린 대화가 좋아." 깊은 연결형입니다.',
        personB: '"같이 있는 시간이 좋아. 네가 편안하면 나도 편안해." 따뜻한 연결형입니다.',
        tip: '서로의 사랑 언어가 다릅니다. 상대방의 방식도 사랑임을 인정하는 것이 먼저입니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 내면에서 천천히 정리하고, 다른 사람은 관계 회복을 먼저 원합니다.',
        personA: '"나 아직 정리가 안 됐어. 조금만 기다려줘." 내면 정리 후 대화형입니다.',
        personB: '"먼저 우리 사이가 괜찮아야 해. 화해하고 싶어." 관계 회복 우선형입니다.',
    ...
    'white-indigo': {
      finance: {
        title: '재정 스타일 차이',
        description: '두 사람 모두 신중한 편이지만, 한 사람은 비움·절제, 다른 사람은 의미·가치 중심 소비를 합니다.',
        personA: '"꼭 필요한 것만 사자. 비워야 편해." 절제·정화형 소비입니다.',
        personB: '"이게 정말 가치 있는 건지가 중요해. 의미 없는 소비는 싫어." 가치·의미 중심 소비입니다.',
      ...
      cleaning: {
        ...
        personB: '"물건이 제자리에 있어야 해. 정돈된 공간이 필요해." 질서·정돈 중심입니다.',
        tension: '"왜 이걸 버려?"와 "왜 이렇게 쌓아둬?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '두 사람 모두 조용한 회복을 선호하지만, 한 사람은 완전한 고요, 다른 사람은 내면 탐색으로 충전합니다.',
        personA: '"아무것도 안 하고 조용히 있어야 충전돼." 고요 회복형입니다.',
        personB: '"혼자 생각 정리하거나 책 읽어야 충전돼." 내면 탐색형입니다.',
        tension: '두 사람 모두 혼자 쉬는 편이라, 감정 표현이 줄어들면 서로 멀어지는 느낌이 생깁니다.',
      },
      affection: {
        title: '애정 표현 방식',
      ...
      conflict: {
        ...
        personB: '"나 아직 정리가 안 됐어. 조금만 기다려줘." 내면 정리 후 대화형입니다.',
        tip: '두 사람 모두 먼저 말하기 어렵습니다. "나 지금 정리 중이야"라는 신호를 보내는 것만으로도 거리감이 줄어듭니다.',
      },
    },
    // ── white + blue 조합 ──
    'white-blue': {
      ...
      cleaning: {
        ...
        tension: '"왜 이걸 버려?"와 "왜 이렇게 쌓아둬?"가 반복될 수 있습니다. 정리 기준이 다릅니다.',
      },
      rest: {
        title: '휴식·회복 방식',
  ...
  const FULL_LIFESTYLE_MAP: Partial<Record<string, LifestyleSections>> = {
    ...
    'red-blue-black|pink-indigo-yellow': {
      finance: {
        ...
        tension: '소비 기준이 달라 "왜 이걸 샀어?"와 "왜 이렇게 딱딱해?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
    ...
    'white-blue-black|red-yellow-purple': {
      finance: {
        ...
        tension: '"왜 이렇게 충동적이야?"와 "왜 이렇게 소극적이야?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        ...
        tension: '"왜 이렇게 어질러?"와 "왜 이렇게 딱딱해?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
    ...
    'magenta-cream-lavender|magenta-cream-lavender': {
      ...
      conflict: {
        title: '갈등 직후 반응',
        description: '두 사람 모두 감정이 먼저이고, 상처에 민감한 경향이 있을 수 있습니다.',
    ...
    'red-orange-coral|pink-beige-cream': {
      finance: {
        ...
        tension: '"왜 이렇게 충동적이야?"와 "왜 이렇게 소극적이야?"가 반복될 수 있습니다. 소비 전 간단한 기준 합의가 마찰을 줄입니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
    ...
    'orange-white-yellow|blue-indigo-violet': {
      ...
      affection: {
        ...
        tip: '"왜 이렇게 즉흥적이야?"보다 "나는 이런 방식이 사랑이야"라고 먼저 알려주면 오해가 줄어듭니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'coral-pink-beige|indigo-violet-black': {
      finance: {
        ...
        tension: '"왜 이렇게 감정적으로 써?"와 "왜 이렇게 인색해?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        ...
        tension: '공간 기준이 달라 "왜 이걸 버려?"와 "왜 이걸 아직도 갖고 있어?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
    ...
    'magenta-pink-coral|white-beige-cream': {
      ...
      cleaning: {
        ...
        tension: '공간 취향이 달라 "왜 이렇게 복잡해?"와 "왜 이렇게 썰렁해?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
      ...
      affection: {
        ...
        tip: '"왜 이렇게 조용해?"보다 "이런 게 나한테 사랑이야"라고 먼저 알려주면 서로의 표현 방식을 이해할 수 있습니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'red-orange-yellow|green-sage-mint': {
      ...
      affection: {
        ...
        tip: '활동적 표현과 조용한 연결 사이에서 "이런 게 나한테 사랑이야"라고 먼저 알려주면 서로를 이해하기 쉽습니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'blue-indigo-black|white-beige-cream': {
      ...
      affection: {
        ...
        personB: '"말 없이도 알아줬으면 해. 조용히 옆에 있어줘." 조용한 진심형입니다.',
        tip: '두 사람 모두 절제된 표현을 선호해 "표현이 부족하다"고 느낄 수 있습니다. "오늘 고마웠어"라는 짧은 한 마디가 두 사람 사이를 따뜻하게 유지합니다.'
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'indigo-violet-purple|pink-lavender-cream': {
      finance: {
        ...
        tension: '"왜 이렇게 실용적으로 써?"와 "왜 이렇게 감정적으로 써?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        ...
        tension: '공간 취향이 달라 "왜 이렇게 새로운 것을 자꾸 사?"와 "왜 이렇게 썰렁해?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
      ...
      affection: {
        ...
        personB: '"오늘 예쁨. 보고 싶었어. 안아줘." 따뜻한 표현·감성형입니다.',
        tip: '"왜 이렇게 진지해?"보다 "나는 이런 게 사랑이야"라고 먼저 알려주세요. 감성적 표현과 깊은 연결 모두 사랑의 언어입니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'green-sage-teal|white-beige-cream': {
      ...
      affection: {
        ...
        personB: '"말 없이도 알아줬으면 해. 조용히 옆에 있어줘." 조용한 진심형입니다.',
        tip: '두 사람 모두 조용한 표현을 선호해 서로 멀어지는 느낌이 생길 수 있습니다. "오늘 좋았어"라는 짧은 한 마디가 연결을 유지합니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
    ...
    'yellow-gold-beige|blue-sky-white': {
      finance: {
        ...
        tension: '"왜 이렇게 화려하게 써?"와 "왜 이렇게 따져?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
      ...
      affection: {
        ...
        tip: '밝고 즉흥적인 표현과 진지한 신뢰 사이에서 "이런 게 나한테 사랑이야"라고 먼저 알려주면 서로를 이해하기 쉽습니다.'
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 빠르게 털고 넘어가려 하고, 다른 사람은 충분히 정리한 후 대화하려 합니다.',
    ...
    // ── indigo-black-pink + lavender-pink-cream 조합 (내면·깊이 vs 감성·안정) ──
    'indigo-black-pink|lavender-pink-cream': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 의미·원칙 중심 소비, 다른 사람은 감성적 안정과 따뜻한 연결을 위한 소비를 합니다.',
        personA: '"이게 정말 가치 있는 건지가 중요해. 원칙 없이 쓰면 안 돼." 가치·원칙 중심 소비입니다.',
        personB: '"이게 있으면 마음이 편안해질 것 같아. 감성적인 것도 필요해." 감성 안정형 소비입니다.',
        tension: '"왜 이런 걸 사?"와 "이게 나한테 필요해"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 조용하고 정돈된 공간, 다른 사람은 감성적이고 따뜻한 공간을 원합니다.',
        personA: '"필요한 것만 두자. 비워야 마음이 편해." 미니멀 정리형입니다.',
        personB: '"예쁘고 따뜻한 분위기가 있어야 편안해. 감성적인 소품도 필요해." 감성 공간형입니다.',
        tension: '한 사람이 치우면 다른 사람은 "내 물건 어디 갔어?"라고 느낄 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 혼자 내면을 탐색하며 회복하고, 다른 사람은 감성적인 분위기와 따뜻한 연결 안에서 회복합니다.',
        personA: '"혼자 생각 정리하거나 의미 있는 걸 하면서 충전돼." 내면 탐색형입니다.',
        personB: '"좋아하는 음악 틀고, 따뜻한 분위기에서 쉬어야 회복돼." 감성 회복형입니다.',
        tension: '한 사람이 혼자 있고 싶을 때 다른 사람은 연결을 원해 방향이 엇갈리는 경향이 나타날 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 깊은 대화와 신뢰로, 다른 사람은 감성적인 말과 따뜻한 분위기로 사랑을 표현합니다.',
        personA: '"네 생각이 궁금해. 진심 어린 대화가 좋아." 깊은 연결형입니다.',
        personB: '"오늘 예쁨. 네가 옆에 있어서 좋아." 감성적인 말과 분위기가 사랑의 언어입니다.',
        tip: '"왜 표현을 안 해?"보다 "이런 게 나한테 사랑이야"라고 먼저 알려주세요.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 혼자 정리하고, 다른 사람은 빨리 화해하고 싶어합니다.',
        personA: '"나 아직 정리가 안 됐어. 조금만 기다려줘." 내면 정리 후 대화형입니다.',
        personB: '"빨리 화해하고 싶어. 지금 안아줘." 즉각 연결 회복형입니다.',
        tip: '"나 지금 정리 중이야, 조금만 기다려줘"라는 신호가 오해를 줄입니다.',
      },
    },
    // ── white-blue-red + orange-yellow-warm 조합 (정돈·신뢰 vs 활동·표현) ──
    'white-blue-red|orange-yellow-warm': {
      finance: {
        title: '재정 스타일 차이',
        description: '한 사람은 계획·신뢰 기반 소비, 다른 사람은 활동·경험 중심 소비를 합니다.',
        personA: '"계획적으로 쓰자. 비상금은 꼭 있어야 해." 안정·계획형 소비입니다.',
        personB: '"지금 즐거운 게 중요해. 경험에 쓰는 게 아까워." 활동·경험형 소비입니다.',
        tension: '"왜 이렇게 충동적으로 써?"와 "왜 이렇게 소극적으로 써?"가 반복될 수 있습니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        description: '한 사람은 정돈된 공간을 원하고, 다른 사람은 활동적이고 생동감 있는 공간을 원합니다.',
        personA: '"제자리에 있어야 해. 정돈된 공간이 심리적 안정이야." 정돈·신뢰형입니다.',
        personB: '"조금 어질러진 게 살아있는 느낌이야. 너무 정돈하면 답답해." 자유·활동형입니다.',
        tension: '"왜 이렇게 어질러?"와 "왜 이렇게 예민해?"가 반복될 수 있습니다.',
      },
      rest: {
        title: '휴식·회복 방식',
        description: '한 사람은 루틴 안에서, 다른 사람은 새로운 자극과 활동으로 회복합니다.',
        personA: '"정해진 루틴대로 하면 자연스럽게 회복돼." 루틴 회복형입니다.',
        personB: '"어딘가 새로운 데 가보자. 집에만 있으면 답답해." 활동 전환형입니다.',
        tension: '한 사람이 집에서 쉬고 싶을 때 다른 사람은 "왜 집에만 있어?"라고 느낄 수 있습니다.',
      },
      affection: {
        title: '애정 표현 방식',
        description: '한 사람은 일관된 신뢰로, 다른 사람은 즉흥적인 표현과 활동으로 사랑을 표현합니다.',
        personA: '"매일 연락하고, 약속 지키는 게 사랑이야." 꾸준한 신뢰형입니다.',
        personB: '"갑자기 안아주고 싶어." "오늘 뭐 하자." 즉흥적 표현형입니다.',
        tip: '"왜 갑자기 이래?"보다 "이런 표현이 좋아"라고 말해주면 두 사람 모두 편해집니다.',
      },
      conflict: {
        title: '갈등 직후 반응',
        description: '한 사람은 논리적으로 정리하려 하고, 다른 사람은 즉각 감정을 표현합니다.',
        personA: '"감정적으로 말하면 해결이 안 돼. 진정되면 얘기하자." 논리 정리형입니다.',
        personB: '"지금 당장 얘기해야 해. 이 감정 그냥 넘기면 안 돼." 즉각 반응형입니다.',
        tip: '"지금 많이 화났구나"라는 한 마디가 논리보다 먼저 필요합니다.',
      },
    },
  };
  ...
  const PROFILE_CONTRAST_OVERRIDE_MAP: Partial<Record<string, ProfileContrastOverride>> = {
    ...
    'red-white-blue|pink-indigo-yellow': {
      ...
      relationFlow: '한 사람이 먼저 결정하고 실행하면, 다른 사람은 "왜 나한테 먼저 물어보지 않았어?"라고 느끼는 흐름이 반복될 수 있습니다. 결정 속도의 차이가 관계 패턴이 됩니다. 빠른 사람이 기다려주고, 신중한 사람이 의견을 먼저 내는 연습이 이 관계의 균형을 만듭니다.',
      ...
      conflictPattern: '한 사람은 "이미 해결했잖아"라고 느끼고, 다른 사람은 "아직 마음이 안 풀렸어"라고 느끼는 순간이 반복될 수 있습니다. 해결 속도와 감정 회복 속도가 다릅니다. "다 끝났지?"보다 "아직 마음에 남은 게 있어?"라고 먼저 물어봐 주세요.',
    ...
    'red-blue-black|pink-indigo-yellow': {
      ...
      relationFlow: '한 사람이 논리적으로 정리하려 하면, 다른 사람은 "내 감정은 어디 갔어?"라고 느끼는 경향이 나타날 수 있습니다. 논리와 감정이 번갈아 충돌합니다. "맞고 틀리고"보다 "네 마음이 어때?"가 먼저 필요한 관계입니다.',
    ...
    'white-blue-black|red-yellow-purple': {
      ...
      relationFlow: '한 사람이 조용히 거리를 두면, 다른 사람은 "왜 갑자기 말이 없어?"라고 불안해합니다. 거리와 활발함이 번갈아 충돌하는 경향이 나타날 수 있습니다. "나 지금 충전 중이야"라고 말해주는 것만으로도 상대의 불안이 줄어듭니다.',
    ...
    'blue-indigo-black|white-beige-cream': {
      ...
      relationFlow: '두 사람 모두 혼자 있는 시간이 필요한 패턴입니다. 한 사람이 조용해지면 다른 사람도 조용해지고, 서로 연결이 끊어진 느낌이 반복될 수 있습니다. 주기적으로 "오늘 어땠어?"라고 먼저 연결을 시도하는 것이 이 관계의 숙제입니다.',
      ...
      conflictPattern: '두 사람 모두 혼자 정리하려 하여 갈등 후 연결이 늦어지는 경향이 나타날 수 있습니다. "언제쯤 얘기할 수 있어?"라고 시간을 정해두면 두 사람 모두 덜 불안합니다.',
    ...
    'indigo-violet-purple|pink-lavender-cream': {
      ...
      relationFlow: '한 사람이 혼자 생각하고 있을 때, 다른 사람은 연결을 원해 방향이 엇갈리는 경향이 나타날 수 있습니다. "나 지금 생각 중이야, 조금만 기다려줘"라는 신호와 "그래, 기다릴게"라는 여유가 이 관계의 균형입니다.',
    ...
    'green-sage-teal|white-beige-cream': {
      ...
      relationFlow: '두 사람 모두 조용하고 신중한 패턴입니다. 갈등이 생겨도 직접 표현하지 않아 서로 눈치만 보는 흐름이 반복될 수 있습니다. 먼저 "나 요즘 이런 게 신경 쓰여"라고 말하는 연습이 이 관계의 숙제입니다.',
      ...
      conflictPattern: '두 사람 모두 조용히 정리하려 하여 갈등 후 연결이 늦어지는 경향이 나타날 수 있습니다. "잠깐 산책하고 와서 얘기하자"는 제안이 이 관계에서 효과적입니다.',
    ...
    'yellow-gold-beige|blue-sky-white': {
      ...
      relationFlow: '한 사람이 활발하게 표현할 때, 다른 사람은 아직 신뢰를 쌓는 중인 경향이 나타날 수 있습니다. "나는 이렇게 표현하는 게 자연스러워"라고 먼저 알려주는 것이 이 관계의 시작입니다.',
    ...
    'indigo|yellow': {
      ...
      conflictPattern: '한 사람이 조용해지면, 다른 사람은 "뭔가 잘못됐나?"라고 불안해합니다. 침묵이 거리감으로 번지는 경향이 나타날 수 있습니다. "나 지금 생각 중이야"라고 먼저 말해주는 것이 이 관계의 숙제입니다.',
    ...
    'purple-yellow-red|orange-white-yellow': {
      ...
      relationFlow: '한 사람이 신중하게 결정하려 할 때, 다른 사람은 이미 행동하고 있는 경향이 나타날 수 있습니다. 결정 속도와 생활 리듬이 다릅니다. "나 먼저 생각해볼게"라는 신호와 "그래, 기다릴게"라는 여유가 이 관계의 균형입니다.',
      ...
      conflictPattern: '한 사람은 "나 아직 정리 중이야"라고 느끼고, 다른 사람은 "왜 말을 안 해?"라고 불안해합니다. 침묵과 표현 욕구가 충돌하는 경향이 나타날 수 있습니다. "나 지금 정리 중이야, 조금만 기다려줘"라는 신호가 오해를 줄입니다.',
    ...
    'orange-white-yellow|purple-yellow-red': {
      ...
      relationFlow: '한 사람이 이미 행동하고 있을 때, 다른 사람은 아직 생각 중인 경향이 나타날 수 있습니다. "먼저 생각해볼게"라는 신호와 "그래, 기다릴게"라는 여유가 이 관계의 균형입니다.',
    ...
    'magenta-cream-lavender|magenta-cream-lavender': {
      ...
      relationFlow: '두 사람 모두 감정이 먼저인 패턴입니다. 한 사람이 상처받으면 다른 사람도 민감하게 반응하는 흐름이 반복될 수 있습니다. 서로의 감정을 먼저 확인하는 습관이 이 관계를 안정적으로 만듭니다.',
  ...
  const EXPR_LABEL_PAIR_TO_EXPR_DIFF: Record<string, string> = {
    ...
    '내면 처리 후 표현|내면 처리 후 표현': '두 사람 모두 내면에서 먼저 정리한 후 표현하는 편입니다. 서로의 침묵을 이해하지만 둘 다 기다리다 연결이 늦어지는 경향이 나타날 수 있습니다.',
...
function buildDefaultLifestyleSections(
  ...
  const getShapeLifestyleNote = (shape?: string): string => {
    ...
    const notes: Record<string, string> = {
      ...
      hexagon: '갈등 직후 관계를 지키려는 마음에 자신의 감정을 숨기는 경향이 있을 수 있습니다. 상대는 실제 상태를 모를 수 있습니다.',
    };
    return notes[shape] ?? '';
  };
...
const FRIEND_ARCHETYPE_DATA: Record<FriendArchetype, LightArchetypeResult> = {
  편안한공감형: {
    ...
    misunderstandingPattern: '배려하느라 솔직한 말을 참다가 나중에 서운함이 쌓이는 경향이 있을 수 있습니다.',
  ...
  친구형형제자매: {
    ...
    togetherRoutine: {
      routines: [
        '같이 좋아하는 음식 먹으러 가기',
        '드라마·영화 같이 보며 수다 떨기',
        '서로 근황 공유하는 카톡 루틴 만들기',
        '힘든 일 생기면 먼저 연락하기',
        '각자의 취미 공유하고 반응해주기',
      ],
      energyNote: '편안한 사이일수록 특별한 이유 없이 연락하는 것이 이 관계를 오래 유지하는 방법입니다.',
    },
  },
  보호형형제자매: {
    typeName: '보호형 형제자매',
    ...
    togetherRoutine: {
      routines: [
        '중요한 결정 앞에 서로 의견 물어보기',
        '가족 행사나 명절에 함께 준비하기',
        '힘든 일 생기면 제일 먼저 연락하기',
        '서로의 일상 안부 짧게 나누기',
        '가끔 둘만의 식사 시간 만들기',
      ],
      energyNote: '보호하는 마음이 강한 관계일수록, 가끔 역할을 바꿔 기대는 연습이 관계를 더 따뜻하게 만듭니다.',
    },
  },
  거리유지형형제자매: {
    ...
    togetherRoutine: {
      routines: [
        '명절이나 특별한 날 연락하기',
        '중요한 소식 생기면 먼저 알리기',
        '각자의 삶을 존중하며 가끔 근황 나누기',
        '멀어진 느낌이 들면 "요즘 어때?" 한 마디 먼저 건네기',
      ],
      energyNote: '자주 연락하지 않아도 필요할 때 곁에 있는 것, 그것이 이 관계의 연결 방식입니다.',
    },
  },
  감정공유형형제자매: {
    ...
    togetherRoutine: {
      routines: [
        '오늘 기분 어때? 가볍게 묻기',
        '힘든 일 생기면 먼저 연락하기',
        '감정이 상했을 때 시간 두고 솔직하게 이야기하기',
        '서로의 감정에 판단 없이 반응해주기',
        '가끔 둘만의 산책이나 카페 시간 만들기',
      ],
      energyNote: '감정을 솔직하게 나눌 수 있는 형제자매 관계는 삶에서 가장 든든한 지지대입니다.',
    },
  },
  경쟁성장형형제자매: {
    ...
    togetherRoutine: {
      routines: [
        ...
        '"잘 하고 있어" 응원 한 마디 건네기',
        '각자의 성취를 진심으로 축하해주기',
        '경쟁 느낌이 생기면 솔직하게 이야기하기',
        '함께 좋아하는 취미나 활동 찾아보기',
      ],
      energyNote: '서로를 자극하며 함께 성장하는 관계에서, 응원 한 마디가 경쟁을 협력으로 바꿉니다.',
    },
  },
};
// ─── 동료 4유형 ──────────────────────────────────────────────────────────────
...
const COLLEAGUE_ARCHETYPE_DATA: Record<ColleagueArchetype, LightArchetypeResult> = {
  ...
  소통중심형: {
    ...
    togetherRoutine: {
      ...
      energyNote: '소통이 원활한 관계일수록, 업무 외의 연결이 협업의 품질을 더 높여줍니다.',
    },
  },
  에너지소모형: {
    typeName: '에너지 소모형 관계',
    ...
    togetherRoutine: {
      routines: [
        '업무 소통은 명확하게, 감정은 간단하게',
        '오해가 생기면 바로 확인하기',
        '업무 외 개인적인 이야기는 업무와 분리하기',
        '업무 스트레스 생기면 잠깐 자리를 만들기',
      ],
      energyNote: '업무 스타일이 다른 관계에서도, 명확한 소통 규칙이 에너지 소모를 줄이는 가장 실용적인 방법입니다.',
    },
  },
};
