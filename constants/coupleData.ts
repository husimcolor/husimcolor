...
function buildConversationRoutine(fA: EnergyFamily, fB: EnergyFamily, rel: RelationType): string {
  ...
  const comboConversation: Partial<Record<string, string>> = {
    'warm_active-cool_deep': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 빠른 표현과 깊은 내면이 만나는 지점에서 두 분의 대화가 가장 진솔해집니다. 답을 기다리는 여유가 두 분 사이를 더 가깝게 만들어줍니다.',
    'cool_deep-warm_active': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 깊은 내면과 빠른 표현이 만나는 지점에서 두 분의 대화가 가장 진솔해집니다. 답을 기다리는 여유가 두 분 사이를 더 가깝게 만들어줍니다.',
    ...
    'cool_deep-cool_deep': '조용한 시간에 짧게 "요즘 마음 어때?"라고 먼저 물어보세요. 깊은 대화가 아니라도, 짧은 질문 하나가 두 분의 거리를 좁혀줍니다.',
    'warm_soft-cool_clear': '한 분이 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 따뜻한 감성과 명료한 이성이 만나는 대화가 두 분 사이를 더 가까운 곳으로 데려다줍니다.',
    'cool_clear-warm_soft': '한 분이 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 명료한 이성과 따뜻한 감성이 만나는 대화가 두 분 사이를 더 가까운 곳으로 데려다줍니다.',
    'nature-nature': '말 없이 함께 있는 시간이 두 분에게 가장 자연스러운 대화입니다. 가끔 "요즘 마음 어때?"라는 짧은 질문이 두 분의 연결을 더 따뜻하게 만들어줍니다.',
    'nature-warm_active': '한 분은 먼저 "오늘 어떤 하루였어?"라고 물어보고, 다른 분은 그 질문을 조용히 받아들이는 것만으로도 충분합니다. 속도가 달라도 방향은 같습니다.',
    'warm_active-nature': '한 분은 먼저 "오늘 어떤 하루였어?"라고 물어보고, 다른 분은 그 질문을 조용히 받아들이는 것만으로도 충분합니다. 속도가 달라도 방향은 같습니다.',
    ...
    'warm_active-warm_soft': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 빠르게 말하고 싶은 마음과 천천히 배려하는 마음이 만나는 지점에서 두 분의 대화가 가장 따뜻해집니다.',
    'warm_soft-warm_active': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 배려하는 마음과 직접적인 표현이 만나는 지점에서 두 분의 대화가 가장 따뜻해집니다.',
    'warm_grounded-cool_deep': '한 분이 먼저 "요즘 마음 어때?"라고 물어보세요. 일상의 안정감 위에서 내면의 이야기가 조금씩 열릴 수 있습니다. 기다려주는 것이 두 분 사이의 가장 깊은 대화입니다.',
    'cool_deep-warm_grounded': '한 분이 먼저 "요즘 마음 어때?"라고 물어보세요. 깊은 내면의 이야기가 일상의 안정감 위에서 조금씩 열릴 수 있습니다. 기다려주는 것이 두 분 사이의 가장 깊은 대화입니다.',
    'warm_active-cool_clear': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 빠른 에너지와 명료한 정리가 만나는 대화에서 두 분의 관계가 더 단단해집니다.',
    'cool_clear-warm_active': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 명료한 정리와 빠른 에너지가 만나는 대화에서 두 분의 관계가 더 단단해집니다.',
    'cool_clear-cool_deep': '조용한 시간에 짧게 "요즘 마음 어때?"라고 먼저 물어보세요. 명료한 언어와 깊은 내면이 만나는 대화가 두 분 사이를 더 단단하게 이어줍니다.',
    'cool_deep-cool_clear': '조용한 시간에 짧게 "요즘 마음 어때?"라고 먼저 물어보세요. 깊은 내면과 명료한 언어가 만나는 대화가 두 분 사이를 더 단단하게 이어줍니다.',
    'warm_grounded-warm_soft': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 안정적인 일상 위에 따뜻한 감성이 더해질 때 두 분의 대화가 가장 풍성해집니다.',
    'warm_soft-warm_grounded': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 따뜻한 감성과 안정적인 일상이 만나는 대화가 두 분 사이를 더 편안하게 만들어줍니다.',
    'warm_grounded-cool_clear': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 일상의 안정감과 명료한 표현이 만날 때 두 분의 대화가 가장 효율적이고 편안해집니다.',
    'cool_clear-warm_grounded': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 명료한 표현과 일상의 안정감이 만날 때 두 분의 대화가 가장 효율적이고 편안해집니다.',
    'nature-cool_deep': '조용한 시간에 짧게 "요즘 마음 어때?"라고 먼저 물어보세요. 두 분 모두 말보다 마음으로 더 많이 느끼는 사람들입니다. 그 침묵 안에서도 이미 충분히 연결되어 있습니다.',
    'cool_deep-nature': '조용한 시간에 짧게 "요즘 마음 어때?"라고 먼저 물어보세요. 두 분 모두 말보다 마음으로 더 많이 느끼는 사람들입니다. 그 침묵 안에서도 이미 충분히 연결되어 있습니다.',
    'nature-warm_soft': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 조용한 존재감과 따뜻한 배려가 만나는 대화가 두 분 사이를 가장 편안하게 이어줍니다.',
    'warm_soft-nature': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 따뜻한 배려와 조용한 존재감이 만나는 대화가 두 분 사이를 가장 편안하게 이어줍니다.',
    'nature-cool_clear': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 조용한 존재감과 명료한 표현이 만나는 대화가 두 분 사이를 더 단단하게 만들어줍니다.',
    'cool_clear-nature': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 명료한 표현과 조용한 존재감이 만나는 대화가 두 분 사이를 더 단단하게 만들어줍니다.',
    'warm_grounded-nature': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 안정적인 일상과 조용한 존재감이 만나는 대화가 두 분 사이를 가장 편안하게 이어줍니다.',
    'nature-warm_grounded': '한 분이 먼저 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 조용한 존재감과 안정적인 일상이 만나는 대화가 두 분 사이를 가장 편안하게 이어줍니다.',
  };
...
function buildConnectionRoutine(
  ...
  const connectionMap: Partial<Record<string, string>> = {
    ...
    'warm_active-cool_deep': '한 사람이 먼저 "오늘 어떤 마음이야?"라고 물어보세요. 빠른 표현과 깊은 내면이 만나는 지점에서 두 사람의 연결이 가장 진솔해집니다. 답을 기다리는 여유가 두 사람 사이를 더 가깝게 만들어줍니다.',
    'cool_deep-warm_active': '한 사람이 먼저 "오늘 어떤 마음이야?"라고 물어보세요. 깊은 내면과 빠른 표현이 만나는 지점에서 두 사람의 연결이 가장 진솔해집니다. 답을 기다리는 여유가 두 사람 사이를 더 가깝게 만들어줍니다.',
    'warm_soft-cool_clear': '한 사람이 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 따뜻한 감성과 명료한 이성이 만나는 대화가 두 사람 사이를 가장 따뜻하게 이어줍니다.',
    'cool_clear-warm_soft': '한 사람이 "오늘 나한테 어떤 순간이 좋았어?"라고 물어보세요. 명료한 이성과 따뜻한 감성이 만나는 대화가 두 사람 사이를 가장 따뜻하게 이어줍니다.',
    'cool_deep-cool_deep': '말이 없어도 괜찮습니다. 같은 공간에서 조용히 있는 것만으로도 충분한 연결입니다. 다만 가끔 "지금 마음 어때?"라는 짧은 질문이 두 사람의 거리를 좁혀줍니다.',
    'nature-nature': '자연 속에서 함께 조용히 있는 시간이 두 사람에게 가장 자연스러운 연결입니다. 함께 편안히 시간을 보내는 것만으로도 충분한 연결이 됩니다.',
    'nature-warm_active': '한 사람이 조용히 있고 싶을 때, 다른 사람이 그 조용함을 존중해주세요. 조용한 존재감과 활기찬 에너지가 서로를 보완할 때 두 사람의 연결이 가장 편안해집니다.',
    'warm_active-nature': '한 사람이 조용히 있고 싶을 때, 다른 사람이 그 조용함을 존중해주세요. 활기찬 에너지와 조용한 존재감이 서로를 보완할 때 두 사람의 연결이 가장 편안해집니다.',
    'warm_grounded-warm_grounded': '일상의 작은 순간에 집중해보세요. "오늘 저녁 뛰어서 좋았어", "오늘 네가 해준 거 덕분에 맛있었어" 같은 작은 인정이 두 사람 사이를 따뜻게 유지해줍니다.',
  };
...
function buildAffectionRoutine(fA: EnergyFamily, fB: EnergyFamily, rel: RelationType = '연인'): string {
  ...
  const comboAffection: Partial<Record<string, string>> = {
    ...
    'warm_active-cool_deep': '한 분이 먼저 "오늘 어떤 하루였어?"라고 물어보세요. 빠른 표현과 깊은 내면이 만나는 순간, 두 분의 연결이 가장 진솔해집니다. 답을 기다리는 여유가 두 분 사이를 더 가깝게 만들어줍니다.',
    'cool_deep-warm_active': '깊은 내면을 가진 분이 먼저 "오늘 어떤 마음이었어?"라고 물어보세요. 활기찬 에너지와 조용한 내면이 만나는 대화가 두 분 사이를 가장 따뜻하게 이어줍니다.',
    'warm_soft-cool_clear': '따뜻한 감성을 가진 분에게는 "네가 있어서 좋아"라는 말이 가장 큰 선물입니다. 명료한 분에게는 약속을 지키고 필요한 것을 먼저 챙기는 행동이 사랑의 언어입니다. 서로의 방식으로 한 번씩 먼저 다가가보세요.',
    'cool_clear-warm_soft': '명료한 분에게는 약속을 지키고 필요한 것을 먼저 챙기는 행동이 사랑의 언어입니다. 따뜻한 감성을 가진 분에게는 "네가 있어서 좋아"라는 말이 가장 큰 선물입니다. 서로의 방식으로 한 번씩 먼저 다가가보세요.',
    'cool_deep-cool_deep': '"말 안 해도 네 마음 알아"라는 짧은 한 마디가 두 분 모두에게 깊이 닿습니다. 거창한 표현보다 진심 어린 한 마디가 두 분의 연결을 더 깊게 만들어줍니다.',
    'nature-nature': '말 없이 조용히 곁에 있어주는 것이 두 분에게 가장 큰 사랑의 표현입니다. 가끔 "네가 곁에 있어서 좋아"라는 한 마디를 더해보세요.',
    'nature-warm_active': '조용한 존재감을 가진 분은 말 없이 곁에 있어주는 것으로, 활기찬 분은 짧은 표현과 함께하는 활동으로 마음을 전합니다. 서로의 언어로 한 번씩 먼저 다가가는 것이 두 분의 거리를 좁혀줍니다.',
    'warm_active-nature': '활기찬 분은 짧은 표현과 함께하는 활동으로, 조용한 존재감을 가진 분은 말 없이 곁에 있어주는 것으로 마음을 전합니다. 서로의 언어로 한 번씩 먼저 다가가는 것이 두 분의 거리를 좁혀줍니다.',
    'warm_grounded-warm_grounded': '"오늘도 수고했어", "네가 해준 거 덕분에 맛있었어" 같은 일상적인 인정이 두 분 모두에게 가장 큰 사랑의 언어입니다. 특별한 것보다 일상 속의 꾸준한 관심이 관계를 따뜻하게 유지해줍니다.',
    ...
    'warm_grounded-cool_clear': '한 분은 일상 속에서 묵묵히 신뢰를 쌓는 방식으로, 다른 분은 명확하게 정리하고 애써주는 방식으로 마음을 전합니다. "네가 해준 거 다 알아", "네가 있어서 든든해" 같은 짧은 인정이 두 분 모두에게 가장 큰 에너지가 됩니다.',
    'cool_clear-warm_grounded': '한 분은 명확하게 정리하고 애써주는 방식으로, 다른 분은 일상 속에서 묵묵히 신뢰를 쌓는 방식으로 마음을 전합니다. "네가 정리해준 거 덕분에 나 편해졌어", "네가 묵묵히 있어줘서 나 안정돼" 같은 짧은 인정이 두 분 모두에게 답니다.',
  ...
  if (needsPhysical && needsWords) {
    return isCouple
      ? `아침이나 저녁에 ${connTone.physicalTouch} "오늘도 고마워"라는 말을 나눠보세요. ${connTone.closingGesture} 두 사람 모두에게 닿습니다.`
      : `저녁에 짧게 안부를 나누고 "오늘도 고마워"라는 말을 나눠보세요. 말과 공감이 함께할 때 두 사람 모두에게 닿습니다.`;
  }
  if (needsPhysical) {
    return isCouple
  ...
  return '"오늘 어떤 하루였어?", "네가 있어서 다행이야" 같은 작은 말 한 마디가 두 분 사이를 따뜻하게 유지해줍니다. 특별한 것보다 꾸준한 관심이 더 중요합니다.';
}
