...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  ...
  안정추구형: {
    ...
    typeName: '안정추구형 관계',
    typeEmoji: '🏠',
    coreSummary: '조용하지만 오래 가는 연결입니다. 매일 함께하는 것이 이 관계의 사랑 방식입니다.',
    tensionDescription: '이 관계는 드라마틱하지 않습니다. 큰 갈등도, 극적인 화해도 없습니다. 그래서 때로는 "우리 너무 무난한 거 아니야?" 싶을 수 있습니다. 그러나 작은 배려와 익숙한 루틴이 쌓여 신뢰가 됩니다. 그 신뢰가 이 관계의 기반입니다.',
  ...
  감정순환형: {
    ...
    typeName: '감정순환형 관계',
    typeEmoji: '🌊',
    coreSummary: '두 사람의 감정은 파도입니다. 높아졌다가 낮아지고, 가까워졌다가 멀어집니다. 그 흐름을 함께 타는 것이 이 관계의 방식입니다.',
    tensionDescription: '이 관계에는 감정의 파도가 있습니다. 가까워졌다가 멀어지고, 따뜻해졌다가 차가워집니다. 파도가 올 때 혼자 있고 싶어질 수 있습니다. 감정이 갑자기 올라와 스스로도 당황할 수 있습니다. 그러나 파도는 지나갑니다. 잔잔해진 후 다시 연결되는 것, 그것이 이 관계의 리듬입니다. 파도가 무서운 것이 아니라, 파도를 함께 타는 법을 배우는 것이 이 관계의 과제입니다.',
  ...
  거리조절형: {
    ...
    tensionDescription: '너무 가까우면 숨막힙니다. 너무 멀면 불안합니다. 이 관계는 그 사이 어딘가를 찾고 있습니다. 한 사람이 다가가면 다른 사람이 물러섭니다. 물러서면 다시 쫓아옵니다. 이 패턴은 반복됩니다. 그리고 두 사람 모두 지칩니다.',
  ...
  회복형: {
    ...
    typeName: '회복형 관계',
    typeEmoji: '🌱',
    coreSummary: '싸우고 나서 더 가까워지는 관계입니다. 갈등이 끝이 아니라 다시 연결되는 시작입니다.',
    tensionDescription: '이 관계에는 갈등이 있습니다. 싸우고 나면 지칩니다. 또 이 패턴이야, 싶은 순간도 있습니다. 그러나 두 사람은 반드시 다시 연결됩니다. 그 회복이 이 관계를 더 단단하게 만듭니다. 갈등의 횟수가 아니라, 회복의 깊이가 이 관계의 척도입니다.',
