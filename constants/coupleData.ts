...
function buildExpressionDifference(
  ...
  const colorIdExprMap: Partial<Record<string, string>> = {
    ...
    'black-red': `한 사람은 경계를 세우고 자기 방식을 고수하며, 다른 사람은 즉각적으로 반응하고 표현합니다. 한 사람의 고집이 다른 사람에게 벽처럼 느껴지고, 다른 사람의 빠른 반응이 한 사람에게 침범으로 느껴집니다.`,
    'black-pink': `한 사람은 감정을 쉽게 열지 않고 경계를 중요하게 여기며, 다른 사람은 따뜻한 표현과 확인을 원합니다. "나는 이미 여기 있잖아"와 "왜 말을 안 해줘?"가 반복됩니다.`,
    'navy-pink': `한 사람은 행동으로 사랑을 표현하고, 다른 사람은 말과 감정 표현으로 확인하고 싶어 합니다. "이미 다 하고 있잖아"와 "그래도 말로 해줘"가 교차하는 패턴입니다.`,
    'navy-red': `한 사람은 신중하게 생각한 후 표현하고, 다른 사람은 감정이 생기면 바로 꺼냅니다. 한 사람의 신중함이 다른 사람에게 답답함으로, 다른 사람의 빠른 반응이 한 사람에게 충동적으로 느껴집니다.`,
    'navy-magenta': `한 사람은 감정을 혼자 삭이며 버티고, 다른 사람은 감정을 깊이 나누고 싶어 합니다. 한 사람의 침묵이 다른 사람에게 거리두기로 읽히고, 다른 사람의 강한 감정이 한 사람에게 부담이 됩니다.`,
    'red-green': `한 사람은 감정이 생기면 바로 표현하고, 다른 사람은 갈등을 피하며 조용히 담아둡니다. 한 사람의 직선적인 표현이 다른 사람에게 공격적으로 느껴지고, 다른 사람의 회피가 한 사람에게 무관심으로 느껴집니다.`,
    'red-violet': `한 사람은 즉각적으로 반응하고, 다른 사람은 깊이 생각한 후 천천히 표현합니다. 속도 차이가 반복되면 한 사람은 "왜 반응이 없어?"라고 느끼고, 다른 사람은 "왜 이렇게 빨리 결론 내려?"라고 느낍니다.`,
    'pink-green': `한 사람은 애정 표현을 자주 원하고, 다른 사람은 갈등을 피하며 조용히 배려합니다. 한 사람의 표현 기대가 다른 사람에게 부담이 되고, 다른 사람의 조용한 배려가 한 사람에게 무관심으로 느껴집니다.`,
    'magenta-green': `한 사람은 감정에 깊이 몰입하여 표현하고, 다른 사람은 갈등을 피하며 조용히 넘기려 합니다. 한 사람의 강한 감정이 다른 사람에게 부담이 되고, 다른 사람의 회피가 한 사람에게 거절로 느껴집니다.`,
    'violet-yellow': `한 사람은 깊은 감정적 의미를 중요하게 여기고, 다른 사람은 현실적이고 밝게 소통합니다. 한 사람은 "왜 이렇게 가볍게 봐?"라고 느끼고, 다른 사람은 "왜 이렇게 깊이 생각해?"라고 느낍니다.`,
    'green-navy': `두 사람 모두 감정을 안으로 담아두는 편입니다. 한 사람은 갈등을 피하며 배려하고, 다른 사람은 혼자 책임을 지며 버팁니다. 서로 표현이 부족해 거리감이 조용히 쌓입니다.`,
  };
  const colorA0 = colorsA[0]?.id ?? '';
  const colorB0 = colorsB[0]?.id ?? '';
...
function buildProfileContrast(
  ...
  const colorIdContrastMap: Partial<Record<string, string>> = {
    ...
    'white-red': isCouple
      ? `한 사람은 정화, 정리, 완벽주의 성향이 있습니다. 다른 사람은 즉각 반응, 표현 직선성, 빠른 속도가 특징입니다.\n한 사람의 차분함이 다른 사람에게 안정감을 주고, 다른 사람의 활기가 한 사람에게 자극이 됩니다.\n반복되는 패턴은 이렇게 나타납니다. 생활 속도와 청소·정리 기준 차이가 일상 긴장이 됩니다. 한 사람은 "왜 이렇게 어질러?"라고 느끼고, 다른 사람은 "왜 이렇게 예민해?"라고 느낍니다.`
      : `한 사람은 정리와 명료함으로, 다른 사람은 즉각적인 표현으로 관계를 이어갑니다. 속도와 기준 차이가 반복적인 긴장 포인트입니다.`,
    'white-black': isCouple
      ? `두 사람 모두 마음을 쉽게 열지 않는 편입니다. 한 사람은 정화와 정리로, 다른 사람은 경계와 통제로 자신을 지킵니다.\n서로의 독립성을 존중하는 것이 이 관계의 강점입니다.\n반복되는 패턴은 이렇게 나타납니다. 서로 기다리다 연결이 늦어집니다. 청소·정리 기준과 생활 방식 차이가 조용히 쌓입니다.`
      : `두 사람 모두 마음을 쉽게 열지 않습니다. 서로의 독립성을 존중하면서 조금씩 다가가는 것이 필요합니다.`,
    'white-navy': isCouple
      ? `두 사람 모두 감정을 안으로 담아두는 편입니다. 한 사람은 정리와 거리두기로, 다른 사람은 책임감과 신뢰로 관계를 지킵니다.\n서로의 독립성과 신뢰가 이 관계의 기반입니다.\n반복되는 패턴은 이렇게 나타납니다. 서로 "괜찮아"라고 말하면서 실제로는 지쳐가는 패턴이 생깁니다. 정리 기준과 생활 방식 차이가 조용히 쌓입니다.`
    ...
    'black-red': isCouple
      ? `한 사람은 경계, 통제, 고집이 특징입니다. 다른 사람은 즉각 반응, 추진력, 표현 직선성이 특징입니다.\n한 사람의 깊이가 다른 사람에게 신뢰감을 주고, 다른 사람의 활기가 한 사람에게 자극이 됩니다.\n반복되는 패턴은 이렇게 나타납니다. 주도권 갈등이 생깁니다. "내 방식대로 해야 해"와 "왜 이렇게 고집이 세?"가 반복됩니다.`
      : `한 사람은 경계와 통제로, 다른 사람은 즉각적인 추진력으로 움직입니다. 주도권 갈등이 반복적인 긴장 포인트입니다.`,
    'black-pink': isCouple
      ? `한 사람은 경계, 개인 공간, 쉽게 마음 열지 않음이 특징입니다. 다른 사람은 애정 표현, 정서 반응, 따뜻한 연결이 특징입니다.\n한 사람의 깊이가 다른 사람에게 신비감을 주고, 다른 사람의 따뜻함이 한 사람에게 온기를 줍니다.\n반복되는 패턴은 이렇게 나타납니다. "왜 나한테만 차가워?"와 "나는 이미 여기 있잖아"가 반복됩니다.`
      : `한 사람은 경계와 개인 공간을 중요하게 여기고, 다른 사람은 따뜻한 표현을 원합니다. 서로의 방식을 이해하는 것이 시작입니다.`,
    'navy-pink': isCouple
      ? `한 사람은 책임감, 신뢰, 행동으로 사랑 표현이 특징입니다. 다른 사람은 애정 표현, 정서 반응, 말로 확인하고 싶어 함이 특징입니다.\n한 사람의 안정감이 다른 사람에게 신뢰를 주고, 다른 사람의 따뜻함이 한 사람에게 온기를 줍니다.\n반복되는 패턴은 이렇게 나타납니다. "이미 다 하고 있잖아"와 "그래도 말로 해줘"가 반복됩니다.`
    ...
    'violet-yellow': isCouple
      ? `한 사람은 깊은 감정, 이상적 연결, 내면 성찰이 특징입니다. 다른 사람은 현실성, 걱정, 밝은 소통이 특징입니다.\n한 사람의 깊이가 다른 사람에게 의미를 주고, 다른 사람의 현실감이 한 사람에게 균형을 줍니다.\n반복되는 패턴은 이렇게 나타납니다. "왜 이렇게 깊이 생각해?"와 "왜 이렇게 가볍게 봐?"가 반복됩니다.`
      : `한 사람은 깊이와 의미를 중요하게 여기고, 다른 사람은 현실적이고 밝게 소통합니다. 관점 차이가 반복적인 긴장 포인트입니다.`,
    'green-navy': isCouple
      ? `두 사람 모두 감정을 안으로 담아두는 편입니다. 한 사람은 갈등을 피하며 배려하고, 다른 사람은 혼자 책임을 지며 버팁니다.\n서로의 안정감이 이 관계의 기반입니다.\n반복되는 패턴은 이렇게 나타납니다. 서로 표현이 부족해 거리감이 조용히 쌓입니다. "나는 괜찮아"를 반복하다 어느 순간 멀어진 느낌이 드는 패턴입니다.`
...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  온도차형: {
    ...
    typeName: '온도차형 관계',
    typeEmoji: '🌡️',
    coreSummary: '한 사람은 이미 끝났고, 다른 사람은 아직 그 안에 있습니다.',
    tensionDescription: '두 사람은 같은 상황을 다른 속도로 경험합니다. 한 사람은 이미 끝났고, 다른 사람은 아직 그 안에 있습니다. 이 속도 차이가 오해를 만듭니다. 한 사람은 왜 아직이야, 다른 사람은 왜 벌써야 싶습니다.',
  ...
  성장자극형: {
    ...
    tensionDescription: '이 관계는 편안하지 않습니다. 자극이 있고, 갈등이 있고, 긴장이 있습니다. 한 사람의 도전이 다른 사람에게는 압박이 됩니다. 사랑하지만 지치는 순간도 있습니다. 그 충돌 뒤에 성장이 있습니다. 부딪힌 후 더 가까워지는 것, 그것이 이 관계의 방식입니다.',
    misunderstandingPattern: '"왜 항상 도전해?" "왜 그냥 넘어가지 못해?" — 성장을 원하는 마음이 상대에게는 압박이 됩니다. 밀어붙이는 것이 사랑이지만, 받는 사람은 숨막힐 수 있습니다. 이 관계의 가장 큰 오해입니다.',
  ...
  안정추구형: {
    ...
    typeName: '안정추구형 관계',
    typeEmoji: '🏠',
    coreSummary: '조용한 안정이 이 관계의 힘입니다.',
    tensionDescription: '이 관계는 드라마틱하지 않습니다. 큰 갈등도, 극적인 화해도 없습니다. 그래서 때로는 "우리 너무 무난한 거 아니야?" 싶을 수 있습니다. 그러나 매일의 작은 배려가 쌓입니다. 익숙한 루틴이 신뢰가 됩니다. 그 조용한 신뢰가 이 관계의 기반입니다.',
    misunderstandingPattern: '"우리 너무 무난한 거 아니야?" "설레는 게 없어." — 안정이 무감각으로 느껴질 때가 있습니다. 편안함이 당연해지면 서로에 대한 감사가 줄어들 수 있습니다. 익숙함이 사랑의 반대가 아님을 기억하는 것이 이 관계의 과제입니다.',
    connectionStyle: '이 관계의 연결은 일상 속에 있습니다. 함께 먹는 밥, 나누는 일상 이야기, 습관처럼 하는 연락. 루틴이 신뢰이고, 신뢰가 연결입니다. 특별하지 않은 순간들이 쌓여 이 관계가 됩니다.',
    recoveryRoutine: '특별한 것이 필요 없습니다. 익숙한 카페, 자주 가던 산책길, 좋아하는 음식. 평소 하던 것을 함께 하세요. 일상으로 돌아오는 것이 이 관계의 회복입니다.',
    ...
    closingMessage: '이 관계는 조용합니다. 드라마틱하지 않습니다. 그러나 조용한 것이 덜 사랑하는 것이 아닙니다. 매일 함께 있는 것, 그것이 이 관계의 가장 깊은 사랑 방식입니다. 익숙함 속에 있는 애정을 잊지 마세요.',
  ...
  감정순환형: {
    ...
    typeName: '감정순환형 관계',
    typeEmoji: '🌊',
    coreSummary: '감정의 파도를 함께 건넙니다.',
    tensionDescription: '이 관계에는 감정의 파도가 있습니다. 가까워졌다가 멀어지고, 따뜻해졌다가 차가워집니다. 파도가 올 때 혼자 있고 싶어질 수 있습니다. 감정이 갑자기 올라와 스스로도 당황할 수 있습니다. 그러나 파도는 지나갑니다. 잔잔해진 후 다시 연결됩니다. 파도를 함께 타는 법을 배우는 것, 그것이 이 관계의 과제입니다.',
    misunderstandingPattern: '"왜 갑자기 차가워졌어?" — 변심이 아닙니다. 파도가 온 겁니다. "왜 갑자기 가까워지려 해?" — 밀어내는 게 아닙니다. 파도가 지나간 겁니다. 이 관계에서 감정의 변화는 변심이 아니라 순환입니다.',
  ...
  거리조절형: {
    ...
    tensionDescription: '너무 가까우면 숨막힙니다. 너무 멀면 불안합니다. 다가가면 물러서고, 물러서면 다시 당깁니다. 이 패턴이 반복됩니다. 두 사람 모두 지칩니다. 그러나 그 사이 어딘가에 이 관계의 자리가 있습니다.',
    misunderstandingPattern: '"왜 가까워지면 도망가?" — 도망가는 게 아닙니다. 숨 쉬러 가는 겁니다. "왜 내가 물러서면 쫓아와?" — 쫓아가는 게 아닙니다. 불안해서 확인하는 겁니다. 이 두 사람은 서로를 오해하고 있습니다.',
  ...
  보호자형: {
    ...
    tensionDescription: '이 관계에는 보호하는 사람과 보호받는 사람이 있습니다. 그 역할이 자연스럽게 형성됩니다. 그러나 시간이 지나면 보호하는 사람은 지칩니다. 보호받는 사람은 의존이 됩니다. 그 역할이 짐이 될 때, 이 관계는 흔들립니다.',
  ...
  이상주의형: {
    ...
    typeName: '이상주의형 관계',
    typeEmoji: '✨',
    coreSummary: '서로에게서 특별함을 봅니다. 그 시선이 아름답고, 때로는 무겁습니다.',
    tensionDescription: '이 관계에는 높은 기대가 있습니다. 서로를 이상화합니다. 그 이상에 미치지 못할 때 실망합니다. 마음속의 상대와 현실의 상대 사이의 간극이 이 관계의 긴장입니다. 그 간극이 클수록 상처도 깊어집니다.',
    ...
    realEmotions: {
      feelings: [
        '기대했던 모습과 다를 때 실망감이 올라올 수 있습니다.',
        '완벽하지 않은 상대를 보며 혼란스러울 수 있습니다.',
        '예전 같지 않다는 느낌이 들 수 있습니다.',
        '이 관계가 맞는지 의심이 올라올 수 있습니다.',
      ],
  ...
  현실균형형: {
    ...
    typeName: '현실균형형 관계',
    typeEmoji: '⚖️',
    coreSummary: '현실을 함께 살아가는 것이 이 관계의 사랑입니다.',
    tensionDescription: '이 관계는 현실적입니다. 감정보다 상황이 먼저입니다. 설렘보다 책임이 먼저입니다. 그 현실 속에서 사랑의 감각을 잃지 않는 것, 그것이 이 관계의 긴장입니다. 현실을 함께 살면서 연결감을 유지하는 것이 이 관계의 과제입니다.',
  ...
  회복형: {
    ...
    tensionDescription: '이 관계에는 갈등이 있습니다. 싸우고 나면 지칩니다. 멀어진 것 같아 불안해집니다. 그런데 시간이 지나면 다시 서로가 생각납니다. 연락하고 싶어집니다. 결국 다시 연결됩니다. 상처보다 다시 연결되는 힘이 더 큰 관계입니다.',
    misunderstandingPattern: '"우리 왜 이렇게 자주 싸우지?" — 갈등이 많은 것이 관계가 나쁜 것이 아닙니다. 갈등 후 다시 연결되는 것이 반복될수록 이 관계는 더 깊어집니다. 싸우는 것이 문제가 아니라, 싸우고 나서 어떻게 돌아오느냐가 이 관계의 핵심입니다.',
