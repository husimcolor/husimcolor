...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  온도차형: {
    ...
    tensionDescription: '두 사람은 같은 상황을 다른 속도로 경험합니다. 싸우고 난 다음 날 아침, 한 사람은 평소처럼 "오늘 뭐 먹을까?"라고 묻습니다. 다른 사람은 아직 어젯밤이 정리되지 않은 채입니다. 한 사람에게 넘어간 것이 다른 사람에게는 무시처럼 느껴집니다. 이 속도 차이가 반복되면서 "왜 아직도 그래?"와 "왜 아무렇지 않아?"가 교차합니다.',
    misunderstandingPattern: '갈등 다음 날 아침, 한 사람은 평소처럼 행동합니다. 다른 사람은 아직 어젯밤 안에 있습니다. "어떻게 아무렇지 않아?"라는 말이 나옵니다. 한 사람은 "이미 끝난 거 아니야?"라고 합니다. 이 순간이 이 관계에서 가장 자주 반복되는 오해입니다. 빠른 사람은 느린 사람이 집착한다고 느끼고, 느린 사람은 빠른 사람이 무관심하다고 느낍니다.',
    connectionStyle: '한 사람이 먼저 "나 아직 정리 중이야"라고 말하고, 다른 사람이 "알겠어, 기다릴게"라고 답하는 것. 속도를 맞추려 하지 않고, 서로 다른 속도를 인정하는 것이 이 관계의 연결입니다. 빠른 사람이 느린 사람 곁에 조용히 앉아 있어주는 것만으로도 이 관계는 연결됩니다.',
    recoveryRoutine: '각자 30분 정도 시간을 갖고 다시 만나기. 빠른 사람이 느린 사람 곁에 조용히 앉아 있어주는 것. "다 됐을 때 말해줘"라고 말하며 기다리는 것이 이 관계의 회복입니다. 억지로 빠르게 화해하려 하지 않는 것이 중요합니다.',
    ...
    affectionRoutine: '말 없이 옆에 앉아 있기. 빠른 사람이 느린 사람 곁에 조용히 머물러 주는 것. "다 됐을 때 얘기해줘"라고 말하며 기다리는 것. 서두르지 않는 것 자체가 이 관계에서 가장 따뜻한 사랑 표현입니다.',
    ...
    dangerPattern: '침묵이 거리감으로 번지는 패턴. 빠른 사람은 이미 끝났다고 생각하고 일상으로 돌아갑니다. 느린 사람은 아직 혼자 삭이고 있습니다. 그 간극을 아무도 말하지 않습니다. 쌓입니다. 어느 순간 "요즘 우리 왜 이렇게 어색해?"라는 말이 나옵니다. 속도 차이를 말하지 않으면 거리감이 됩니다.',
  ...
  성장자극형: {
    ...
    dangerPattern: '응원이 압박이 되는 패턴. "이렇게 해봐"가 "너는 부족해"로 들립니다. 도전이 비난처럼 느껴집니다. 한 사람은 "나는 그냥 도와주려 했는데"라고 하고, 다른 사람은 "그 말이 나를 지치게 해"라고 합니다. 자극과 지지의 균형이 무너지면, 이 관계는 성장 대신 상처를 남깁니다.',
  ...
  안정추구형: {
    ...
    tensionDescription: '이 관계는 드라마틱하지 않습니다. 주말 아침 함께 커피를 마시고, 저녁에 같이 드라마를 봅니다. 큰 갈등도, 극적인 화해도 없습니다. 그래서 때로는 "우리 너무 무난한 거 아니야?"라는 생각이 스칩니다. 하지만 매일 함께 밥을 먹는 것, 잠들기 전 손을 잡는 것, 그 작은 것들이 쌓여 이 관계가 됩니다.',
    misunderstandingPattern: '"요즘 우리 너무 친구 같지 않아?" — 편안함이 설렘을 대체하는 순간입니다. 함께 있어도 특별한 것이 없다는 느낌. 익숙한 루틴이 무감각처럼 느껴지는 순간. 그러나 매일 함께 있다는 것, 그 자체가 이미 깊은 신뢰입니다. 당연해진 것들 안에 사랑이 있습니다.',
    connectionStyle: '이 관계의 연결은 일상 속에 있습니다. 함께 먹는 아침밥, 퇴근 후 "오늘 어땠어?"라는 말, 주말 아침 느긋하게 보내는 시간. 특별하지 않은 순간들이 쌓여 이 관계가 됩니다. 루틴이 신뢰이고, 신뢰가 연결입니다.',
    ...
    affectionRoutine: '함께 요리하기, 같이 드라마 보기, 주말 아침 느긋하게 보내기. 장을 함께 보거나, 좋아하는 카페에 가거나, 잠들기 전 짧게 오늘 이야기 나누기. 생활 속에서 자연스럽게 함께하는 것이 이 관계의 애정 표현입니다.',
    ...
    dangerPattern: '편안함이 무감각이 되는 패턴. 함께 있어도 각자 폰을 봅니다. 대화가 줄어듭니다. "오늘 뭐 먹을까?"가 유일한 대화가 됩니다. 어느 순간 "우리 요즘 대화가 없는 것 같아"라는 말이 나옵니다. 안정이 당연해지면 감사가 줄어듭니다. 의식적으로 "오늘 함께해서 좋았어"라고 말하는 것이 필요합니다.',
  ...
  감정순환형: {
    ...
    dangerPattern: '파도가 동시에 오는 패턴. 두 사람의 감정이 동시에 높아집니다. 한 사람이 "왜 갑자기 차가워?"라고 물으면, 다른 사람도 감정이 올라와 있습니다. 그 순간 말이 상처가 됩니다. 한 사람이 먼저 "나 지금 파도 중이야, 잠깐 기다려줘"라고 말하는 것이 이 관계에서 가장 어렵고 가장 중요한 기술입니다.',
  ...
  거리조절형: {
    ...
    dangerPattern: '추격-도피 패턴. 한 사람이 공간을 원하면 다른 사람이 더 가까이 다가갑니다. 그러면 한 사람은 더 물러섭니다. 다른 사람은 더 쫓아갑니다. 다가가는 사람은 지치고, 물러서는 사람은 숨막힙니다. "나한테 관심 없어?"와 "왜 항상 붙어있으려 해?"가 교차합니다. 이 패턴이 고착되면 두 사람 모두 지칩니다.',
  ...
  친구형: {
    ...
    tensionDescription: '이 관계는 편안합니다. 함께 있으면 자연스럽습니다. 그런데 어느 날 "우리 너무 친구 같지 않아?"라는 생각이 듭니다. 설레는 게 없습니다. 특별한 날도 평소와 다르지 않습니다. 편안함이 연인 사이의 긴장감을 대체하는 순간입니다. 그러나 이 편안함이 이 관계의 가장 큰 자산입니다.',
  ...
  이상주의형: {
    ...
    tensionDescription: '이 관계에는 높은 기대가 있습니다. 처음에는 상대가 완벽해 보였습니다. 그런데 함께 살아가면서 현실의 모습이 보입니다. 양말을 아무 데나 벗어두고, 약속 시간에 늦고, 기념일을 잊습니다. "처음엔 달랐는데"라는 생각이 듭니다. 마음속의 상대와 현실의 상대 사이의 간극이 이 관계의 긴장입니다.',
    ...
    affectionRoutine: '평범한 순간을 특별하게 만들기. 완벽하지 않은 날 "지금 네가 좋아"라고 말하는 것. 기대보다 현실의 상대를 있는 그대로 보는 것이 이 관계의 가장 깊은 애정 표현입니다.',
    ...
    dangerPattern: '이상화와 실망의 반복 패턴. 높이 올립니다. 실망합니다. 다시 올립니다. 다시 실망합니다. "처음엔 달랐는데"가 반복됩니다. 이상화가 높을수록 실망도 깊습니다. 현실의 상대는 마음속 상대와 다릅니다. 그 간극을 인정하지 않으면, 이 관계는 반복됩니다.',
  ...
  현실균형형: {
    ...
    tensionDescription: '이 관계는 현실적입니다. 함께 가계부를 쓰고, 집안일을 나누고, 미래 계획을 세웁니다. 설렘보다 책임이 먼저입니다. 그런데 어느 날 "우리 요즘 감정 얘기를 안 하는 것 같아"라는 말이 나옵니다. 현실을 함께 살면서 연결감을 잃지 않는 것, 그것이 이 관계의 가장 어려운 과제입니다.',
    misunderstandingPattern: '"우리 요즘 감정 얘기를 안 하는 것 같아" — 현실적인 대화만 남은 순간입니다. "오늘 뭐 먹을까?", "이번 달 카드값 나왔어?", "다음 주 일정 어때?" 이런 대화만 남으면 "우리 괜찮은 거야?"라는 의문이 듭니다. 현실을 함께 살아가는 것 자체가 깊은 사랑임을 잊지 않는 것이 이 관계의 과제입니다.',
    ...
    dangerPattern: '현실에 치여 감정을 잊는 패턴. 해결할 것이 많습니다. 감정 표현이 줄어듭니다. 함께 있어도 각자 할 일을 합니다. 어느 순간 "우리 요즘 대화가 없는 것 같아"라는 말이 나옵니다. 현실을 함께 살면서 연결감을 잃지 않는 것, 그것이 이 관계의 가장 어려운 과제입니다.',
  ...
  회복형: {
    ...
    dangerPattern: '회복이 반복되면서 지치는 패턴. 갈등이 옵니다. 회복됩니다. 또 갈등이 옵니다. "또 이 패턴이야." 그 피로감이 쌓입니다. 빠른 화해를 반복하면서 근본 원인을 다루지 않으면 같은 갈등이 반복됩니다. "우리 왜 항상 이 문제로 싸우지?"라는 말이 나올 때, 회복의 깊이를 더해야 합니다.',
