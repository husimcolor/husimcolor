  ...
  const LIFESTYLE_MAP: Partial<Record<string, LifestyleSections>> = {
    ...
    'red-green': {
      finance: {
        ...
        tension: '"왜 혼자 결정해?"와 "왜 이렇게 느려?"가 반복됩니다. 소비 결정 속도의 차이가 갈등 포인트입니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
    ...
    'black-lavender': {
      finance: {
        ...
        tension: '"왜 이런 걸 사?"와 "이게 나한테 필요해"가 반복됩니다. 소비 기준이 다릅니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
    ...
    'indigo-green': {
      ...
      rest: {
        ...
        personB: '"같이 있으면서 편안하게 쉬고 싶어. 관계 안에서 충전돼." 관계 회복형입니다.',
        tension: '"왜 혼자 있으려 해?"와 "나 지금 충전 중이야"가 반복됩니다.',
      },
      affection: {
        title: '애정 표현 방식',
    ...
    'white-indigo': {
      ...
      cleaning: {
        ...
        tension: '"왜 이걸 버려?"와 "왜 이렇게 쌓아둬?"가 반복됩니다.',
      },
      rest: {
        title: '휴식·회복 방식',
  ...
  const FULL_LIFESTYLE_MAP: Partial<Record<string, LifestyleSections>> = {
    ...
    'indigo-black-pink|lavender-pink-cream': {
      finance: {
        ...
        personB: '"이게 있으면 마음이 편안해질 것 같아. 감성적인 것도 필요해." 감성 안정형 소비입니다.',
        tension: '"왜 이런 걸 사?"와 "이게 나한테 필요해"가 반복됩니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
      ...
      rest: {
        ...
        tension: '한 사람이 혼자 있고 싶을 때 다른 사람은 연결을 원해 방향이 엇갈리는 패턴이 반복됩니다.',
      },
      affection: {
        title: '애정 표현 방식',
    ...
    'white-blue-red|orange-yellow-warm': {
      finance: {
        ...
        tension: '"왜 이렇게 충동적으로 써?"와 "왜 이렇게 소극적으로 써?"가 반복됩니다.',
      },
      cleaning: {
        title: '청소·정리 스타일',
        ...
        tension: '"왜 이렇게 어질러?"와 "왜 이렇게 예민해?"가 반복됩니다.',
      },
      rest: {
        title: '휴식·회복 방식',
