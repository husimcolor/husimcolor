...
function buildMisunderstandingPattern(fA: EnergyFamily, fB: EnergyFamily, rel: RelationType): string {
  const patterns: Partial<Record<string, string>> = {
    'warm_active-cool_deep': '한 사람이 감정을 바로 표현할 때, 다른 사람은 그 강도에 압도되어 더 안으로 들어갑니다. 이것이 반복되면 한 사람은 "나를 피하는 것 같다"고 느끼고, 다른 사람은 "왜 지금 연락이 안 돼?"라고 느끽니다. "왜 그래?"대신 "지금 어떤 마음이야?"로 시작하는 것이 이 패턴을 바꾸는 첫 걸음입니다.',
    'cool_deep-warm_active': '한 사람이 마음을 정리하는 동안 조용히 있을 때, 다른 사람은 그 침묵을 거절로 읽습니다. 이것이 반복되면 한 사람은 "나를 싫어하는 건가?"라고 오해하고, 다른 사람은 "왜 나를 얼어주지 않지?"라고 느끽니다. 침묵은 거리두기가 아니라 정리하는 시간임을 서로 알면, 오해가 줄어듭니다.',
    'warm_soft-cool_clear': '한 사람이 감정적으로 표현할 때, 다른 사람은 자동으로 해결책을 내놓습니다. 한 사람은 "내 말을 들어주지 않는다"고 느끼고, 다른 사람은 "내가 도움이 되려고 한 것인데 왜 서운해하지?"라고 당혽스러워합니다. "도와줘"대신 "지금 어떤 마음이야?"로 시작하면 서로의 언어가 자연스럽게 연결됩니다.',
    'cool_clear-warm_soft': '한 사람이 상황을 논리적으로 정리할 때, 다른 사람은 감정적 공감을 먼저 원합니다. "왜 그렇게 차갑게 말해?"와 "나는 해결하려고 한 것들인데"가 반복되는 패턴이 생깁니다. 이성적인 말을 하기 전에 "네 마음이 힘들걌구나"한 마디가 실제로 큰 차이를 만들어냅니다.',
    'warm_active-nature': '한 사람이 빠르게 반응하고 표현할 때, 다른 사람은 그 속도에 압도되어 안으로 들어갑니다. 한 사람은 "왜 반응이 없지?"라고 느끼고, 다른 사람은 "왜 이렇게 강요하지?"라고 느끽니다. 속도를 맞추려고 하기보다 "네 페이스로 해"라고 먼저 말해주는 것이 이 패턴을 넘는 방법입니다.',
    'nature-warm_active': '한 사람이 자신의 리듬대로 조용히 있을 때, 다른 사람은 그 존재감을 무관심으로 읽습니다. 한 사람은 "나는 함께 있는데"라고 느끼고, 다른 사람은 "왜 말이 없지?"라고 당혽스러워합니다. 조용한 동행이 함께하는 방식임을 서로 알면, 이 패턴에서 벗어날 수 있습니다.',
    'warm_grounded-warm_active': '한 사람이 안정적으로 신중하게 반응할 때, 다른 사람은 즉각적으로 강하게 표현합니다. 한 사람은 "왜 그렇게 흥분해?"라고 느끼고, 다른 사람은 "왜 그렇게 무덤덤해?"라고 당혽스러워합니다. 표현의 강도가 다를 뿐, 두 사람 모두 진심으로 반응하고 있습니다.',
...
function buildExpressionDifference(
  ...
  return map[key] ?? `${nameA}의 흐름을 가진 사람과 ${nameB}의 흐름을 가진 사람은 감정을 다루는 방식과 속도가 다릅니다.\n같은 상황에서도 서로 다른 반응이 나올 수 있으며, 이것이 때로는 오해의 씨앗이 됩니다.\n서로의 방식이 틀린 것이 아니라 다른 것임을 기억하는 것이 중요합니다.`;
}
...
function buildNeededExpression(
  ...
  // 조합별 맞춤 표현 — 상대방의 에너지 결을 고려한 실전 코칭 언어
