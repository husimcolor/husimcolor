...
function buildProfileContrast(
  ...
  // 다른 계열 조합 — 에너지 방향 차이 + 끌림 이유 + 반복 패턴 + 해법
  const contrastMap: Partial<Record<string, string>> = {
    'warm_active-cool_deep': `${nameA}의 흐름을 가진 사람은 표현 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 내면 정리 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 활기차고 직접적인 에너지가 다른 사람에게 살아있는 느낌을 주고, 한 사람의 깊고 조용한 내면이 다른 사람에게 안정감을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람이 바로 말하고 싶을 때, 다른 사람은 아직 정리중입니다. "지금 말할 수 있어?"라고 먼저 묻는 것이 이 패턴을 넘는 가장 빠른 방법입니다.`,
    'cool_deep-warm_active': `${nameA}의 흐름을 가진 사람은 내면 정리 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 표현 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 깊고 조용한 내면이 다른 사람에게 안정감을 주고, 한 사람의 활기차고 직접적인 에너지가 다른 사람에게 살아있는 느낌을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람의 침묵이 다른 사람에게 거리두기로 읽히는 순간이 있습니다. "말하고 싶을 때 들어줄게"라고 먼저 말해주는 것이 이 패턴에서 보호해줍니다.`,
    'warm_soft-cool_clear': `${nameA}의 흐름을 가진 사람은 감정 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 신뢰와 실질 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 따뜻한 감성이 다른 사람에게 안심감을 주고, 한 사람의 명료한 판단이 다른 사람에게 방향감을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람은 공감을 원하고, 다른 사람은 해결책을 내놓습니다. "해결보다 먼저 들어줄게"라고 먼저 말하는 것이 두 사람 사이의 온도를 높여줍니다.`,
    'cool_clear-warm_soft': `${nameA}의 흐름을 가진 사람은 신뢰와 실질 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 감정 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 명료한 판단이 다른 사람에게 방향감을 주고, 한 사람의 따뜻한 감성이 다른 사람에게 안심감을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람의 이성적인 말이 다른 사람에게 차갑게 느껴지는 순간이 있습니다. "네 마음이 힘들겠구나"한 마디가 두 사람 사이의 온도를 높여줍니다.`,
    'warm_active-nature': `${nameA}의 흐름을 가진 사람은 표현 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 자신의 리듬 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 활기차고 직접적인 에너지가 다른 사람에게 살아있는 느낌을 주고, 한 사람의 조용하고 편안한 존재감이 다른 사람에게 안정감을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람의 빠른 에너지가 다른 사람에게 부담으로 느껴지는 순간이 있습니다. "네 페이스로 해"라고 먼저 말해주는 것이 이 패턴을 넘는 가장 빠른 방법입니다.`,
    'nature-warm_active': `${nameA}의 흐름을 가진 사람은 자신의 리듬 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 표현 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 조용하고 편안한 존재감이 다른 사람에게 안정감을 주고, 한 사람의 활기차고 직접적인 에너지가 다른 사람에게 살아있는 느낌을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람의 조용한 존재감이 다른 사람에게 무관심으로 읽히는 순간이 있습니다. "나 여기 있어"라고 먼저 말해주는 것이 이 패턴에서 보호해줍니다.`,
    'warm_soft-warm_active': `${nameA}의 흐름을 가진 사람은 배려 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 표현 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 따뜻한 배려가 다른 사람에게 안심감을 주고, 한 사람의 직접적인 표현이 다른 사람에게 살아있는 느낌을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 한 사람의 조심스러운 표현이 다른 사람에게 소극적으로 느껴지는 순간이 있습니다. "네 표현 방식이 나는 좋아"라고 먼저 말해주는 것이 두 사람 사이의 온도를 높여줍니다.`,
    'warm_grounded-cool_deep': `${nameA}의 흐름을 가진 사람은 안정 중심으로 살아갑니다. ${nameB}의 흐름을 가진 사람은 내면 성찰 중심으로 살아갑니다.
서로에게 끌리는 이유는 명확합니다. 한 사람의 안정적인 존재감이 다른 사람에게 신뢰감을 주고, 한 사람의 깊은 내면이 다른 사람에게 깊이감을 줍니다.
반복되는 패턴은 이렇게 나타납니다. 두 사람 모두 감정을 바로 드러내지 않아 서로의 마음을 읽기 어려울 때가 있습니다. 먼저 한 마디 건네는 것이 두 사람 사이를 가장 빠르게 연결하는 방법입니다.`,
  };
...
function buildClosingMessage(
  ...
  const relMessages: Record<RelationType, string> = {
    ...
    '아빠-아들': `아빠와 아들은 서로에게 많은 것을 배우면서 자랍니다. 서로의 감정 표현 방식이 다를 뿐, 두 사람 모두 더 가까이 연결되고 싶은 마음이 있습니다. 오늘 이 흐름이 그 연결의 시작이 되길 바랍니다.`,
    '아빠-딸': `아빠와 딸은 서로에게 많은 것을 배우면서 자랍니다. 서로의 감정 표현 방식이 다를 뿐, 두 사람 모두 더 가까이 연결되고 싶은 마음이 있습니다. 오늘 이 흐름이 그 연결의 시작이 되길 바랍니다.`,
    '엄마-아들': `엄마와 아들은 서로에게 많은 것을 배우면서 자랍니다. 서로의 감정 표현 방식이 다를 뿐, 두 사람 모두 더 가까이 연결되고 싶은 마음이 있습니다. 오늘 이 흐름이 그 연결의 시작이 되길 바랍니다.`,
    '엄마-딸': `엄마와 딸은 서로에게 많은 것을 배우면서 자랍니다. 서로의 감정 표현 방식이 다를 뿐, 두 사람 모두 더 가까이 연결되고 싶은 마음이 있습니다. 오늘 이 흐름이 그 연결의 시작이 되길 바랍니다.`,
