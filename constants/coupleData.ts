...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  ...
  성장자극형: {
    ...
    connectionStyle: '부딪힌 후 더 가까워지는 것. 갈등이 끝이 아니라 시작인 관계. "그래서 우리가 성장했어"라고 말할 수 있을 때, 이 관계의 연결이 완성됩니다.',
  ...
  안정추구형: {
    ...
    connectionStyle: '함께 먹는 밥, 나누는 일상 이야기, 습관처럼 하는 연락. 특별한 것이 없어도 함께 있는 것. 그 루틴이 이 관계의 연결입니다. 매일 반복되는 작은 것들이 이 관계를 지탱합니다.',
  ...
  거리조절형: {
    ...
    connectionStyle: '"나 지금 공간이 필요해." 이 말을 거부로 듣지 않는 것. 그것이 이 관계의 연결입니다. 거리가 사랑의 반대가 아님을 두 사람이 함께 배우는 것.',
  ...
  회복형: {
    ...
    tensionDescription: '이 관계에는 갈등이 있습니다. 싸우고 나면 지칩니다. 또 이 패턴이야, 싶을 때도 있습니다. 그러나 두 사람은 반드시 다시 연결됩니다. 멀어진 만큼 더 가까워집니다. 갈등의 횟수가 아니라, 회복의 깊이가 이 관계의 척도입니다.',
    ...
    connectionStyle: '갈등을 함께 넘어온 경험이 이 관계의 가장 깊은 연결입니다. "우리 이번에도 해냈어." 그 감각이 쌓일수록 이 관계는 더 단단해집니다. 상처를 함께 아문 사람들만이 아는 연결입니다.',
    ...
    closingMessage: '이 관계는 갈등 후 더 가까워집니다. 싸우는 것이 문제가 아닙니다. 어떻게 돌아오느냐가 이 관계의 핵심입니다. 두 사람은 이미 그 방법을 알고 있습니다. 그 회복의 능력이 이 관계의 가장 큰 자산입니다.',
    ...
    realEmotions: {
      feelings: [
        ...
        '갈등 후 회복하는 것이 지칠 수 있습니다.',
        '상처를 받았지만 먼저 다가가야 할 것 같은 부담이 있을 수 있습니다.',
        '갈등이 반복될 때 이 관계가 맞는지 의심이 올 수 있습니다.',
      ],
