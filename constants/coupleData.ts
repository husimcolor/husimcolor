...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  온도차형: {
    typeName: '온도차형 관계',
    typeEmoji: '🌡️',
    coreSummary: '두 사람은 같은 상황을 다른 속도로 경험합니다. 한 사람이 이미 결론에 도달했을 때, 다른 사람은 아직 감정 안에 있습니다.',
    tensionDescription: '표현의 타이밍이 다릅니다. 한 사람은 빠르게 말하고, 다른 사람은 정리된 후에야 말합니다. 이 속도 차이가 오해의 씨앗이 됩니다. "왜 말을 안 해?"와 "왜 이미 결론을 내려?"가 반복되는 패턴입니다.',
    misunderstandingPattern: '침묵이 거리감으로 읽힙니다. 정리하는 사람은 "생각 중"이지만, 기다리는 사람에게는 "차갑게 느껴짐"으로 전달됩니다. 속도의 차이가 온도의 차이처럼 느껴지는 것이 이 관계의 핵심 오해입니다.',
    connectionStyle: '먼저 말하는 것보다 먼저 기다리는 것이 이 관계의 연결 방식입니다. "나 지금 정리 중이야"라는 한 마디가 침묵을 설명해줍니다. 속도를 맞추려 하지 말고, 속도가 다름을 인정하는 것이 시작입니다.',
    recoveryRoutine: '갈등 후 30분 각자 시간을 갖고 다시 만나세요. "그때 어떤 마음이었어?"가 아니라 "지금은 어때?"로 시작하는 것이 이 관계의 회복 루틴입니다.',
    neededWords: '"천천히 해도 돼. 나 여기 있을게."',
    recommendedActivity: '말 없이 함께 있는 시간 — 같은 공간에서 각자 하고 싶은 것을 하는 저녁. 대화 없이도 연결되는 경험이 이 관계를 회복시킵니다.',
    emotionRecoveryStyle: '빠른 화해보다 충분한 공간이 먼저입니다. 회복은 "우리 다시 잘 지내자"가 아니라 "나 이제 괜찮아"에서 시작됩니다. 각자의 속도를 존중하는 것이 이 관계의 회복 방식입니다.',
    conversationRoutine: '하루 한 번, 짧게. "오늘 어땠어?"보다 "오늘 뭐가 제일 기억나?"가 이 관계에 더 잘 맞는 대화입니다. 길게 말하지 않아도 됩니다. 짧고 솔직한 교환이 이 관계의 대화 리듬입니다.',
    connectionRoutine: '말보다 존재로 연결됩니다. 같은 공간에서 조용히 쉬는 시간, 굳이 대화하지 않아도 편안한 시간이 이 관계의 정서 연결입니다. 침묵이 불편하지 않은 날이 이 관계가 가장 가까운 날입니다.',
    affectionRoutine: '부담 없는 작은 행동이 이 관계의 애정 언어입니다. 손잡고 조용히 걷기, 따뜻한 음료 건네기, 잠들기 전 짧게 "오늘 고마웠어" 한 마디. 화려하지 않아도 됩니다.',
    emotionRoutine: '감정이 정리되지 않았을 때 억지로 말하지 않아도 됩니다. "나 지금 말하기 어려워, 조금만 기다려줘"가 이 관계에서 가장 정직한 감정 표현입니다. 정리된 후에 말하는 것이 이 관계의 회복 방식입니다.',
    closingMessage: '두 사람이 같은 속도로 움직이지 않아도 괜찮습니다. 온도가 다르다는 것은 서로가 다른 방식으로 이 관계를 소중히 여긴다는 뜻입니다. 속도를 맞추려 하지 말고, 서로의 속도를 읽는 법을 배우세요. 그것이 이 관계가 오래가는 방법입니다.',
    temperatureGraph: { emotionGap: 70, expressionIntensity: 40, recoverySpeed: 55 },
    expressionSpeed: { personA: '즉시 표현', personB: '정리 후 표현', description: '한 사람은 감정이 생기면 바로 말하고, 다른 사람은 충분히 정리된 후에야 말합니다. 이 타이밍 차이가 "왜 말을 안 해?"와 "왜 이미 결론을 내려?"로 반복됩니다.' },
    recoveryStyle: { icon: 'alone' as const, label: '혼자 정리형', description: '각자 충분한 시간을 갖고 정리된 후 다시 만나는 방식으로 회복됩니다. 빠른 화해보다 진짜 회복을 선택합니다.' },
    dangerPattern: '침묵이 길어질수록 거리감이 굳어집니다. "어차피 말해도 달라지지 않아"라는 포기가 쌓이면, 두 사람은 같은 공간에 있어도 다른 세계에 있게 됩니다. 침묵의 의미를 물어보지 않는 것이 가장 큰 위험입니다.',
    forbiddenWords: ['"왜 말을 안 해?"', '"그냥 넘어가면 되잖아"', '"왜 이렇게 예민해?"', '"이미 지난 일이잖아"'],
    relationStrength: '말하지 않아도 서로의 상태를 알아채는 능력, 그것이 이 관계의 가장 큰 강점입니다. 속도가 달라도 방향이 같다면, 결국 같은 곳에 도달합니다. 이 관계는 조용하지만 깊습니다.',
    intimacyConnection: {
      marriageNote: '말이 어색할 때, 몸의 언어가 먼저 다가갑니다. 온도차가 있는 부부에게 가벼운 스킨십은 "나 아직 여기 있어"라는 신호입니다. 말보다 먼저 손을 내미는 것이 이 관계에서 가장 용기 있는 행동입니다.',
      loverNote: '거리감이 느껴질 때, 말 대신 가까이 앉는 것부터 시작하세요. 물리적 거리가 좁혀지면 감정의 거리도 자연스럽게 좁혀집니다.',
      actions: ['말 없이 옆에 앉기', '잠들기 전 손 잡기', '지나칠 때 어깨 살짝 건드리기', '따뜻한 음료 건네며 눈 맞추기'],
    },
  },
  성장자극형: {
    typeName: '성장자극형 관계',
    typeEmoji: '⚡',
    coreSummary: '두 사람은 서로를 변화시킵니다. 편안하지 않지만, 이 관계 안에서 두 사람은 더 나은 사람이 됩니다.',
    tensionDescription: '에너지가 충돌합니다. 한 사람의 직진이 다른 사람의 경계를 건드리고, 그 마찰이 갈등이 됩니다. 하지만 그 갈등이 두 사람을 성장시키는 연료이기도 합니다. 편안함보다 자극이 이 관계의 언어입니다.',
    misunderstandingPattern: '강하게 말하면 "공격"으로 읽힙니다. 솔직함이 상처가 되고, 직접적인 표현이 "왜 저렇게 말해?"로 들립니다. 서로를 바꾸려는 마음이 "나를 인정하지 않는다"는 느낌으로 전달되는 것이 이 관계의 오해입니다.',
    connectionStyle: '갈등 후 함께 새로운 것을 시도하는 것이 이 관계의 연결 방식입니다. 말로 화해하는 것보다 함께 움직이는 것이 더 잘 맞습니다. 갈등 후 함께 처음 가보는 곳, 처음 해보는 것이 이 관계를 다시 연결시킵니다.',
    recoveryRoutine: '갈등 후 말로 풀기보다 함께 움직이세요. 드라이브, 산책, 처음 가보는 식당. 몸이 움직이면 감정도 풀립니다. 이 관계의 회복은 대화보다 행동에서 시작됩니다.',
    neededWords: '"네 말이 맞아. 나도 변하고 있어."',
    recommendedActivity: '함께 처음 해보는 것 — 새로운 취미, 처음 가보는 여행지, 함께 배우는 것. 갈등 후 새로운 경험이 이 관계를 리셋시킵니다.',
    emotionRecoveryStyle: '에너지를 소모한 후에는 각자 충전이 필요합니다. 갈등 후 바로 화해하려 하지 말고, 각자 에너지를 회복한 후 다시 만나세요. 충전된 상태에서 만나야 진짜 대화가 됩니다.',
    conversationRoutine: '"네가 틀렸어"가 아니라 "나는 이렇게 느꼈어"로 시작하는 대화가 이 관계를 바꿉니다. 주장보다 감정을 먼저 말하는 연습이 이 관계의 대화 루틴입니다. 강하게 말해도 되지만, 감정을 먼저 꺼내세요.',
    connectionRoutine: '갈등을 함께 넘어온 경험이 이 관계의 가장 깊은 연결입니다. "우리 이번에도 해냈어"라는 감각이 쌓일수록 이 관계는 더 단단해집니다. 갈등 자체가 이 관계의 연결 방식입니다.',
    affectionRoutine: '행동으로 표현하는 것이 이 관계의 애정 언어입니다. 함께 드라이브하기, 같이 요리하기, 처음 가보는 곳에 데려가기. 말보다 함께하는 경험이 이 관계에서 더 크게 느껴집니다.',
    emotionRoutine: '감정이 폭발하기 전에 "나 지금 에너지가 없어, 나중에 얘기하자"라고 말하는 것이 이 관계의 가장 중요한 감정 관리입니다. 충전된 상태에서 대화해야 갈등이 성장으로 이어집니다.',
    closingMessage: '두 사람이 편안하지 않은 것은 이 관계가 나쁜 것이 아닙니다. 서로를 자극하고 변화시키는 것이 이 관계의 방식입니다. 갈등을 피하지 말고, 갈등을 다루는 방법을 함께 만들어가세요. 이 관계는 두 사람을 더 강하게 만들고 있습니다.',
    temperatureGraph: { emotionGap: 60, expressionIntensity: 85, recoverySpeed: 70 },
    expressionSpeed: { personA: '직접 표현', personB: '반응 후 표현', description: '한 사람은 감정을 바로 강하게 표현하고, 다른 사람은 그 에너지에 반응한 후 자신의 감정을 표현합니다. 이 에너지 교환이 갈등이 되기도 하고 성장의 연료가 되기도 합니다.' },
    recoveryStyle: { icon: 'activity' as const, label: '활동 회복형', description: '함께 움직이고 새로운 것을 경험하면서 회복됩니다. 말보다 행동이 이 관계의 회복 언어입니다.' },
    dangerPattern: '갈등이 반복되면서 "이 사람과 있으면 지친다"는 피로감이 쌓입니다. 자극이 성장이 아닌 소모로 느껴지기 시작하면, 이 관계는 위험 신호입니다. 갈등 후 회복 없이 다음 갈등으로 넘어가는 패턴을 조심하세요.',
    forbiddenWords: ['"네가 틀렸어"', '"왜 항상 이래?"', '"그러니까 안 된다고"', '"내 말이 맞잖아"'],
    relationStrength: '서로를 편안하게 두지 않는 것, 그것이 이 관계의 가장 큰 강점입니다. 이 관계 안에서 두 사람은 멈추지 않습니다. 갈등이 있어도 함께 앞으로 나아가는 것이 이 관계의 본질입니다.',
    intimacyConnection: {
      marriageNote: '갈등 후 먼저 손을 내미는 것이 이 관계에서 가장 용기 있는 행동입니다. 말보다 먼저 가까이 다가가는 것이 "나 아직 이 관계를 포기하지 않았어"라는 신호입니다. 강한 에너지를 가진 부부일수록 스킨십이 화해의 언어가 됩니다.',
      loverNote: '갈등 후 말이 어렵다면 먼저 옆에 앉으세요. 몸이 가까워지면 말도 자연스럽게 따라옵니다. 강한 감정 뒤에 오는 조용한 연결이 이 관계를 회복시킵니다.',
      actions: ['갈등 후 먼저 옆에 앉기', '말 없이 어깨에 기대기', '화해 후 함께 드라이브하기', '처음 가보는 곳에 함께 가기'],
    },
  },
  안정추구형: {
    typeName: '안정추구형 관계',
    typeEmoji: '🏡',
    coreSummary: '두 사람은 함께 있으면 편안합니다. 이 관계의 가장 큰 자산은 신뢰이고, 가장 큰 위험은 익숙함 속에서 서로를 당연하게 여기는 것입니다.',
    tensionDescription: '갈등이 없는 것이 문제가 될 수 있습니다. 너무 편해서 감정을 말하지 않게 되고, 말하지 않아서 쌓이고, 쌓여서 어느 날 터집니다. 안정이 정체로 변하는 순간이 이 관계의 위기입니다.',
    misunderstandingPattern: '익숙함이 당연함이 됩니다. "말 안 해도 알겠지"가 쌓이면, 어느 날 "나는 네가 이렇게 느끼는지 몰랐어"가 됩니다. 편안함이 소통의 부재를 가리는 것이 이 관계의 오해입니다.',
    connectionStyle: '일상을 함께 만드는 것이 이 관계의 연결 방식입니다. 특별한 이벤트보다 반복되는 작은 루틴이 이 관계를 유지시킵니다. 매일 저녁 10분의 대화, 주말의 작은 약속이 이 관계의 언어입니다.',
    recoveryRoutine: '갈등 후 일상으로 돌아오는 것이 이 관계의 회복입니다. 특별한 화해보다 평소처럼 함께 밥을 먹고, 평소처럼 이야기하는 것이 이 관계에서 가장 자연스러운 회복입니다.',
    neededWords: '"오늘도 고마워. 네가 있어서 다행이야."',
    recommendedActivity: '함께하는 일상 루틴 — 주말 아침 같이 요리하기, 저녁 산책, 좋아하는 드라마 함께 보기. 특별함보다 반복되는 편안함이 이 관계의 애정 언어입니다.',
    emotionRecoveryStyle: '감정이 쌓이기 전에 작게 말하는 연습이 필요합니다. "나 요즘 좀 피곤해"처럼 작은 감정을 일상에서 나누는 것이 이 관계의 감정 관리입니다. 큰 감정 폭발보다 작은 감정 공유가 이 관계를 건강하게 만듭니다.',
    conversationRoutine: '저녁 식사 후 10분, 오늘 가장 기억나는 순간 하나씩 이야기하기. 특별한 주제가 없어도 됩니다. 일상을 나누는 것 자체가 이 관계의 대화 루틴입니다. 말의 내용보다 함께 말하는 시간이 중요합니다.',
    connectionRoutine: '반복되는 작은 약속이 이 관계의 정서 연결입니다. 매주 같은 카페, 매달 같은 날 외식, 매년 같은 여행지. 반복이 신뢰가 되고, 신뢰가 연결이 됩니다.',
    affectionRoutine: '일상 속 작은 표현이 이 관계의 애정 언어입니다. 아침에 커피 먼저 내려주기, 퇴근 후 "오늘 어땠어?" 먼저 묻기, 자기 전 "오늘도 고마웠어" 한 마디. 화려하지 않아도, 반복되는 것이 이 관계를 따뜻하게 만듭니다.',
    emotionRoutine: '감정이 쌓이기 전에 작게 꺼내는 연습이 필요합니다. "나 요즘 좀 지쳐" 같은 작은 말이 큰 갈등을 예방합니다. 편안한 관계일수록 감정 표현을 더 의식적으로 해야 합니다.',
    closingMessage: '이 관계의 가장 큰 강점은 신뢰입니다. 하지만 신뢰가 당연함이 되지 않도록, 오늘 "고마워"라고 한 번 더 말해보세요. 편안함 속에서도 서로를 새롭게 보는 눈을 잃지 마세요. 이 관계는 오래갈수록 더 깊어집니다.',
    temperatureGraph: { emotionGap: 30, expressionIntensity: 35, recoverySpeed: 60 },
    expressionSpeed: { personA: '안정적 표현', personB: '안정적 표현', description: '두 사람 모두 감정 표현이 안정적입니다. 큰 기복 없이 일상을 함께 만들어가는 것이 이 관계의 리듬입니다. 편안함이 이 관계의 가장 큰 자산입니다.' },
    recoveryStyle: { icon: 'routine' as const, label: '루틴 회복형', description: '일상으로 돌아오는 것이 회복입니다. 특별한 화해보다 평소처럼 함께하는 시간이 이 관계를 회복시킵니다.' },
    dangerPattern: '익숙함이 무관심처럼 보이기 시작합니다. "말 안 해도 알겠지"가 쌓이면, 어느 날 "나는 네가 이렇게 느끼는지 몰랐어"가 됩니다. 편안함이 소통의 부재를 가리지 않도록 의식적인 표현이 필요합니다.',
    forbiddenWords: ['"말 안 해도 알잖아"', '"항상 이랬잖아"', '"뭐가 문제야, 잘 지내고 있잖아"', '"그냥 넘어가자"'],
    relationStrength: '흔들리지 않는 신뢰, 그것이 이 관계의 가장 큰 자산입니다. 어떤 상황에서도 서로가 있다는 안정감, 그것이 이 관계를 오래가게 만드는 힘입니다. 편안함은 이 관계의 약점이 아니라 가장 큰 강점입니다.',
    intimacyConnection: {
      marriageNote: '오래된 부부에게 스킨십은 "나 아직 여기 있어"라는 가장 조용한 신호입니다. 익숙함 속에서도 의식적으로 손을 잡고, 안아주는 것이 이 관계를 따뜻하게 유지시킵니다. 당연하게 여기지 말고, 오늘 먼저 다가가세요.',
      loverNote: '편안한 관계일수록 스킨십을 의식적으로 표현하는 것이 중요합니다. 익숙해진 사이일수록 "오늘도 좋았어"라는 작은 표현이 관계를 따뜻하게 유지시킵니다.',
      actions: ['아침 인사할 때 짧게 안아주기', '함께 소파에 기대어 쉬기', '손잡고 저녁 산책하기', '자기 전 "오늘도 고마웠어" 말하며 토닥이기'],
    },
  },
  감정순환형: {
    typeName: '감정순환형 관계',
    typeEmoji: '🌊',
    coreSummary: '두 사람의 감정은 파도처럼 움직입니다. 가까워졌다가 멀어지고, 다시 가까워지는 흐름이 반복됩니다. 이 순환 자체가 이 관계의 방식입니다.',
    tensionDescription: '감정이 올라올 때와 내려갈 때의 온도 차이가 큽니다. 가까울 때는 매우 가깝고, 멀어질 때는 매우 멀게 느껴집니다. 이 기복이 이 관계를 풍부하게 만들기도 하고, 지치게 만들기도 합니다.',
    misunderstandingPattern: '감정이 내려갈 때 "관계가 식었나?"라고 오해합니다. 파도가 낮아진 것을 관계가 끝나가는 신호로 읽는 것이 이 관계의 가장 큰 오해입니다. 감정의 기복은 이 관계의 특성이지, 문제가 아닙니다.',
    connectionStyle: '감정을 솔직하게 나누는 것이 이 관계의 연결 방식입니다. "오늘 나 좀 가라앉아 있어"라고 말하는 것이 이 관계에서 가장 중요한 연결입니다. 감정을 숨기지 않는 것이 이 관계를 유지시킵니다.',
    recoveryRoutine: '감정이 내려갔을 때 억지로 올리려 하지 마세요. "나 지금 좀 가라앉아 있어, 같이 있어줘"라고 말하고, 그냥 함께 있는 것이 이 관계의 회복입니다. 감정을 해결하려 하지 말고, 함께 느끼는 것이 먼저입니다.',
    neededWords: '"네 감정이 어떻든, 나 여기 있어."',
    recommendedActivity: '감정을 함께 느끼는 활동 — 좋아하는 음악 함께 듣기, 감성적인 영화 보기, 조용한 카페에서 각자 하고 싶은 것 하기. 감정을 공유하는 경험이 이 관계를 연결시킵니다.',
    emotionRecoveryStyle: '감정이 내려갔을 때 혼자 있는 시간과 함께 있는 시간을 적절히 섞는 것이 이 관계의 감정 관리입니다. 완전히 혼자도, 완전히 함께도 아닌, 그 사이 어딘가가 이 관계의 회복 공간입니다.',
    conversationRoutine: '"오늘 기분 어때?"라는 질문을 매일 하세요. 대답이 짧아도 됩니다. "별로야"도 괜찮습니다. 감정을 묻고 받아주는 것이 이 관계의 대화 루틴입니다. 해결하려 하지 말고, 들어주는 것이 먼저입니다.',
    connectionRoutine: '감정을 함께 경험하는 것이 이 관계의 정서 연결입니다. 기쁠 때 함께 기뻐하고, 가라앉을 때 함께 가라앉는 것. 감정의 파도를 함께 타는 것이 이 관계의 연결 방식입니다.',
    affectionRoutine: '감정 표현이 이 관계의 애정 언어입니다. "오늘 네가 보고 싶었어", "네 목소리 듣고 싶었어", "오늘 네 생각 났어". 감성적인 표현이 이 관계를 따뜻하게 만듭니다.',
    emotionRoutine: '감정이 올라올 때 바로 표현하세요. 쌓아두면 더 커집니다. "나 지금 좀 힘들어"라고 말하는 것이 이 관계에서 가장 중요한 감정 관리입니다. 감정을 말하는 것이 이 관계를 건강하게 만듭니다.',
    closingMessage: '감정의 파도가 반복되는 것은 이 관계가 살아있다는 증거입니다. 가까워졌다 멀어지는 것을 두려워하지 마세요. 파도는 항상 다시 돌아옵니다. 두 사람의 감정 리듬을 믿으세요.',
    temperatureGraph: { emotionGap: 50, expressionIntensity: 75, recoverySpeed: 65 },
    expressionSpeed: { personA: '감정 즉시 표현', personB: '감정 흡수 후 표현', description: '한 사람은 감정이 생기면 바로 표현하고, 다른 사람은 감정을 충분히 느낀 후에 표현합니다. 이 리듬 차이가 때로는 "왜 반응이 없어?"로 느껴질 수 있습니다.' },
    recoveryStyle: { icon: 'talk' as const, label: '공감 회복형', description: '감정을 함께 나누고 공감받는 것으로 회복됩니다. 해결보다 공감이 먼저인 관계입니다.' },
    dangerPattern: '감정 기복이 반복되면서 "이 관계가 안정적이지 않다"는 불안이 쌓입니다. 파도가 낮아질 때마다 "관계가 끝나가나?"라는 두려움이 생기면, 이 관계는 지치기 시작합니다. 기복을 관계의 문제로 보지 않는 것이 중요합니다.',
    forbiddenWords: ['"왜 갑자기 차가워졌어?"', '"기분이 왜 그래?"', '"또 이래?"', '"감정 기복이 너무 심해"'],
    relationStrength: '감정을 솔직하게 나눌 수 있는 것, 그것이 이 관계의 가장 큰 강점입니다. 감정의 파도를 함께 타는 경험이 쌓일수록, 이 관계는 더 깊어집니다. 감정이 풍부한 관계는 그만큼 살아있는 관계입니다.',
    intimacyConnection: {
      marriageNote: '감정이 내려갔을 때 말 대신 안아주는 것이 이 관계에서 가장 효과적인 회복입니다. 감정의 파도를 함께 타는 부부에게 스킨십은 "나 아직 여기 있어"라는 가장 따뜻한 신호입니다.',
      loverNote: '감정이 가라앉을 때 말 대신 가까이 있어주세요. 해결하려 하지 말고, 그냥 옆에 있는 것이 이 관계에서 가장 큰 위로입니다.',
      actions: ['감정이 가라앉을 때 말 없이 안아주기', '함께 좋아하는 음악 듣기', '어깨에 기대어 조용히 쉬기', '손잡고 감정 나누기'],
    },
  },
  거리조절형: {
    typeName: '거리조절형 관계',
    typeEmoji: '🌙',
    coreSummary: '두 사람은 가까워지고 싶으면서도 자신만의 공간이 필요합니다. 거리를 조절하는 것 자체가 이 관계의 방식입니다.',
    tensionDescription: '가까워지면 숨막히고, 멀어지면 불안합니다. 이 모순이 이 관계의 핵심 긴장입니다. 한 사람이 가까이 오면 다른 사람이 물러나고, 물러나면 다시 가까이 오는 패턴이 반복됩니다.',
    misunderstandingPattern: '거리를 두면 "나를 피하는 것"으로 읽힙니다. 혼자만의 시간이 필요한 것이 "관심이 없어진 것"으로 오해됩니다. 거리는 관계의 종료 신호가 아니라 충전의 방식입니다.',
    connectionStyle: '서로의 공간을 존중하는 것이 이 관계의 연결 방식입니다. "나 오늘 혼자 있고 싶어"라고 말할 수 있는 것, 그리고 그것을 받아들이는 것이 이 관계의 가장 중요한 연결입니다.',
    recoveryRoutine: '거리가 생겼을 때 억지로 좁히려 하지 마세요. "나 충전하고 올게, 곧 돌아올게"라고 말하고, 충전 후 자연스럽게 돌아오는 것이 이 관계의 회복입니다.',
    neededWords: '"혼자 있어도 돼. 나 여기 있을게."',
    recommendedActivity: '각자의 시간 후 함께하는 활동 — 각자 하고 싶은 것을 하고 저녁에 만나기, 각자 여행 후 이야기 나누기. 각자의 시간이 이 관계를 더 풍부하게 만듭니다.',
    emotionRecoveryStyle: '혼자만의 시간이 이 관계의 가장 중요한 감정 관리입니다. 충전 없이 계속 함께 있으면 이 관계는 지칩니다. 혼자 있는 시간이 이 관계를 더 오래가게 만드는 연료입니다.',
    conversationRoutine: '매일 긴 대화가 필요하지 않습니다. 짧지만 진심 어린 교환이 이 관계의 대화 루틴입니다. "오늘 뭐 했어?" 한 마디, "잘 자" 한 마디. 짧아도 됩니다. 매일 연결되는 것이 중요합니다.',
    connectionRoutine: '각자의 시간 후 다시 만나는 것이 이 관계의 정서 연결입니다. 충전 후 돌아왔을 때 "보고 싶었어"라고 말하는 것이 이 관계의 가장 깊은 연결입니다.',
    affectionRoutine: '부담 없는 연결이 이 관계의 애정 언어입니다. 짧은 메시지, 좋아하는 것 공유하기, 각자 시간 후 "잘 있었어?" 묻기. 강요하지 않는 연결이 이 관계를 따뜻하게 만듭니다.',
    emotionRoutine: '"나 지금 충전이 필요해"라고 말하는 것이 이 관계에서 가장 중요한 감정 표현입니다. 거리를 두는 것이 관계를 포기하는 것이 아님을 서로 알고 있는 것이 이 관계의 건강한 감정 관리입니다.',
    closingMessage: '거리가 생기는 것을 두려워하지 마세요. 이 관계는 가까워졌다 멀어지는 것을 반복하면서 균형을 찾습니다. 서로의 공간을 존중하는 것이 이 관계를 오래가게 만드는 방법입니다. 거리는 이 관계의 약점이 아니라 방식입니다.',
    temperatureGraph: { emotionGap: 55, expressionIntensity: 45, recoverySpeed: 50 },
    expressionSpeed: { personA: '공간 필요형', personB: '연결 추구형', description: '한 사람은 혼자만의 시간이 필요하고, 다른 사람은 연결을 추구합니다. 이 차이가 "왜 멀어지려 해?"와 "왜 항상 붙어있으려 해?"로 반복됩니다.' },
    recoveryStyle: { icon: 'alone' as const, label: '공간 회복형', description: '혼자만의 시간으로 충전한 후 자연스럽게 돌아오는 방식으로 회복됩니다. 거리가 회복의 방법입니다.' },
    dangerPattern: '거리가 너무 길어지면 "우리 멀어진 것 아닌가?"라는 불안이 쌓입니다. 충전을 위한 거리가 습관적인 회피가 되지 않도록, 돌아오는 것을 의식적으로 해야 합니다. 거리를 두되, 돌아오는 것을 잊지 마세요.',
    forbiddenWords: ['"왜 항상 혼자 있으려 해?"', '"나 피하는 거야?"', '"우리 사이가 멀어진 것 같아"', '"왜 연락을 안 해?"'],
    relationStrength: '서로의 공간을 존중하는 것, 그것이 이 관계의 가장 큰 강점입니다. 혼자 있어도 불안하지 않은 관계, 그것이 이 관계의 성숙함입니다. 거리를 두면서도 연결되어 있다는 것을 아는 것이 이 관계를 특별하게 만듭니다.',
    intimacyConnection: {
      marriageNote: '각자의 시간 후 다시 만날 때의 연결이 이 관계에서 가장 따뜻한 순간입니다. 충전 후 돌아왔을 때 먼저 안아주는 것이 "나 돌아왔어"라는 가장 따뜻한 신호입니다.',
      loverNote: '각자의 시간 후 다시 만날 때 "보고 싶었어"라고 말하며 가까이 다가가세요. 거리 후의 연결이 이 관계에서 가장 따뜻한 순간입니다.',
      actions: ['각자 시간 후 만날 때 먼저 안아주기', '충전 후 "보고 싶었어" 말하기', '각자 하고 싶은 것 하고 저녁에 함께 쉬기', '손편지나 짧은 메모 남기기'],
    },
  },
  보호자형: {
    typeName: '보호자형 관계',
    typeEmoji: '🛡️',
    coreSummary: '한 사람의 사랑이 보호의 언어로 표현됩니다. 지키고 싶은 마음이 크지만, 그 마음이 때로는 상대방을 숨막히게 만들 수 있습니다.',
    tensionDescription: '사랑과 통제의 경계가 흐릿합니다. 보호하려는 마음에서 나온 행동이 "왜 내 일에 간섭해?"로 느껴지는 순간이 생깁니다. 걱정이 크면 클수록 상대방의 자유가 좁아지는 패턴이 이 관계의 핵심 긴장입니다.',
    misunderstandingPattern: '걱정이 통제로 읽힙니다. "너를 위해서"라는 말이 "내 방식대로 해"로 들립니다. 보호하는 사람은 사랑을 표현하고 있지만, 보호받는 사람은 자유를 잃고 있다고 느낍니다.',
    connectionStyle: '보호하되 결정권을 주는 것이 이 관계의 연결 방식입니다. "내가 도와줄게, 어떻게 하고 싶어?"라고 묻는 것이 이 관계에서 가장 중요한 연결입니다. 보호와 자율성을 함께 주는 것이 이 관계의 언어입니다.',
    recoveryRoutine: '보호하는 사람이 한 발 물러서는 것이 이 관계의 회복입니다. "내가 너무 걱정했나봐, 미안해"라고 말하는 것이 이 관계에서 가장 중요한 화해의 시작입니다.',
    neededWords: '"네가 결정해. 나는 네 편이야."',
    recommendedActivity: '상대방이 원하는 것을 함께 하기 — 상대방이 하고 싶은 것을 먼저 물어보고 함께 하는 경험. 보호자가 따라가는 경험이 이 관계의 균형을 만듭니다.',
    emotionRecoveryStyle: '걱정이 올라올 때 "나 지금 걱정이 돼"라고 말하는 것이 이 관계의 감정 관리입니다. 걱정을 행동으로 표현하기 전에 말로 먼저 꺼내는 것이 이 관계를 건강하게 만듭니다.',
    conversationRoutine: '"어떻게 하고 싶어?"라고 먼저 묻는 것이 이 관계의 대화 루틴입니다. 조언보다 질문이 먼저입니다. 상대방의 생각을 듣는 것이 이 관계의 대화를 바꿉니다.',
    connectionRoutine: '상대방이 스스로 결정하고 성공하는 것을 함께 기뻐하는 것이 이 관계의 정서 연결입니다. "네가 해냈어"라고 말하는 것이 이 관계의 가장 깊은 연결입니다.',
    affectionRoutine: '지지하는 표현이 이 관계의 애정 언어입니다. "네가 하는 것 믿어", "네 선택 응원해", "뭐든 네 편이야". 보호보다 지지가 이 관계를 따뜻하게 만듭니다.',
    emotionRoutine: '걱정이 올라올 때 행동하기 전에 말하세요. "나 지금 네가 걱정돼"라고 먼저 말하고, 상대방의 반응을 기다리는 것이 이 관계의 감정 관리입니다.',
    closingMessage: '보호하고 싶은 마음은 사랑입니다. 하지만 가장 큰 사랑은 상대방이 스스로 설 수 있도록 옆에서 지켜보는 것입니다. 한 발 물러서서 "네가 결정해, 나는 네 편이야"라고 말해보세요. 그것이 이 관계에서 가장 깊은 사랑의 표현입니다.',
    temperatureGraph: { emotionGap: 45, expressionIntensity: 65, recoverySpeed: 55 },
    expressionSpeed: { personA: '보호 표현형', personB: '자율 추구형', description: '한 사람은 걱정과 보호로 사랑을 표현하고, 다른 사람은 자율성과 독립으로 자신을 표현합니다. 이 차이가 "왜 간섭해?"와 "나는 너를 위해서야"로 반복됩니다.' },
    recoveryStyle: { icon: 'talk' as const, label: '대화 회복형', description: '"내가 너무 걱정했나봐"라는 인정과 "나는 네 편이야"라는 지지로 회복됩니다.' },
    dangerPattern: '보호가 통제가 되는 순간, 이 관계는 숨막히기 시작합니다. "너를 위해서"라는 말이 반복될수록 상대방은 자신의 선택권을 잃어가는 느낌을 받습니다. 보호와 통제의 경계를 의식적으로 확인해야 합니다.',
    forbiddenWords: ['"내가 다 알아서 할게"', '"너를 위해서야"', '"왜 내 말을 안 들어?"', '"그러다 다쳐"'],
    relationStrength: '누군가를 진심으로 지키고 싶은 마음, 그것이 이 관계의 가장 큰 강점입니다. 보호하는 사람의 사랑은 깊고 진심입니다. 그 사랑이 자유와 함께할 때, 이 관계는 가장 아름답습니다.',
    intimacyConnection: {
      marriageNote: '보호하는 마음을 스킨십으로 표현하는 것이 이 관계에서 자연스럽습니다. 하지만 먼저 "안아줘도 돼?"라고 묻는 것이 이 관계의 존중입니다. 상대방의 선택을 기다리는 것이 가장 깊은 보호입니다.',
      loverNote: '보호하고 싶은 마음을 "안아줄게"로 표현해보세요. 말보다 따뜻한 스킨십이 이 관계에서 더 잘 전달됩니다.',
      actions: ['"안아줄게?" 먼저 묻기', '어깨에 손 얹으며 "괜찮아?" 묻기', '힘들 때 옆에서 조용히 함께 있기', '잘 해냈을 때 토닥이며 "잘 했어" 말하기'],
    },
  },
  친구형: {
    typeName: '친구형 관계',
    typeEmoji: '☀️',
    coreSummary: '두 사람은 연인이면서 가장 편한 친구입니다. 이 관계의 가장 큰 강점은 편안함이고, 가장 큰 위험은 설렘을 잊는 것입니다.',
    tensionDescription: '너무 편해서 연인처럼 느껴지지 않는 순간이 생깁니다. 친구처럼 편안하지만, 연인으로서의 특별함이 사라지는 것이 이 관계의 긴장입니다.',
    misunderstandingPattern: '편안함이 무관심으로 읽힙니다. "우리 그냥 친구 같아"라는 느낌이 생기면, 관계의 온도가 내려가는 것처럼 느껴집니다. 편안함과 설렘을 함께 유지하는 것이 이 관계의 과제입니다.',
    connectionStyle: '함께 웃고 즐기는 것이 이 관계의 연결 방식입니다. 진지한 대화보다 함께 재미있는 것을 경험하는 것이 이 관계를 더 가깝게 만듭니다.',
    recoveryRoutine: '갈등 후 함께 웃을 수 있는 것을 하세요. 좋아하는 음식 먹기, 재미있는 영상 함께 보기. 웃음이 이 관계의 가장 빠른 회복 방법입니다.',
    neededWords: '"너랑 있으면 제일 편해. 그리고 제일 좋아."',
    recommendedActivity: '함께 즐거운 것 — 새로운 맛집 탐방, 함께 게임하기, 좋아하는 것 공유하기. 즐거운 경험이 이 관계를 특별하게 만듭니다.',
    emotionRecoveryStyle: '웃음이 이 관계의 가장 좋은 감정 관리입니다. 무거운 감정이 생겼을 때 함께 가벼운 것을 하는 것이 이 관계의 회복 방식입니다.',
    conversationRoutine: '가볍고 재미있는 대화가 이 관계의 일상 루틴입니다. 진지한 대화도 필요하지만, 함께 웃는 시간이 이 관계를 유지시킵니다.',
    connectionRoutine: '함께 웃은 기억이 이 관계의 정서 연결입니다. "그때 그거 진짜 웃겼지"라고 함께 기억하는 것이 이 관계를 특별하게 만듭니다.',
    affectionRoutine: '가볍고 자연스러운 표현이 이 관계의 애정 언어입니다. 장난치기, 좋아하는 것 공유하기, 함께 웃기. 편안하게 표현하는 것이 이 관계의 방식입니다.',
    emotionRoutine: '감정이 무거워질 때 함께 가벼운 것을 하세요. 이 관계는 웃음으로 많은 것을 회복할 수 있습니다.',
    closingMessage: '편안함은 이 관계의 가장 큰 선물입니다. 하지만 가끔은 연인으로서의 특별한 시간을 의식적으로 만들어보세요. 친구이면서 연인인 것, 그것이 이 관계의 가장 아름다운 점입니다.',
    temperatureGraph: { emotionGap: 25, expressionIntensity: 55, recoverySpeed: 75 },
    expressionSpeed: { personA: '자연스러운 표현', personB: '자연스러운 표현', description: '두 사람 모두 자연스럽고 편안하게 감정을 표현합니다. 이 편안함이 이 관계의 가장 큰 강점입니다.' },
    recoveryStyle: { icon: 'activity' as const, label: '활동 회복형', description: '함께 즐거운 것을 하면서 자연스럽게 회복됩니다. 웃음이 이 관계의 가장 빠른 회복 방법입니다.' },
    dangerPattern: '너무 편해서 연인으로서의 노력을 잊는 것이 이 관계의 위험입니다. 편안함이 당연함이 되면, 설렘이 사라집니다. 가끔은 의식적으로 특별한 시간을 만들어야 합니다.',
    forbiddenWords: ['"우리 그냥 친구 같아"', '"설레는 게 없어"', '"항상 이렇잖아"', '"뭔가 특별한 게 없어"'],
    relationStrength: '함께 있으면 편안하고 즐거운 것, 그것이 이 관계의 가장 큰 강점입니다. 편안함과 즐거움이 함께하는 관계는 오래갑니다. 이 관계는 시간이 지날수록 더 깊어집니다.',
    intimacyConnection: {
      marriageNote: '친구처럼 편안한 부부에게 스킨십은 "우리 여전히 연인이야"라는 신호입니다. 가끔은 의식적으로 먼저 안아주고, 손잡고, 가까이 앉는 것이 이 관계를 연인으로 유지시킵니다.',
      loverNote: '편안한 관계일수록 스킨십을 의식적으로 표현하는 것이 중요합니다. 자연스럽게, 하지만 의식적으로 가까이 다가가세요.',
      actions: ['자연스럽게 손잡기', '함께 소파에 기대어 드라마 보기', '어깨에 기대며 "오늘 좋았어" 말하기', '잠들기 전 "오늘도 좋았어" 말하며 안아주기'],
    },
  },
  이상주의형: {
    typeName: '이상주의형 관계',
    typeEmoji: '✨',
    coreSummary: '두 사람은 이 관계에 큰 의미를 부여합니다. 깊이 연결되고 싶고, 완전히 이해받고 싶은 마음이 이 관계를 특별하게 만들기도 하고, 때로는 무겁게 만들기도 합니다.',
    tensionDescription: '현실이 이상을 따라가지 못하는 순간이 생깁니다. 완벽한 연결을 원하지만, 현실의 관계는 항상 완벽하지 않습니다. 이 간극이 실망이 되고, 실망이 거리감이 됩니다.',
    misunderstandingPattern: '기대가 높으면 실망도 큽니다. "이 사람이라면 나를 완전히 이해해줄 것"이라는 기대가 "왜 나를 이해 못 해?"라는 실망으로 바뀌는 것이 이 관계의 오해입니다.',
    connectionStyle: '깊은 대화가 이 관계의 연결 방식입니다. 일상적인 대화보다 서로의 생각과 감정을 깊이 나누는 것이 이 관계를 연결시킵니다. "너는 어떻게 생각해?"라는 질문이 이 관계의 언어입니다.',
    recoveryRoutine: '실망했을 때 기대를 말하는 것이 이 관계의 회복입니다. "나는 이런 것을 원했어"라고 솔직하게 말하는 것이 이 관계의 화해 방식입니다. 기대를 숨기지 않는 것이 이 관계를 건강하게 만듭니다.',
    neededWords: '"완벽하지 않아도 괜찮아. 너와 함께라면."',
    recommendedActivity: '깊이 있는 경험 — 의미 있는 영화 함께 보기, 철학적인 대화 나누기, 함께 새로운 것을 배우기. 깊이 있는 경험이 이 관계를 특별하게 만듭니다.',
    emotionRecoveryStyle: '실망했을 때 기대를 솔직하게 말하는 것이 이 관계의 감정 관리입니다. 기대를 숨기면 실망이 쌓이고, 쌓인 실망이 관계를 무겁게 만듭니다.',
    conversationRoutine: '깊이 있는 대화가 이 관계의 일상 루틴입니다. "오늘 어땠어?"보다 "요즘 어떤 생각 많이 해?"가 이 관계에 더 잘 맞는 대화입니다.',
    connectionRoutine: '서로의 내면을 나누는 것이 이 관계의 정서 연결입니다. 생각, 꿈, 두려움을 함께 나누는 것이 이 관계를 깊게 만듭니다.',
    affectionRoutine: '의미 있는 표현이 이 관계의 애정 언어입니다. 손편지, 의미 있는 선물, "너와 함께라서 이 순간이 특별해"라는 말. 깊이 있는 표현이 이 관계를 따뜻하게 만듭니다.',
    emotionRoutine: '기대가 생겼을 때 바로 말하세요. "나는 이런 것을 원해"라고 솔직하게 말하는 것이 이 관계의 가장 중요한 감정 표현입니다.',
    closingMessage: '완벽한 관계는 없습니다. 하지만 깊이 연결되려는 마음, 그것이 이 관계를 특별하게 만듭니다. 이상을 낮추는 것이 아니라, 현실 속에서 이상을 찾는 것이 이 관계의 방향입니다. 완벽하지 않아도, 함께라면 충분합니다.',
    temperatureGraph: { emotionGap: 40, expressionIntensity: 70, recoverySpeed: 45 },
    expressionSpeed: { personA: '깊이 표현형', personB: '깊이 표현형', description: '두 사람 모두 깊이 있게 감정을 표현합니다. 이 깊이가 이 관계를 특별하게 만들기도 하고, 때로는 무겁게 만들기도 합니다.' },
    recoveryStyle: { icon: 'talk' as const, label: '대화 회복형', description: '깊이 있는 대화로 회복됩니다. 기대와 감정을 솔직하게 나누는 것이 이 관계의 회복 방식입니다.' },
    dangerPattern: '기대가 높을수록 실망도 큽니다. 완벽한 연결을 원하다가 현실의 불완전함에 실망하는 패턴이 반복되면, 이 관계는 지치기 시작합니다. 기대를 현실적으로 조정하는 것이 이 관계의 과제입니다.',
    forbiddenWords: ['"왜 나를 이해 못 해?"', '"이 정도도 못 해줘?"', '"나는 이런 관계를 원했는데"', '"실망이야"'],
    relationStrength: '깊이 연결되려는 마음, 그것이 이 관계의 가장 큰 강점입니다. 이 관계 안에서 두 사람은 서로를 깊이 이해하려 합니다. 그 노력 자체가 이 관계를 특별하게 만듭니다.',
    intimacyConnection: {
      marriageNote: '깊이 연결되고 싶은 부부에게 스킨십은 말로 표현하기 어려운 감정을 전달하는 방법입니다. "말로는 다 못 표현하지만, 이렇게 가까이 있고 싶어"라는 마음을 몸으로 표현해보세요.',
      loverNote: '깊이 연결되고 싶을 때, 말보다 가까이 있는 것이 더 많은 것을 전달합니다. 조용히 안아주는 것이 이 관계에서 가장 깊은 표현입니다.',
      actions: ['조용히 오래 안아주기', '눈 맞추며 "네가 있어서 다행이야" 말하기', '함께 별 보며 이야기하기', '손잡고 의미 있는 장소 방문하기'],
    },
  },
  현실균형형: {
    typeName: '현실균형형 관계',
    typeEmoji: '⚖️',
    coreSummary: '두 사람은 현실적이고 균형 있게 관계를 만들어갑니다. 감정보다 현실을 먼저 보는 경향이 있어, 안정적이지만 때로는 감정적 연결이 부족하게 느껴질 수 있습니다.',
    tensionDescription: '현실적인 문제 해결이 감정 공감보다 앞서는 경향이 있습니다. 상대방이 감정을 표현할 때 해결책을 먼저 제시하는 것이 "내 감정을 무시하는 것"으로 느껴지는 것이 이 관계의 긴장입니다.',
    misunderstandingPattern: '해결책이 공감보다 먼저 나옵니다. "그래서 어떻게 할 건데?"가 "힘들었겠다"보다 먼저 나오는 것이 이 관계의 오해입니다. 감정을 먼저 받아주는 것이 이 관계의 과제입니다.',
    connectionStyle: '현실적인 문제를 함께 해결하는 것이 이 관계의 연결 방식입니다. 하지만 문제 해결 전에 감정을 먼저 나누는 것이 이 관계를 더 깊게 만듭니다.',
    recoveryRoutine: '갈등 후 "그때 어떤 마음이었어?"라고 먼저 묻는 것이 이 관계의 회복입니다. 해결보다 감정을 먼저 확인하는 것이 이 관계의 화해 방식입니다.',
    neededWords: '"해결하기 전에, 힘들었겠다."',
    recommendedActivity: '함께 계획하고 실행하는 활동 — 여행 계획 세우기, 함께 목표 만들기, 새로운 것 배우기. 현실적인 목표를 함께 이루는 경험이 이 관계를 연결시킵니다.',
    emotionRecoveryStyle: '문제가 해결된 후 감정을 나누는 것이 이 관계의 감정 관리입니다. 해결 후 "그때 어떤 마음이었어?"라고 묻는 것이 이 관계의 감정 회복입니다.',
    conversationRoutine: '현실적인 대화와 감정적인 대화를 균형 있게 섞는 것이 이 관계의 루틴입니다. 문제 해결 대화 후 "그래서 지금 기분은 어때?"라고 묻는 것이 이 관계를 균형 있게 만듭니다.',
    connectionRoutine: '함께 목표를 이루는 것이 이 관계의 정서 연결입니다. 작은 목표를 함께 달성하고 "우리 해냈어"라고 말하는 것이 이 관계의 연결입니다.',
    affectionRoutine: '실용적인 표현이 이 관계의 애정 언어입니다. 필요한 것을 먼저 챙겨주기, 힘든 일을 대신 해주기, "내가 도와줄게"라고 말하기. 행동으로 표현하는 것이 이 관계의 방식입니다.',
    emotionRoutine: '감정을 해결책보다 먼저 표현하는 연습이 필요합니다. "나 지금 힘들어"라고 말하는 것이 이 관계에서 가장 중요한 감정 표현입니다.',
    closingMessage: '현실적인 것과 감정적인 것의 균형, 그것이 이 관계의 과제입니다. 문제를 잘 해결하는 것만큼, 감정을 잘 나누는 것도 중요합니다. 오늘 "그래서 기분은 어때?"라고 한 번 더 물어보세요.',
    temperatureGraph: { emotionGap: 35, expressionIntensity: 50, recoverySpeed: 65 },
    expressionSpeed: { personA: '현실 중심형', personB: '현실 중심형', description: '두 사람 모두 현실적으로 상황을 판단하고 표현합니다. 이 균형감이 이 관계의 안정성을 만들지만, 때로는 감정적 연결이 부족하게 느껴질 수 있습니다.' },
    recoveryStyle: { icon: 'routine' as const, label: '문제해결 회복형', description: '현실적인 문제를 함께 해결하면서 회복됩니다. 해결 후 감정을 나누는 것이 이 관계의 완전한 회복입니다.' },
    dangerPattern: '감정보다 현실이 항상 앞서면, 이 관계는 차갑게 느껴지기 시작합니다. "우리는 그냥 현실적인 파트너 같아"라는 느낌이 생기면, 감정적 연결을 의식적으로 만들어야 합니다.',
    forbiddenWords: ['"그래서 어떻게 할 건데?"', '"감정적으로 생각하지 마"', '"현실적으로 봐"', '"그게 뭐가 문제야?"'],
    relationStrength: '현실적인 문제를 함께 잘 해결하는 것, 그것이 이 관계의 가장 큰 강점입니다. 어떤 상황에서도 함께 방법을 찾는 것이 이 관계를 안정적으로 만듭니다.',
    intimacyConnection: {
      marriageNote: '현실적인 부부에게 스킨십은 "우리 여전히 연결되어 있어"라는 신호입니다. 문제를 해결한 후 "수고했어"라며 안아주는 것이 이 관계의 가장 따뜻한 표현입니다.',
      loverNote: '현실적인 대화 후 "그래도 네가 있어서 다행이야"라며 가까이 다가가세요. 현실적인 관계에서 스킨십은 감정적 연결을 만드는 중요한 방법입니다.',
      actions: ['수고했을 때 "고마워" 말하며 안아주기', '함께 목표 달성 후 손잡기', '힘든 일 마친 후 어깨 토닥이기', '함께 쉬며 "오늘도 잘 했어" 말하기'],
    },
  },
  회복형: {
    typeName: '회복형 관계',
    typeEmoji: '🌱',
    coreSummary: '두 사람은 갈등 후 회복하는 패턴을 반복하며 관계를 이어갑니다. 싸우는 것이 문제가 아니라, 어떻게 회복하느냐가 이 관계의 핵심입니다.',
    tensionDescription: '갈등과 회복이 반복됩니다. 충돌이 생기면 힘들지만, 회복 후에는 더 깊이 연결되는 경험을 합니다. 이 패턴 자체가 두 사람의 관계 방식입니다. 회복의 과정이 이 관계를 더 단단하게 만듭니다.',
    misunderstandingPattern: '갈등이 반복되면서 "우리는 왜 이렇게 자주 싸우지?"라는 의문이 생깁니다. 하지만 갈등 자체보다 회복하지 않는 것이 더 큰 문제입니다. 갈등 후 회복을 미루는 것이 이 관계의 가장 큰 위험입니다.',
    connectionStyle: '갈등을 함께 넘어온 경험이 이 관계의 가장 깊은 연결입니다. "우리 이번에도 해냈어"라는 감각이 쌓일수록 이 관계는 더 단단해집니다. 갈등 후 회복하는 방식을 함께 만들어가는 것이 이 관계의 핵심입니다.',
    recoveryRoutine: '갈등 후 충분한 시간을 갖고, 다시 만날 때 "그때 힘들었지? 나도 미안했어"라고 시작하는 대화가 진짜 회복입니다. 빠른 화해보다 진심 어린 회복이 이 관계를 더 단단하게 만듭니다.',
    neededWords: '"우리 또 회복했어. 이번에도 우리가 이겼어."',
    recommendedActivity: '갈등 후 함께 즐거운 시간을 만드는 활동 — 맛있는 것 먹기, 좋아하는 장소 방문, 함께 웃을 수 있는 것. 회복 후의 연결이 이 관계를 더 단단하게 만듭니다.',
    emotionRecoveryStyle: '갈등 후 빠른 화해보다 충분한 감정 처리 시간이 필요합니다. "나 아직 정리가 안 됐어, 조금만 기다려줘"라고 말하는 것이 이 관계의 가장 정직한 회복 방식입니다. 회복 후 "우리 이번에 뭘 배웠지?"라고 묻는 습관이 이 관계를 더 단단하게 만듭니다.',
    conversationRoutine: '갈등 후 다시 만날 때 "그때 어떤 마음이었어?"라고 먼저 묻는 것이 이 관계의 대화 루틴입니다. 사건보다 감정을 먼저 나누는 대화가 진짜 회복을 만듭니다.',
    ...
    closingMessage: '갈등 후 회복하는 것을 반복하며 이 관계는 더 단단해지고 있습니다. 싸우는 것이 문제가 아니라, 어떻게 회복하느냐가 이 관계의 핵심입니다. 두 사람은 이미 그 방법을 알고 있습니다. 이 관계는 갈등을 통해 성장합니다.',
    ...
    dangerPattern: '회복이 반복되면서 지치는 패턴. 갈등과 회복이 반복되다 보면 "또 이 패턴이야"라는 피로감이 쌓입니다. 회복 후 근본적인 원인을 다루지 않으면 같은 갈등이 반복됩니다. 회복 후 "우리 이번에 뭘 배웠지?"라고 묻는 것이 중요합니다.',
    ...
    intimacyConnection: {
      marriageNote: '회복하는 부부에게 화해의 포옹은 말보다 먼저 마음을 열어줍니다. 갈등 후 먼저 손을 내미는 것, 그것이 이 관계에서 가장 용기 있는 행동입니다. 몸의 연결이 마음의 회복을 앞서가도 괜찮습니다.',
      loverNote: '회복하는 과정에서 말이 어렵다면 먼저 가까이 앉는 것부터 시작하세요. 거리가 좁혀지면 말도 자연스럽게 따라옵니다. 화해는 완벽한 말이 아니라 작은 접근에서 시작됩니다.',
      actions: ['갈등 후 먼저 옆에 앉기', '말 없이 손을 내밀기', '화해 후 짧게 안아주기', '회복된 날 "우리 잘 했어" 말하며 토닥이기'],
    },
  },
};
