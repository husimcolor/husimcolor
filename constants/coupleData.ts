...
const ARCHETYPE_DATA: Record<RelationArchetype, Omit<ArchetypeResult, 'archetype'>> = {
  온도차형: {
    ...
    conversationRoutine: '하루 중 딱 한 가지만 이야기하기. "오늘 가장 기억에 남는 순간"을 각자 하나씩 꺼내보세요. 길게 말하지 않아도 됩니다. 짧아도 충분합니다.',
    connectionRoutine: '"지금 어때?"라고 먼저 묻는 것이 이 관계의 가장 강력한 연결입니다. 답을 기다리는 것, 그 자체가 공감입니다.',
    ...
    intimacyConnection: {
      marriageNote: '부부 사이의 따뜻한 신체 접촉은 단순한 표현이 아니라, 오랜 시간 함께한 두 사람의 마음을 다시 연결하는 언어입니다. 바쁜 일상 속에서도 의식적으로 가까이 있는 시간을 만드는 것이 관계 온도를 유지하는 가장 현실적인 방법입니다.',
      loverNote: '표현 속도가 다를 때, 말보다 먼저 손을 내미는 것이 더 빠른 연결이 될 수 있습니다. 가벼운 터치 하나가 "나는 여기 있어"라는 신호가 됩니다.',
      actions: ['잠들기 전 짧게 손 잡기', '외출할 때 가볍게 안아주기', '같은 소파에 나란히 앉아 쉬기', '어깨에 살짝 기대는 시간'],
    },
  },
  성장자극형: {
    typeName: '성장자극형 관계',
    ...
    conversationRoutine: '하루 중 가장 도전적이었던 순간을 이야기하세요. "오늘 나 이런 걸 해봤어"라고 서로의 성장을 공유하는 대화가 이 관계를 살아있게 만듭니다.',
    connectionRoutine: '"네가 도전하는 모습이 나를 움직여"라고 말하는 순간, 두 사람의 에너지가 가장 직접적으로 연결됩니다. 서로의 성장을 공유하는 것이 이 관계의 정서 연결입니다.',
    ...
    intimacyConnection: {
      marriageNote: '갈등 후 회복하는 과정에서 신체적 연결은 말보다 먼저 화해의 신호가 됩니다. 포옹 한 번이 긴 설명보다 더 빠르게 마음의 거리를 좁혀줍니다. 싸운 날 잠들기 전 손을 내미는 것, 그것이 이 관계의 회복 루틴이 될 수 있습니다.',
      loverNote: '긴장이 풀린 순간, 먼저 가까이 다가가는 것이 이 관계에서 가장 강한 화해의 언어입니다. 활동하며 함께 움직이는 것도 연결감을 회복하는 좋은 방법입니다.',
      actions: ['갈등 후 먼저 손 내밀기', '함께 걷거나 운동하며 긴장 풀기', '어깨를 가볍게 두드려 "괜찮아" 신호 보내기', '활동 후 함께 쉬는 시간 갖기'],
    },
  },
  안정추구형: {
    typeName: '안정추구형 관계',
    ...
    conversationRoutine: '저녁 식사 후 "오늘 어땠어?"라고 묻는 것이 이 관계의 대화 루틴입니다. 특별한 주제 없이 하루를 나누는 것, 그 일상의 공유가 두 사람을 연결합니다.',
    connectionRoutine: '"괜찮아"가 아니라 "사실 오늘 조금 힘들었어"라고 말하는 연습이 이 관계의 정서 연결을 깊게 만듭니다. 작은 솔직함이 쌓여 신뢰가 됩니다.',
    ...
    intimacyConnection: {
      marriageNote: '오랜 시간 함께한 부부에게 친밀한 시간은 새로운 설렘이 아니라 깊은 안정감의 표현입니다. 매일 반복되는 작은 터치와 함께하는 시간이 관계의 뿌리를 더 깊게 내립니다. 특별한 날이 아니어도, 일상 속 따뜻한 연결이 이 관계를 지탱합니다.',
      loverNote: '편안한 관계일수록 표현을 잊기 쉽습니다. 익숙함 속에서도 의식적으로 가까이 있는 시간을 만드는 것이 관계를 신선하게 유지하는 방법입니다.',
      actions: ['함께 소파에 앉아 TV 보기', '아침 인사로 가볍게 안아주기', '식사 후 잠깐 손 잡고 앉아있기', '잠들기 전 "오늘도 고마워" 말하며 등 토닥이기'],
    },
  },
  감정순환형: {
    typeName: '감정순환형 관계',
    ...
    conversationRoutine: '"오늘 마음은 어땠어?"라고 하루를 마무리하며 묻는 것이 이 관계의 대화 루틴입니다. 사건보다 감정을 먼저 나누는 대화가 두 사람을 가장 가깝게 연결합니다.',
    connectionRoutine: '상대의 감정을 해결하려 하지 말고, 먼저 공감하는 것이 이 관계의 정서 연결 방식입니다. "그랬구나, 힘들었겠다"라는 한 마디가 가장 강력한 연결입니다.',
    ...
    intimacyConnection: {
      marriageNote: '감정이 출렁이는 날, 말보다 먼저 가까이 있어주는 것이 이 관계에서 가장 깊은 위로가 됩니다. 부부 사이의 따뜻한 포옹은 감정의 파도를 잠재우고 "우리는 연결되어 있다"는 안정감을 줍니다. 감정이 격해질 때일수록 몸의 온기가 마음을 먼저 안정시킵니다.',
      loverNote: '감정이 넘칠 때 말로 설명하기 어렵다면, 조용히 옆에 앉아 손을 잡는 것만으로도 충분합니다. 감정을 함께 느끼는 것이 이 관계의 가장 자연스러운 연결 방식입니다.',
      actions: ['감정이 격해질 때 조용히 손 잡기', '울고 싶을 때 안아주기', '기쁜 순간 함께 껴안기', '감정이 가라앉은 후 나란히 누워 이야기하기'],
    },
  },
  거리조절형: {
    typeName: '거리조절형 관계',
    ...
    conversationRoutine: '연락이 뜸해졌을 때 "요즘 어때?"라고 먼저 건네는 짧은 메시지가 이 관계의 대화 루틴입니다. 긴 대화보다 짧은 연결이 이 관계를 유지합니다.',
    connectionRoutine: '각자의 공간을 존중하면서도 "나 여기 있어"라는 신호를 보내는 것이 이 관계의 정서 연결입니다. 멀어졌다고 느낄 때 먼저 손 내미는 것이 이 관계의 핵심입니다.',
    ...
    intimacyConnection: {
      marriageNote: '혼자만의 시간이 필요한 부부에게, 다시 연결되는 순간의 따뜻한 접촉은 "나는 여전히 당신 편"이라는 신호입니다. 강요하지 않되, 준비가 되었을 때 먼저 다가가는 것이 이 관계의 균형을 만듭니다.',
      loverNote: '각자의 공간을 충분히 가진 후 다시 만날 때, 가벼운 포옹 하나가 "잘 있었어?"보다 더 많은 것을 전달합니다. 거리가 필요한 관계일수록 다시 연결되는 방식이 중요합니다.',
      actions: ['혼자 시간 후 재회할 때 가볍게 안아주기', '각자 쉬다가 같은 공간에 자연스럽게 모이기', '강요 없이 옆에 앉아 있기', '준비가 되면 먼저 손 내밀기'],
    },
  },
  보호자형: {
    typeName: '보호자형 관계',
    ...
    conversationRoutine: '"요즘 나는 어때?"라고 자신의 감정을 먼저 꺼내는 연습이 이 관계의 대화 루틴입니다. 배려하는 사람도 자신의 이야기를 나눌 수 있는 공간이 필요합니다.',
    connectionRoutine: '감싸는 사람이 "나도 가끔 힘들어"라고 말하는 순간, 이 관계의 정서 연결이 가장 깊어집니다. 서로가 서로를 돌볼 수 있는 관계가 가장 건강합니다.',
    ...
    intimacyConnection: {
      marriageNote: '보호하는 사람도 때로는 기댈 수 있어야 합니다. 부부 사이의 따뜻한 신체 접촉은 "나도 당신에게 기댈 수 있다"는 신뢰의 표현입니다. 배려를 주는 사람이 먼저 받는 연습을 하는 것이 이 관계의 균형을 만듭니다.',
      loverNote: '보살피는 역할에 익숙한 사람도 "기대도 돼"라는 신호가 필요합니다. 상대가 먼저 안아줄 때 그 온기를 충분히 받아들이는 것이 이 관계를 더 깊게 만듭니다.',
      actions: ['배려받는 사람이 먼저 안아주기', '어깨를 내어주며 "기대도 돼" 표현하기', '함께 따뜻하게 쉬는 시간 만들기', '손을 잡고 "고마워, 네가 있어서"라고 말하기'],
    },
  },
  친구형: {
    typeName: '친구형 관계',
    ...
    conversationRoutine: '가벼운 대화 대신 가끔 "요즘 진짜 어때?"라고 깊이 묻는 시간을 만드세요. 편한 사이일수록 의도적으로 진지한 대화를 만드는 것이 이 관계를 더 단단하게 합니다.',
    connectionRoutine: '"편한 사이라서 더 솔직하게 말할 수 있어"라는 것을 실제로 보여주는 것이 이 관계의 정서 연결입니다. 중요한 감정을 나누는 것을 미루지 마세요.',
    ...
    intimacyConnection: {
      marriageNote: '친구 같은 부부에게 친밀한 시간은 자연스럽게 찾아오지 않을 수 있습니다. 의식적으로 "우리는 부부"라는 것을 표현하는 시간이 필요합니다. 편안함 위에 따뜻한 접촉을 더하면 이 관계는 더 깊어집니다.',
      loverNote: '친구처럼 편한 관계일수록 연인으로서의 표현을 잊기 쉽습니다. 가끔은 "우리 연인이잖아"를 상기시켜주는 작은 행동이 관계를 신선하게 유지합니다.',
      actions: ['함께 웃으며 가볍게 안아주기', '나란히 앉아 어깨 기대기', '산책하며 자연스럽게 손 잡기', '잠들기 전 "오늘도 좋았어" 말하며 토닥이기'],
    },
  },
  이상주의형: {
    typeName: '이상주의형 관계',
    ...
    conversationRoutine: '"지금 이 순간 뭐가 좋아?"라고 묻는 대화가 이 관계에 가장 잘 맞습니다. 이상적인 기대보다 지금 있는 것을 함께 발견하는 대화가 이 관계를 현실로 가져옵니다.',
    connectionRoutine: '"지금 이 모습도 좋아"라고 말하는 것이 이 관계의 가장 강력한 정서 연결입니다. 완벽한 순간을 기다리지 말고, 지금 이 순간을 함께 인정하세요.',
    ...
    intimacyConnection: {
      marriageNote: '깊은 연결을 원하는 부부에게, 몸의 온기는 영혼의 연결을 현실로 만드는 방법입니다. 이상적인 관계는 멀리 있지 않습니다. 지금 이 순간 옆에 있는 사람을 안아주는 것에서 시작됩니다.',
      loverNote: '깊은 감정을 나누는 것만큼, 가까이 있는 것도 연결의 방법입니다. 이상적인 순간을 기다리기보다 지금 이 순간 손을 잡는 것이 더 깊은 연결이 될 수 있습니다.',
      actions: ['조용한 저녁 함께 안아있기', '눈을 맞추며 손 잡기', '의미 있는 날 포옹으로 시작하기', '감정이 깊어질 때 가까이 앉아 기대기'],
    },
  },
  현실균형형: {
    typeName: '현실균형형 관계',
    ...
    conversationRoutine: '일상적인 이야기 사이에 "요즘 어때? 힘든 건 없어?"라고 감정을 먼저 확인하는 대화가 이 관계를 살아있게 만듭니다.',
    connectionRoutine: '"고마워, 네가 있어서 든든해"라는 말이 이 관계의 가장 강력한 정서 연결입니다. 현실적인 역할 분담 속에서도 감정 표현을 잊지 마세요.',
    ...
    intimacyConnection: {
      marriageNote: '현실적인 부부에게 친밀한 시간은 효율적으로 계획될 수 있습니다. "오늘 저녁은 우리 둘만의 시간"이라고 정해두는 것이 자연스러운 연결을 만드는 현실적인 방법입니다. 계획된 따뜻함도 진짜 따뜻함입니다.',
      loverNote: '현실적인 관계일수록 감성적인 표현이 부족해질 수 있습니다. 하루 한 번, 의식적으로 가까이 있는 시간을 만드는 것이 관계의 온기를 유지하는 가장 실용적인 방법입니다.',
      actions: ['하루 일과 후 함께 앉아 쉬기', '계획적으로 "우리만의 저녁" 만들기', '일 이야기 없이 손 잡고 산책하기', '잠들기 전 짧게 안아주기'],
    },
  },
  회복형: {
    typeName: '회복형 관계',
