  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      h3 { font-size: 11.5pt; line-height: 1.45; margin-bottom: 6px; color: #4A3A2A; }
      ...
      .color-chip span { color: #766B60; font-size: 8.8pt; margin-top: 3px; }
      ...
      .preparation { color: #66557B; font-size: 9.5pt; margin-bottom: 0; }
