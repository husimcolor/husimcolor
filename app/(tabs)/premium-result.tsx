...
function getJobCoaching(job: string, faith: string): JobCoaching {
  ...
  const jobMap: Record<string, JobCoaching> = {
    서비스직: {
      routineNote:
        "하루 종일 타인의 감정을 받아내는 역할을 하셨다면,\n퇴근 후 10분은 아무것도 하지 않는 시간으로 비워두세요.\n감정 소진 회복에는 혼자만의 조용한 시간이 가장 좋은 루틴입니다.",
      coachingNote:
        "오늘도 많은 감정을 담아내셨을 것입니다. 그 수고가 보입니다.\n퇴근 후 5분, 아무것도 하지 않는 시간을 스스로에게 허락해 보세요.",
    },
    사역자: {
      routineNote:
        "섬기는 역할 속에서도 나 자신을 돌보는 경계가 필요합니다.\n쉬는 것도 사역의 일부임을 기억해 주세요.\n하루 한 번, 나를 위한 조용한 시간을 루틴으로 만들어 보세요.",
      coachingNote:
        "주는 것에 익숙한 당신에게, 오늘은 받는 것을 연습해 보세요.\n경계를 지키는 것이 더 오래 섬길 수 있는 힘이 됩니다.",
    },
    프리랜서: {
      routineNote:
        "일과 쉼의 경계가 흐릿할수록 에너지가 분산됩니다.\n하루 한 가지 작은 마감 의식(차 한 잔, 산책 5분)이\n리듬 회복에 큰 도움이 됩니다.",
      coachingNote:
        "자유로운 만큼 스스로 리듬을 만드는 것이 중요합니다.\n오늘 하루의 끝을 의식적으로 마무리하는 작은 루틴을 만들어 보세요.",
    },
    학생: {
      routineNote:
        "잘해야 한다는 긴장이 쌓이면 집중력이 오히려 떨어집니다.\n학습 전후 짧은 호흡 루틴(3분)이 불안을 완화하고\n집중력 회복에 도움이 됩니다.",
      coachingNote:
        "잘해야 한다는 마음이 클수록 몸과 마음이 먼저 지칩니다.\n오늘 하루 '충분히 했다'고 스스로에게 먼저 말해 주세요.",
    },
    주부: {
      routineNote:
        "가족을 위한 돌봄 속에서 나를 위한 5분이\n가장 중요한 회복 루틴입니다.\n따뜻한 차 한 잔, 혼자만의 조용한 시간을 허락해 주세요.",
      coachingNote:
        "당신의 수고는 눈에 잘 보이지 않는 곳에서도 빛나고 있습니다.\n오늘 하루도 충분히 잘 하셨습니다.",
    },
    생산직: {
      routineNote:
        "몸의 피로가 마음에도 영향을 줍니다.\n퇴근 후 몸을 먼저 쉬게 해 주세요.\n가벼운 스트레칭이나 따뜻한 목욕이 좋은 회복 루틴이 됩니다.",
      coachingNote:
        "몸이 먼저 지쳤을 때는 마음도 함께 쉬어야 합니다.\n반복되는 일상 속 작은 변화 하나가 에너지의 흐름을 바꿀 수 있습니다.",
    },
    자영업: {
      routineNote:
        "책임감과 긴장이 쌓이기 쉬운 환경입니다.\n하루 한 번 의도적으로 이완하는 루틴이 번아웃을 예방합니다.\n짧은 산책이나 조용한 시간이 큰 도움이 됩니다.",
      coachingNote:
        "모든 것을 혼자 감당하려 하지 않아도 됩니다.\n오늘 하루 한 가지만 내려놓는 연습을 해 보세요.",
    },
    무직: {
      routineNote:
        "지금의 멈춤은 다음 흐름을 준비하는 시간입니다.\n아침 산책이나 짧은 글쓰기처럼 작은 루틴 하나가\n방향을 만들어 줍니다.",
      coachingNote:
        "쉬는 것도 용기가 필요합니다.\n지금 이 시간이 당신에게 꼭 필요한 과정일 수 있습니다.\n너무 서두르지 않아도 됩니다.",
    },
    기타: {
      routineNote:
        "자신의 리듬에 맞는 회복 루틴을 하나씩 찾아가는 것이 가장 좋은 방법입니다.\n작은 것부터 시작해 보세요.",
      coachingNote:
