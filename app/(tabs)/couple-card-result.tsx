...
function buildCardFlowAnalysis(
  ...
  const unconsciousIntros: Record<string, string> = {
    red: '겉으로는 단단하고 추진력 있어 보이지만, 무의식 안에는 인정받고 싶은 마음과 상처받고 싶지 않은 긴장이 함께 자리하고 있을 수 있습니다.',
    orange: '활발하고 따뜻해 보이지만, 무의식 안에는 관계에서 혼자 남겨질지 모른다는 두려움이 조용히 자리하고 있을 수 있습니다.',
    coral: '주변을 잘 챙기는 것처럼 보이지만, 무의식 안에는 말보다 리액션과 공감을 먼저 받고 싶었던 마음이 조용히 쌓여 있을 수 있습니다.',
    magenta: '강하고 독립적으로 보이지만, 무의식 안에는 깊이 연결되고 싶은 갈망과 감정이 억눌려 있을 수 있는 긴장이 공존할 수 있습니다.',
    pink: '온화하고 배려 깊어 보이지만, 무의식 안에는 해결보다 공감을 먼저 받고 싶은 마음과, 내 감정을 이해받고 싶다는 바람이 반복될 수 있습니다.',
    peach: '부드럽고 따뜻해 보이지만, 무의식 안에는 해결보다 공감을 먼저 원하는데 상대가 답이 없으면 서운함이 쌓이는 경향이 나타날 수 있습니다.',
    beige: '안정적이고 차분해 보이지만, 무의식 안에는 변화에 대한 불안과 익숙한 것을 잃고 싶지 않은 긴장이 남아 있을 수 있습니다.',
    cream: '조용하고 평온해 보이지만, 무의식 안에는 복잡한 감정들을 혼자 정리하느라 지쳐 있는 상태일 수 있습니다.',
    gold: '자신감 있어 보이지만, 무의식 안에는 자신의 가치를 스스로 충분히 인정하지 못하는 경향이 나타날 수 있습니다.',
    brown: '믿음직하고 안정적으로 보이지만, 무의식 안에는 변화를 두려워하며 현재 자리에서 벗어나지 못하는 경향이 있을 수 있습니다.',
    terracotta: '열정적이고 현실적으로 보이지만, 무의식 안에는 열정과 안정 사이에서 방향을 잡지 못하는 내면의 갈등이 있을 수 있습니다.',
    blue: '신뢰할 수 있고 책임감 있어 보이지만, 무의식 안에는 감정을 표현하지 못해 쌓인 답답함이 자리하고 있을 수 있습니다.',
    skyblue: '자유롭고 밝아 보이지만, 무의식 안에는 현실의 무게와 자유 사이에서 균형을 잡지 못하는 긴장이 남아 있을 수 있습니다.',
    teal: '이성적이고 균형 잡혀 보이지만, 무의식 안에는 감정을 충분히 표현하지 못해 내면에 쌓인 것들이 있을 수 있습니다.',
    mint: '가볍고 청명해 보이지만, 무의식 안에는 충분히 쉬지 못하고 계속 움직여온 피로가 쌓여 있을 수 있습니다.',
    indigo: '깊고 지혜로워 보이지만, 무의식 안에는 오랜 시간 혼자 생각하며 감정을 안으로만 담아온 고독이 자리하고 있을 수 있습니다.',
    violet: '섬세하고 영적으로 보이지만, 무의식 안에는 현실과 내면 사이에서 방향을 잃은 듯한 혼란이 조용히 자리할 수 있습니다.',
    black: '강하고 독립적으로 보이지만, 무의식 안에는 자신을 보호하려는 신중함과 경계가 자리하고 있을 수 있습니다.',
    silver: '차분하고 명료해 보이지만, 무의식 안에는 감정을 정리하지 못한 채 조용히 쌓아온 것들이 있을 수 있습니다.',
    green: '균형 잡히고 안정적으로 보이지만, 무의식 안에는 주변을 먼저 생각하는 성향 때문에 자신의 회복이 뒤로 밀려 있었을 수 있습니다.',
    olive: '묵직하고 성숙해 보이지만, 무의식 안에는 오랫동안 자리를 지키며 자신의 감정을 뒤로 미뤄온 경향이 있을 수 있습니다.',
    sage: '치유적이고 따뜻해 보이지만, 무의식 안에는 다른 사람을 돌보느라 정작 자신의 감정은 조용히 쌓아온 상태입니다.',
    lavender: '섬세하고 감성적으로 보이지만, 무의식 안에는 자신의 감정을 충분히 표현하지 못해 내면에 쌓인 것들이 있을 수 있습니다.',
    white: '깔끔하고 정돈되어 보이지만, 무의식 안에는 모든 것을 비우고 새롭게 시작하고 싶은 간절함이 자리하고 있을 수 있습니다.',
    yellow: '밝고 긍정적으로 보이지만, 무의식 안에는 정리되지 않은 감정들을 밝음으로 덮어온 경향이 나타날 수 있습니다.',
  };

  // 현재 카드 기반 연결 — 현재 관계에서 드러나는 구체적 행동 패턴
  const currentBridges: Record<string, string> = {
    red: '지금은 그 긴장이 관계 안에서 쉽게 불꽃이 튀거나, 반대로 지나치게 억누르는 방식으로 나타나고 있을 수 있습니다.',
    orange: '지금은 그 두려움이 관계에서 더 많이 주거나, 반응이 없을 때 쉽게 불안해지는 방식으로 드러날 수 있습니다.',
    coral: '지금은 그 마음이 리액션이 없는 대화에서 서운함을 느끼거나, 자신의 필요는 말하지 못하는 방식으로 나타날 수 있습니다.',
    magenta: '지금은 그 깊은 감정이 진심을 알아주길 바라는 마음으로 드러나거나, 반대로 조심스럽게 닫아두는 방식으로 나타날 수 있습니다.',
    pink: '지금은 그 마음이 상대의 반응에 민감하게 반응하거나, 공감받지 못하면 서운함이 쌓이는 방식으로 나타날 수 있습니다.',
    peach: '지금은 그 패턴이 공감받고 싶은 마음을 먼저 양보로 들어가거나, 자신의 감정을 잘 꺼내지 못하는 방식으로 드러날 수 있습니다.',
    beige: '지금은 그 불안이 변화를 피하거나, 익숙한 방식만 고집하는 방식으로 관계에 영향을 주고 있습니다.',
    cream: '지금은 그 피로가 혼자 있고 싶거나, 관계에서 한 발 물러서는 방식으로 나타날 수 있습니다.',
    gold: '지금은 그 패턴이 자신을 낮추거나, 인정을 기다리며 표현을 미루는 방식으로 드러날 수 있습니다.',
    brown: '지금은 그 두려움이 새로운 시도를 망설이거나, 현재 상태를 유지하려는 방식으로 나타날 수 있습니다.',
    terracotta: '지금은 그 갈등이 에너지를 쏟아붓다가 갑자기 지치거나, 방향을 잃는 방식으로 드러날 수 있습니다.',
    blue: '지금은 그 답답함이 말하지 않고 참거나, 이미 늦었다고 느껴 표현을 포기하는 방식으로 나타날 수 있습니다.',
    skyblue: '지금은 그 긴장이 현실에서 도망치고 싶거나, 반대로 너무 현실에 묶여 답답함을 느끼는 방식으로 드러날 수 있습니다.',
    teal: '지금은 그 쌓임이 이성으로는 괜찮다고 하면서도 감정적으로는 지쳐 있는 방식으로 나타날 수 있습니다.',
    mint: '지금은 그 피로가 쉬고 싶으면서도 쉬지 못하거나, 가볍게 있으려 해도 마음이 무거운 방식으로 드러날 수 있습니다.',
    indigo: '지금은 그 고독이 혼자 오래 생각하거나, 감정을 말로 꺼내지 않고 안으로 삭히는 방식으로 나타날 수 있습니다.',
    violet: '지금은 그 혼란이 현실에 집중하기 어렵거나, 감정과 이성 사이에서 방향을 잡지 못하는 방식으로 드러날 수 있습니다.',
    black: '지금은 그 긴장이 쉽게 마음을 열지 않거나, 가까워질수록 오히려 거리를 두는 방식으로 나타날 수 있습니다.',
    silver: '지금은 그 쌓임이 감정보다 논리로 상황을 정리하려 하거나, 감정 표현이 어색해지는 방식으로 드러날 수 있습니다.',
    green: '지금은 그 피로가 균형을 유지하려 노력하면서도 내면에서는 지쳐가는 방식으로 나타날 수 있습니다.',
    olive: '지금은 그 패턴이 자신의 감정보다 역할과 책임을 먼저 챙기는 방식으로 드러날 수 있습니다.',
    sage: '지금은 그 상태가 다른 사람의 감정에는 민감하면서도 자신의 감정은 뒤로 미루는 방식으로 나타날 수 있습니다.',
    lavender: '지금은 그 쌓임이 감정을 혼자 정리하려 하거나, 표현하고 싶어도 말이 잘 나오지 않는 방식으로 드러날 수 있습니다.',
    white: '지금은 그 간절함이 모든 것을 내려놓고 싶거나, 관계에서도 복잡함을 피하고 싶은 방식으로 나타날 수 있습니다.',
    yellow: '지금은 그 패턴이 밝게 지내려 노력하면서도 내면의 감정은 충분히 다루지 못하는 방식으로 드러날 수 있습니다.',
  };
  ...
  const recoveryClosings: Record<string, string> = {
    ...
    coral: '지금 필요한 것은 공감받고 싶은 마음을 먼저 솔직하게 말하는 연습입니다. 해결보다 공감이 먼저라는 것을 상대에게 알려주세요.',
    magenta: '지금 필요한 것은 감정을 안전하게 꺼낼 수 있는 공간입니다. 혼자 담아두지 않아도 됩니다.',
    pink: '지금 필요한 것은 공감받고 싶은 마음을 상대에게 솔직하게 전하는 연습입니다. 상대의 반응을 기다리기 전에 먼저 표현해보세요.',
    peach: '지금 필요한 것은 공감받고 싶은 마음을 먼저 표현하는 연습입니다. 양보하기 전에 자신의 감정을 먼저 확인해보세요.',
    ...
    mint: '지금 필요한 것은 잠시 속도를 늦추고 쉬어가는 시간입니다. 몸과 마음이 함께 회복될 수 있도록 자신에게 여유를 허락해보세요.',
  ...
  const intro = unconsciousIntros[c1.color ?? c1.id] ?? '겉으로는 괜찮아 보이지만, 무의식 안에는 오랫동안 혼자 담아온 감정들이 자리하고 있을 수 있습니다.';
  ...
  const coachingIntros: Record<string, string> = {
    ...
    coral: '말보다 리액션과 공감을 먼저 원하는 마음이 있는데, 상대가 바로 해결책을 내놓을 때 서운함이 쌓이는 경향이 있을 수 있습니다. "나는 공감이 먼저야"라고 상대에게 알려주는 것이 지금 가장 필요한 단계입니다.',
    magenta: '강렬한 감정이 마음속에 쌓여 있는 시기입니다. 표현하고 싶지만 어떻게 꺼내야 할지 몰라 안으로 담아온 것들이 있습니다.',
    pink: '해결보다 공감을 먼저 원하는 마음이 강한 시기입니다. 상대가 바로 답을 내놓을 때 "내 감정을 이해 못 하는 것 같아"라는 서운함이 드는 패턴이 있을 수 있습니다. 공감받고 싶은 마음을 먼저 표현하는 것이 관계를 편안하게 만드는 첫 걸음입니다.',
    peach: '따뜻하게 주변을 챙겨왔지만 공감받고 싶은 마음을 먼저 표현하지 못해 지쳐 있는 시기입니다. 해결보다 공감이 먼저라는 것을 상대에게 알려주는 연습이 필요합니다.',
    beige: '조용히 안정을 유지하려 애써온 시기입니다. 변화가 두렵거나, 지금 있는 자리를 잃을까봐 마음이 경직되어 있을 수 있습니다.',
    cream: '복잡한 것들을 정리하고 고요히 머물고 싶은 마음이 있습니다. 자극이 많아질수록 혼자 있고 싶어지는 경향이 나타날 수 있습니다.',
    ...
    terracotta: '안정과 열정 사이에서 내면의 갈등이 있는 시기입니다. 뜨겁게 달려가다가 갑자기 지치거나 방향을 잃는 경향이 나타날 수 있습니다.',
    blue: '책임감 있게 살아왔지만 감정을 표현하지 못해 답답함이 쌓여 있을 수 있습니다. 말하고 싶었지만 "이걸 말해도 될까?"라고 망설이다 넘어간 순간들이 있을 것입니다.',
    ...
    lavender: '감정을 섬세하게 느끼며 천천히 정리하고 싶은 시기입니다. 표현하고 싶은 것들이 있지만 말로 꺼내기 전에 이미 지쳐버리는 경향이 나타날 수 있습니다.',
  ...
  const recoveryKeywords: Record<string, string> = {
    ...
    green: '관계 안에서 균형과 신뢰를 다시 찾아가는',
    olive: '뿌리를 내리고 안정을 찾는',
    sage: '치유의 마음을 자신에게도 돌려주는',
    lavender: '섬세한 감정을 조용히 정화하고 이상적인 연결을 회복하는',
  ...
  const routineMap: Record<string, string> = {
    ...
    // 마젠타 계열: 감정 표현, 글쓰기
    magenta: '하고 싶었던 말을 편지 형식으로 써보거나, 신뢰하는 사람에게 조금씩 진심을 꺼내보세요. 깊이 연결되고 싶은 마음을 표현하는 것 자체가 회복의 시작입니다.',
    // 핑크 계열: 자기 사랑, 작은 기쁨
    ...
    // 그린 계열: 자연, 산책, 균형 회복
    green: '관계 안에서 작은 신뢰의 순간을 다시 쌓아가 보세요. 자연 속을 함께 걷거나 조용한 시간을 나누는 것만으로도 균형이 회복됩니다. 천천히 안정을 되찾아가는 것이 그린의 회복 방식입니다.',
    // 올리브 계열: 안정, 뿌리, 오래된 것들
    ...
    lavender: '조용한 음악을 들으며 자신의 감정을 천천히 들여다보세요. 이상적인 관계를 바라는 마음을 일기나 그림으로 표현해보는 것도 마음의 정화에 도움이 됩니다.',
