...
function buildCardFlowAnalysis(
  ...
  const unconsciousIntros: Record<string, string> = {
    ...
    coral: '주변을 잘 챙기는 것처럼 보이지만, 무의식 안에는 말보다 리액션과 공감을 먼저 받고 싶었던 마음이 조용히 쌓여 있습니다.',
    magenta: '강하고 독립적으로 보이지만, 무의식 안에는 깊이 연결되고 싶은 갈망과 감정이 억눌려 있는 긴장이 공존합니다.',
    pink: '온화하고 배려 깊어 보이지만, 무의식 안에는 해결보다 공감을 먼저 받고 싶은 마음과, 내 감정을 이해받고 싶다는 바람이 반복됩니다.',
    peach: '부드럽고 따뜻해 보이지만, 무의식 안에는 해결보다 공감을 먼저 원하는데 상대가 답이 없으면 서운함이 쌓이는 패턴이 반복됩니다.',
    ...
    black: '강하고 독립적으로 보이지만, 무의식 안에는 자신을 보호하려는 신중함과 경계가 자리하고 있습니다.',
  ...
  const currentBridges: Record<string, string> = {
    ...
    coral: '지금은 그 마음이 리액션이 없는 대화에서 서운함을 느끼거나, 자신의 필요는 말하지 못하는 방식으로 나타납니다.',
    magenta: '지금은 그 억눌림이 감정이 한꺼번에 터지거나, 반대로 완전히 닫아버리는 방식으로 드러납니다.',
    pink: '지금은 그 마음이 상대의 반응에 민감하게 반응하거나, 공감받지 못하면 서운함이 쌓이는 방식으로 나타납니다.',
    peach: '지금은 그 패턴이 공감받고 싶은 마음을 먼저 양보로 들어가거나, 자신의 감정을 잘 꺼내지 못하는 방식으로 드러납니다.',
  ...
  const coachingIntros: Record<string, string> = {
    ...
    coral: '말보다 리액션과 공감을 먼저 원하는 마음이 있는데, 상대가 바로 해결책을 내놓을 때 서운함이 쌓이는 패턴이 있습니다. "나는 공감이 먼저야"라고 상대에게 알려주는 것이 지금 가장 필요한 단계입니다.',
